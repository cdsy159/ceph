...
public:
  ...
  void
  init(const EntityName& n)
  {
    name = n;
  }

  void
  set_want_keys(__u32 keys)
  {
  ...
  static AuthClientHandler* create(
      CephContext* cct,
      int proto,
