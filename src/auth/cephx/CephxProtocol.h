...
struct CephXServerChallenge {
  ...
  static std::list<CephXServerChallenge>
...
struct CephXRequestHeader {
  ...
  static std::list<CephXRequestHeader>
  generate_test_instances()
  {
...
struct CephXResponseHeader {
  ...
  static std::list<CephXResponseHeader>
  generate_test_instances()
  {
...
struct CephXTicketBlob {
  ...
  static std::list<CephXTicketBlob>
  generate_test_instances()
  {
...
struct CephXAuthenticate {
  ...
  static std::list<CephXAuthenticate>
  generate_test_instances()
  {
...
struct CephXChallengeBlob {
  ...
  static std::list<CephXChallengeBlob>
  generate_test_instances()
  {
...
extern bool cephx_build_service_ticket_blob(
    CephContext* cct,
    CephXSessionAuthInfo& ticket_info,
    CephXTicketBlob& blob);

extern void cephx_build_service_ticket_request(
    CephContext* cct,
    uint32_t keys,
...
struct CephXServiceTicketRequest {
  ...
  static std::list<CephXServiceTicketRequest>
  generate_test_instances()
  {
...
struct CephXAuthorizeReply {
  ...
  static std::list<CephXAuthorizeReply>
  generate_test_instances()
  {
...
public:
  ...
  bool verify_reply(
      ceph::buffer::list::const_iterator& reply,
      std::string* connection_secret) override;
  bool add_challenge(
      CephContext* cct,
      const ceph::buffer::list& challenge) override;
};
...
struct CephXTicketHandler {
  ...
  bool verify_service_ticket_reply(
      CryptoKey& principal_secret,
...
struct CephXServiceTicket {
  ...
  static std::list<CephXServiceTicket>
  generate_test_instances()
  {
...
struct CephXServiceTicketInfo {
  ...
  static std::list<CephXServiceTicketInfo>
  generate_test_instances()
  {
...
struct CephXAuthorizeChallenge : public AuthAuthorizerChallenge {
  ...
  static std::list<CephXAuthorizeChallenge>
  generate_test_instances()
  {
...
struct CephXAuthorize {
  ...
  static std::list<CephXAuthorize>
  generate_test_instances()
  {
