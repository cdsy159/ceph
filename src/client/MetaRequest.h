...
public:
  ...
  void
  take_inode(InodeRef* out)
  {
    out->swap(_inode);
  }

  void
  set_old_inode(InodeRef in)
  {
  ...
  void
  take_old_inode(InodeRef* out)
  {
    out->swap(_old_inode);
  }

  void
  set_other_inode(InodeRef in)
  {
  ...
  void
  set_inode_owner_uid_gid(unsigned u, unsigned g)
  {
  ...
  void
  set_alternate_name(std::string an)
  {
    alternate_name = an;
  }
  ...
  void
  set_caller_perms(const UserPerm& _perms)
  {
    perms = _perms;
