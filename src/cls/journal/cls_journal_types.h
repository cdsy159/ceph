...
struct ObjectPosition {
  ...
  ObjectPosition() :
    object_number(0), tag_tid(0), entry_tid(0)
  {}
  ...
  inline bool
  operator==(const ObjectPosition& rhs) const
  {
    return (
        object_number == rhs.object_number && tag_tid == rhs.tag_tid &&
...
struct ObjectSetPosition {
  ...
  inline bool
  operator==(const ObjectSetPosition& rhs) const
  {
...
struct Client {
  ...
  {
    return (
        id == rhs.id && data.contents_equal(rhs.data) &&
        commit_position == rhs.commit_position && state == rhs.state);
  }
...
struct Tag {
  ...
  {
    return (
        tid == rhs.tid && tag_class == rhs.tag_class &&
