...
static inline struct bufferlist_wrap*
to_blwrap(lua_State* L, int pos = 1)
{
  return (bufferlist_wrap*)luaL_checkudata(L, pos, LUA_BUFFERLIST);
}

bufferlist*
clslua_checkbufferlist(lua_State* L, int pos)
{
 ...
 */
bufferlist*
clslua_pushbufferlist(lua_State* L, bufferlist* set)
{
  bufferlist_wrap* blw =
...
static const struct luaL_Reg bufferlist_methods[] = {
    {"str", bl_str},   {"append", bl_append}, {"__concat", bl_concat},
    {"__len", bl_len}, {"__lt", bl_lt},       {"__le", bl_le},
    {"__gc", bl_gc},   {"__eq", bl_eq},       {NULL, NULL}};

static const struct luaL_Reg bllib_f[] = {{"new", bl_new}, {NULL, NULL}};

int
luaopen_bufferlist(lua_State* L)
{
