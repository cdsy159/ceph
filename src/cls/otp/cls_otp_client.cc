...
void
OTP::create(librados::ObjectWriteOperation* rados_op, const otp_info_t& config)
{
...
void
OTP::remove(librados::ObjectWriteOperation* rados_op, const string& id)
{
