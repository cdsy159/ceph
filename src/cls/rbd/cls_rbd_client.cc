...
void
get_features_start(librados::ObjectReadOperation* op, bool read_only)
{
  bufferlist bl;
...
void
set_features(librados::ObjectWriteOperation* op, uint64_t features, uint64_t mask)
{
  bufferlist bl;
  encode(features, bl);
  encode(mask, bl);
...
void
get_object_prefix_start(librados::ObjectReadOperation* op)
{
  bufferlist bl;
...
void
get_data_pool_start(librados::ObjectReadOperation* op)
{
  bufferlist bl;
...
int
get_data_pool_finish(bufferlist::const_iterator* it, int64_t* data_pool_id)
{
  try {
...
void
get_size_start(librados::ObjectReadOperation* op, snapid_t snap_id)
{
  bufferlist bl;
  encode(snap_id, bl);
...
int
get_size_finish(bufferlist::const_iterator* it, uint64_t* size, uint8_t* order)
{
  try {
    decode(*order, *it);
    decode(*size, *it);
...
int
set_size(librados::IoCtx* ioctx, const std::string& oid, uint64_t size)
{
  librados::ObjectWriteOperation op;
  set_size(&op, size);
  return ioctx->operate(oid, &op);
...
void
set_size(librados::ObjectWriteOperation* op, uint64_t size)
{
  bufferlist bl;
  encode(size, bl);
...
void
get_flags_start(librados::ObjectReadOperation* op, snapid_t snap_id)
{
  bufferlist in_bl;
...
int
get_flags_finish(bufferlist::const_iterator* it, uint64_t* flags)
{
  try {
    decode(*flags, *it);
  } catch (const ceph::buffer::error& err) {
...
void
op_features_get_start(librados::ObjectReadOperation* op)
{
  bufferlist in_bl;
...
int
op_features_get_finish(bufferlist::const_iterator* it, uint64_t* op_features)
{
  try {
...
void
get_parent_start(librados::ObjectReadOperation* op, snapid_t snap_id)
{
  bufferlist bl;
  encode(snap_id, bl);
...
int
remove_parent(librados::IoCtx* ioctx, const std::string& oid)
{
  librados::ObjectWriteOperation op;
  remove_parent(&op);
  return ioctx->operate(oid, &op);
...
void
remove_parent(librados::ObjectWriteOperation* op)
{
  bufferlist inbl;
...
void
parent_get_start(librados::ObjectReadOperation* op)
{
  bufferlist in_bl;
...
void
parent_overlap_get_start(librados::ObjectReadOperation* op, snapid_t snap_id)
{
  bufferlist in_bl;
...
void
parent_detach(librados::ObjectWriteOperation* op)
{
  bufferlist in_bl;
...
int
parent_detach(librados::IoCtx* ioctx, const std::string& oid)
{
  librados::ObjectWriteOperation op;
  parent_detach(&op);
  return ioctx->operate(oid, &op);
...
void
snapshot_get_start(librados::ObjectReadOperation* op, snapid_t snap_id)
{
  bufferlist bl;
  encode(snap_id, bl);
...
void
snapshot_remove(librados::ObjectWriteOperation* op, snapid_t snap_id)
{
  bufferlist bl;
  encode(snap_id, bl);
...
void
snapshot_trash_add(librados::ObjectWriteOperation* op, snapid_t snap_id)
{
  bufferlist bl;
  encode(snap_id, bl);
...
void
get_snapcontext_start(librados::ObjectReadOperation* op)
{
  bufferlist bl;
...
int
get_snapcontext_finish(bufferlist::const_iterator* it, ::SnapContext* snapc)
{
  try {
    decode(*snapc, *it);
  } catch (const ceph::buffer::error& err) {
...
void
get_snapshot_name_start(librados::ObjectReadOperation* op, snapid_t snap_id)
{
  bufferlist bl;
  encode(snap_id, bl);
...
int
get_snapshot_name_finish(bufferlist::const_iterator* it, std::string* name)
{
  try {
    decode(*name, *it);
  } catch (const ceph::buffer::error& err) {
...
void
get_snapshot_timestamp_start(librados::ObjectReadOperation* op, snapid_t snap_id)
{
  bufferlist bl;
  encode(snap_id, bl);
...
int
get_snapshot_timestamp_finish(bufferlist::const_iterator* it, utime_t* timestamp)
{
  try {
    decode(*timestamp, *it);
  } catch (const ceph::buffer::error& err) {
...
void
old_snapshot_list_start(librados::ObjectReadOperation* op)
{
  bufferlist in_bl;
...
void
get_all_features_start(librados::ObjectReadOperation* op)
{
  bufferlist in;
...
int
get_all_features_finish(bufferlist::const_iterator* it, uint64_t* all_features)
{
  try {
...
template <typename O>
void
copyup(O* op, ceph::buffer::list data)
{
  op->exec("rbd", "copyup", data);
}

void
copyup(neorados::WriteOp* op, ceph::buffer::list data)
{
  copyup<neorados::WriteOp>(op, data);
}

void
copyup(librados::ObjectWriteOperation* op, bufferlist data)
{
  copyup<librados::ObjectWriteOperation>(op, data);
}

int
copyup(librados::IoCtx* ioctx, const std::string& oid, bufferlist data)
{
  librados::ObjectWriteOperation op;
  copyup(&op, data);
...
void
sparse_copyup(O* op, const E& extent_map, ceph::buffer::list data)
{
  bufferlist bl;
...
void
get_protection_status_start(librados::ObjectReadOperation* op, snapid_t snap_id)
{
  bufferlist bl;
  encode(snap_id, bl);
...
void
snapshot_get_limit_start(librados::ObjectReadOperation* op)
{
  bufferlist bl;
...
int
snapshot_get_limit_finish(bufferlist::const_iterator* it, uint64_t* limit)
{
  try {
    decode(*limit, *it);
  } catch (const ceph::buffer::error& err) {
...
void
snapshot_set_limit(librados::ObjectWriteOperation* op, uint64_t limit)
{
  bufferlist in;
  encode(limit, in);
...
void
get_stripe_unit_count_start(librados::ObjectReadOperation* op)
{
  bufferlist empty_bl;
...
void
get_create_timestamp_start(librados::ObjectReadOperation* op)
{
  bufferlist empty_bl;
...
int
get_create_timestamp_finish(bufferlist::const_iterator* it, utime_t* timestamp)
{
...
void
get_access_timestamp_start(librados::ObjectReadOperation* op)
{
  bufferlist empty_bl;
...
int
get_access_timestamp_finish(bufferlist::const_iterator* it, utime_t* timestamp)
{
  ceph_assert(timestamp);
...
void
set_access_timestamp(librados::ObjectWriteOperation* op)
{
  bufferlist empty_bl;
...
int
set_access_timestamp(librados::IoCtx* ioctx, const std::string& oid)
{
  librados::ObjectWriteOperation op;
...
void
get_modify_timestamp_start(librados::ObjectReadOperation* op)
{
  bufferlist empty_bl;
...
int
get_modify_timestamp_finish(bufferlist::const_iterator* it, utime_t* timestamp)
{
  ceph_assert(timestamp);
...
void
set_modify_timestamp(librados::ObjectWriteOperation* op)
{
  bufferlist empty_bl;
...
int
set_modify_timestamp(librados::IoCtx* ioctx, const std::string& oid)
{
  librados::ObjectWriteOperation op;
...
void
get_id_start(librados::ObjectReadOperation* op)
{
  bufferlist empty_bl;
...
int
get_id_finish(bufferlist::const_iterator* it, std::string* id)
{
  try {
    decode(*id, *it);
  } catch (const ceph::buffer::error& err) {
...
int
get_id(librados::IoCtx* ioctx, const std::string& oid, std::string* id)
{
  librados::ObjectReadOperation op;
  get_id_start(&op);
...
void
set_id(librados::ObjectWriteOperation* op, const std::string& id)
{
  bufferlist bl;
  encode(id, bl);
...
int
set_id(librados::IoCtx* ioctx, const std::string& oid, const std::string& id)
{
  librados::ObjectWriteOperation op;
  set_id(&op, id);
...
void
dir_get_id_start(librados::ObjectReadOperation* op, const std::string& image_name)
{
  bufferlist bl;
...
int
dir_get_id_finish(bufferlist::const_iterator* iter, std::string* image_id)
{
  try {
...
void
dir_get_name_start(librados::ObjectReadOperation* op, const std::string& id)
{
  bufferlist in_bl;
  encode(id, in_bl);
...
int
dir_get_name_finish(bufferlist::const_iterator* it, std::string* name)
{
  try {
    decode(*name, *it);
  } catch (const ceph::buffer::error& err) {
...
int
dir_list_finish(bufferlist::const_iterator* it, map<string, string>* images)
{
  try {
    decode(*images, *it);
  } catch (const ceph::buffer::error& err) {
...
void
object_map_load_start(librados::ObjectReadOperation* op)
{
  bufferlist in_bl;
...
void
object_map_snap_add(librados::ObjectWriteOperation* rados_op)
{
  bufferlist in;
...
void
metadata_remove(librados::ObjectWriteOperation* op, const std::string& key)
{
  bufferlist bl;
  encode(key, bl);
...
void
metadata_get_start(librados::ObjectReadOperation* op, const std::string& key)
{
  bufferlist bl;
  encode(key, bl);
...
int
metadata_get_finish(bufferlist::const_iterator* it, std::string* value)
{
  try {
    decode(*value, *it);
  } catch (const ceph::buffer::error& err) {
...
void
children_list_start(librados::ObjectReadOperation* op, snapid_t snap_id)
{
  bufferlist bl;
  encode(snap_id, bl);
...
void
migration_get_start(librados::ObjectReadOperation* op)
{
  bufferlist bl;
...
int
migration_remove(librados::IoCtx* ioctx, const std::string& oid)
{
  librados::ObjectWriteOperation op;
  migration_remove(&op);
  return ioctx->operate(oid, &op);
...
void
migration_remove(librados::ObjectWriteOperation* op)
{
  bufferlist bl;
...
template <typename O>
void
assert_snapc_seq(O* op, uint64_t snapc_seq, cls::rbd::AssertSnapcSeqState state)
{
  bufferlist bl;
  encode(snapc_seq, bl);
  encode(state, bl);
...
void
mirror_uuid_get_start(librados::ObjectReadOperation* op)
{
  bufferlist bl;
...
int
mirror_uuid_get_finish(bufferlist::const_iterator* it, std::string* uuid)
{
  try {
    decode(*uuid, *it);
  } catch (const ceph::buffer::error& err) {
...
int
mirror_uuid_get(librados::IoCtx* ioctx, std::string* uuid)
{
  librados::ObjectReadOperation op;
...
int
mirror_uuid_set(librados::IoCtx* ioctx, const std::string& uuid)
{
  bufferlist in_bl;
  encode(uuid, in_bl);
...
void
mirror_mode_get_start(librados::ObjectReadOperation* op)
{
  bufferlist bl;
...
int
mirror_mode_get(librados::IoCtx* ioctx, cls::rbd::MirrorMode* mirror_mode)
{
  librados::ObjectReadOperation op;
...
int
mirror_mode_set(librados::IoCtx* ioctx, cls::rbd::MirrorMode mirror_mode)
{
  bufferlist in_bl;
...
int
mirror_remote_namespace_get(librados::IoCtx* ioctx, std::string* mirror_namespace)
{
  bufferlist in_bl;
  bufferlist out_bl;

  int r = ioctx->exec(
      RBD_MIRRORING, "rbd", "mirror_remote_namespace_get", in_bl, out_bl);
  if (r < 0) {
    return r;
  }
...
void
mirror_peer_list_start(librados::ObjectReadOperation* op)
{
  bufferlist bl;
...
int
mirror_peer_list(librados::IoCtx* ioctx, std::vector<cls::rbd::MirrorPeer>* peers)
{
  librados::ObjectReadOperation op;
...
int
mirror_peer_add(librados::IoCtx* ioctx, const cls::rbd::MirrorPeer& mirror_peer)
{
  librados::ObjectWriteOperation op;
...
int
mirror_peer_remove(librados::IoCtx* ioctx, const std::string& uuid)
{
  bufferlist in_bl;
  encode(uuid, in_bl);
...
void
mirror_image_get_image_id_start(
    librados::ObjectReadOperation* op,
...
int
mirror_image_get_image_id_finish(
    bufferlist::const_iterator* it,
    std::string* image_id)
{
  try {
...
int
mirror_image_remove(librados::IoCtx* ioctx, const std::string& image_id)
{
  librados::ObjectWriteOperation op;
...
int
mirror_image_status_get_finish(
    bufferlist::const_iterator* iter,
    cls::rbd::MirrorImageStatus* status)
{
  try {
...
int
mirror_image_status_list_finish(
    bufferlist::const_iterator* iter,
    std::map<std::string, cls::rbd::MirrorImage>* images,
    std::map<std::string, cls::rbd::MirrorImageStatus>* statuses)
{
...
void
mirror_image_status_get_summary_start(
    librados::ObjectReadOperation* op,
    const std::vector<cls::rbd::MirrorPeer>& mirror_peer_sites)
{
  bufferlist bl;
...
int
mirror_image_status_get_summary_finish(
    bufferlist::const_iterator* iter,
    std::map<cls::rbd::MirrorImageStatusState, int32_t>* states)
{
  try {
...
int
mirror_image_status_remove_down(librados::IoCtx* ioctx)
{
  librados::ObjectWriteOperation op;
...
void
mirror_image_status_remove_down(librados::ObjectWriteOperation* op)
{
  bufferlist bl;
...
void
mirror_image_instance_get_start(
    librados::ObjectReadOperation* op,
    const std::string& global_image_id)
{
  bufferlist bl;
...
int
mirror_image_instance_get_finish(
    bufferlist::const_iterator* iter,
    entity_inst_t* instance)
{
  try {
...
void
mirror_image_instance_list_start(
    librados::ObjectReadOperation* op,
    const std::string& start,
    uint64_t max_return)
{
...
int
mirror_image_instance_list_finish(
    bufferlist::const_iterator* iter,
    std::map<std::string, entity_inst_t>* instances)
{
  instances->clear();
...
void
mirror_instances_list_start(librados::ObjectReadOperation* op)
{
  bufferlist bl;
...
int
mirror_instances_add(librados::IoCtx* ioctx, const std::string& instance_id)
{
  librados::ObjectWriteOperation op;
...
int
mirror_instances_remove(librados::IoCtx* ioctx, const std::string& instance_id)
{
  librados::ObjectWriteOperation op;
...
void
image_group_get_start(librados::ObjectReadOperation* op)
{
  bufferlist in_bl;
...
void
trash_remove(librados::ObjectWriteOperation* op, const std::string& id)
{
  bufferlist bl;
  encode(id, bl);
...
int
trash_remove(librados::IoCtx* ioctx, const std::string& id)
{
  librados::ObjectWriteOperation op;
  trash_remove(&op, id);
...
void
trash_get_start(librados::ObjectReadOperation* op, const std::string& id)
{
  bufferlist bl;
  encode(id, bl);
...
void
namespace_add(librados::ObjectWriteOperation* op, const std::string& name)
{
  bufferlist bl;
  encode(name, bl);
...
int
namespace_add(librados::IoCtx* ioctx, const std::string& name)
{
  librados::ObjectWriteOperation op;
...
void
namespace_remove(librados::ObjectWriteOperation* op, const std::string& name)
{
  bufferlist bl;
  encode(name, bl);
...
int
namespace_remove(librados::IoCtx* ioctx, const std::string& name)
{
  librados::ObjectWriteOperation op;
