...
std::ostream&
operator<<(std::ostream& os, MirrorPeerDirection mirror_peer_direction)
{
...
void
MirrorPeer::encode(bufferlist& bl) const
{
  ENCODE_START(2, 1, bl);
  encode(uuid, bl);
  encode(site_name, bl);
...
void
MirrorPeer::decode(bufferlist::const_iterator& it)
{
  DECODE_START(2, it);
  decode(uuid, it);
  decode(site_name, it);
...
void
MirrorPeer::dump(Formatter* f) const
{
...
std::list<MirrorPeer>
MirrorPeer::generate_test_instances()
{
  std::list<MirrorPeer> o;
  o.push_back(MirrorPeer());
  o.push_back(MirrorPeer(
      "uuid-123", MIRROR_PEER_DIRECTION_RX, "site A", "client name", ""));
  o.push_back(MirrorPeer(
      "uuid-234", MIRROR_PEER_DIRECTION_TX, "site B", "", "mirror_uuid"));
  o.push_back(MirrorPeer(
      "uuid-345", MIRROR_PEER_DIRECTION_RX_TX, "site C", "client name",
      "mirror_uuid"));
  return o;
}

bool
MirrorPeer::operator==(const MirrorPeer& rhs) const
{
  return (
      uuid == rhs.uuid && mirror_peer_direction == rhs.mirror_peer_direction &&
      site_name == rhs.site_name && client_name == rhs.client_name &&
      mirror_uuid == rhs.mirror_uuid && last_seen == rhs.last_seen);
}

std::ostream&
operator<<(std::ostream& os, const MirrorMode& mirror_mode)
{
  switch (mirror_mode) {
...
std::ostream&
operator<<(std::ostream& os, const MirrorPeer& peer)
{
  os << "[" << "uuid=" << peer.uuid << ", "
...
void
MirrorImage::encode(bufferlist& bl) const
{
  ENCODE_START(2, 1, bl);
...
void
MirrorImage::decode(bufferlist::const_iterator& it)
{
  uint8_t int_state;
  DECODE_START(2, it);
...
void
MirrorImage::dump(Formatter* f) const
{
...
std::list<MirrorImage>
MirrorImage::generate_test_instances()
{
  std::list<MirrorImage> o;
  o.push_back(MirrorImage());
  o.push_back(MirrorImage(
      MIRROR_IMAGE_MODE_JOURNAL, "uuid-123", MIRROR_IMAGE_STATE_ENABLED));
  o.push_back(MirrorImage(
      MIRROR_IMAGE_MODE_SNAPSHOT, "uuid-abc", MIRROR_IMAGE_STATE_DISABLING));
  return o;
}

bool
MirrorImage::operator==(const MirrorImage& rhs) const
{
...
std::ostream&
operator<<(std::ostream& os, const MirrorImageMode& mirror_mode)
{
  switch (mirror_mode) {
...
std::ostream&
operator<<(std::ostream& os, const MirrorImageState& mirror_state)
{
  switch (mirror_state) {
...
std::ostream&
operator<<(std::ostream& os, const MirrorImage& mirror_image)
{
  os << "[" << "mode=" << mirror_image.mode << ", "
...
std::ostream&
operator<<(std::ostream& os, const MirrorImageStatusState& state)
{
  switch (state) {
...
const std::string MirrorImageSiteStatus::LOCAL_MIRROR_UUID(
    ""); // empty mirror uuid

void
MirrorImageSiteStatus::encode_meta(uint8_t version, bufferlist& bl) const
{
  if (version >= 2) {
...
void
MirrorImageSiteStatus::decode_meta(
    uint8_t version,
...
void
MirrorImageSiteStatus::encode(bufferlist& bl) const
{
...
void
MirrorImageSiteStatus::decode(bufferlist::const_iterator& it)
{
  DECODE_START(2, it);
...
void
MirrorImageSiteStatus::dump(Formatter* f) const
{
...
std::list<MirrorImageSiteStatus>
MirrorImageSiteStatus::generate_test_instances()
{
  std::list<MirrorImageSiteStatus> o;
  o.push_back(MirrorImageSiteStatus());
  o.push_back(
      MirrorImageSiteStatus("", MIRROR_IMAGE_STATUS_STATE_REPLAYING, ""));
  o.push_back(
      MirrorImageSiteStatus("", MIRROR_IMAGE_STATUS_STATE_ERROR, "error"));
  o.push_back(MirrorImageSiteStatus(
      "2fb68ca9-1ba0-43b3-8cdf-8c5a9db71e65", MIRROR_IMAGE_STATUS_STATE_STOPPED,
      ""));
  return o;
}

bool
MirrorImageSiteStatus::operator==(const MirrorImageSiteStatus& rhs) const
{
  return state == rhs.state && description == rhs.description && up == rhs.up;
}

std::ostream&
operator<<(std::ostream& os, const MirrorImageSiteStatus& status)
{
  os << "{" << "state=" << status.state_to_string() << ", "
...
void
MirrorImageSiteStatusOnDisk::encode_meta(bufferlist& bl, uint64_t features) const
{
  ENCODE_START(1, 1, bl);
...
void
MirrorImageSiteStatusOnDisk::encode(bufferlist& bl, uint64_t features) const
{
...
void
MirrorImageSiteStatusOnDisk::decode_meta(bufferlist::const_iterator& it)
{
  DECODE_START(1, it);
  decode(origin, it);
...
void
MirrorImageSiteStatusOnDisk::decode(bufferlist::const_iterator& it)
{
  decode_meta(it);
  cls::rbd::MirrorImageSiteStatus::decode(it);
}

std::list<MirrorImageSiteStatusOnDisk>
MirrorImageSiteStatusOnDisk::generate_test_instances()
{
...
int
MirrorImageStatus::get_local_mirror_image_site_status(
    MirrorImageSiteStatus* status) const
{
  auto it = std::find_if(
      mirror_image_site_statuses.begin(), mirror_image_site_statuses.end(),
...
void
MirrorImageStatus::encode(bufferlist& bl) const
{
...
void
MirrorImageStatus::decode(bufferlist::const_iterator& it)
{
  DECODE_START(2, it);
...
void
MirrorImageStatus::dump(Formatter* f) const
{
  MirrorImageSiteStatus local_status;
  int r = get_local_mirror_image_site_status(&local_status);
  if (r >= 0) {
...
bool
MirrorImageStatus::operator==(const MirrorImageStatus& rhs) const
{
  return (mirror_image_site_statuses == rhs.mirror_image_site_statuses);
}

std::list<MirrorImageStatus>
MirrorImageStatus::generate_test_instances()
{
...
std::ostream&
operator<<(std::ostream& os, const MirrorImageStatus& status)
{
  os << "{";
  MirrorImageSiteStatus local_status;
  ...
  for (auto& remote_status : status.mirror_image_site_statuses) {
    ...
    os << "{" << "mirror_uuid=" << remote_status.mirror_uuid << ", "
...
void
ParentImageSpec::encode(bufferlist& bl) const
{
  ENCODE_START(1, 1, bl);
  encode(pool_id, bl);
...
void
ParentImageSpec::decode(bufferlist::const_iterator& bl)
{
  DECODE_START(1, bl);
  decode(pool_id, bl);
...
void
ParentImageSpec::dump(Formatter* f) const
{
...
std::list<ParentImageSpec>
ParentImageSpec::generate_test_instances()
{
...
std::ostream&
operator<<(std::ostream& os, const ParentImageSpec& rhs)
{
  os << "[" << "pool_id=" << rhs.pool_id << ", "
...
void
ChildImageSpec::encode(bufferlist& bl) const
{
  ENCODE_START(2, 1, bl);
  encode(pool_id, bl);
  encode(image_id, bl);
...
void
ChildImageSpec::decode(bufferlist::const_iterator& it)
{
  DECODE_START(2, it);
  decode(pool_id, it);
  decode(image_id, it);
...
void
ChildImageSpec::dump(Formatter* f) const
{
  f->dump_int("pool_id", pool_id);
  f->dump_string("pool_namespace", pool_namespace);
  f->dump_string("image_id", image_id);
...
std::list<ChildImageSpec>
ChildImageSpec::generate_test_instances()
{
...
std::ostream&
operator<<(std::ostream& os, const ChildImageSpec& rhs)
{
  os << "[" << "pool_id=" << rhs.pool_id << ", "
     << "pool_namespace=" << rhs.pool_namespace << ", "
...
void
GroupImageSpec::encode(bufferlist& bl) const
{
  ENCODE_START(1, 1, bl);
  encode(image_id, bl);
  encode(pool_id, bl);
...
void
GroupImageSpec::decode(bufferlist::const_iterator& it)
{
  DECODE_START(1, it);
  decode(image_id, it);
  decode(pool_id, it);
...
void
GroupImageSpec::dump(Formatter* f) const
{
  f->dump_string("image_id", image_id);
  f->dump_int("pool_id", pool_id);
}
...
int
GroupImageSpec::from_key(const std::string& image_key, GroupImageSpec* spec)
{
  if (nullptr == spec)
    return -EINVAL;
  int prefix_len = cls::rbd::RBD_GROUP_IMAGE_KEY_PREFIX.size();
  std::string data_string =
      image_key.substr(prefix_len, image_key.size() - prefix_len);
...
GroupImageSpec::image_key()
{
  if (-1 == pool_id)
    ...
    ostringstream oss;
    oss << RBD_GROUP_IMAGE_KEY_PREFIX << std::setw(16) << std::setfill('0')
        << std::hex << pool_id << "_" << image_id;
    return oss.str();
  }
}

std::list<GroupImageSpec>
GroupImageSpec::generate_test_instances()
{
...
void
GroupImageStatus::encode(bufferlist& bl) const
{
  ENCODE_START(1, 1, bl);
  encode(spec, bl);
  encode(state, bl);
...
void
GroupImageStatus::decode(bufferlist::const_iterator& it)
{
  DECODE_START(1, it);
  decode(spec, it);
  decode(state, it);
...
void
GroupImageStatus::dump(Formatter* f) const
{
  spec.dump(f);
  f->dump_string("state", state_to_string());
}

std::list<GroupImageStatus>
GroupImageStatus::generate_test_instances()
{
  std::list<GroupImageStatus> o;
  o.push_back(GroupImageStatus(
      GroupImageSpec("10152ae8944a", 0), GROUP_IMAGE_LINK_STATE_ATTACHED));
  o.push_back(GroupImageStatus(
      GroupImageSpec("1018643c9869", 3), GROUP_IMAGE_LINK_STATE_ATTACHED));
  o.push_back(GroupImageStatus(
      GroupImageSpec("10152ae8944a", 0), GROUP_IMAGE_LINK_STATE_INCOMPLETE));
  o.push_back(GroupImageStatus(
      GroupImageSpec("1018643c9869", 3), GROUP_IMAGE_LINK_STATE_INCOMPLETE));
  return o;
}

void
GroupSpec::encode(bufferlist& bl) const
{
  ENCODE_START(1, 1, bl);
  encode(pool_id, bl);
  encode(group_id, bl);
...
void
GroupSpec::decode(bufferlist::const_iterator& it)
{
  DECODE_START(1, it);
  decode(pool_id, it);
  decode(group_id, it);
...
void
GroupSpec::dump(Formatter* f) const
{
...
bool
GroupSpec::is_valid() const
{
  return (!group_id.empty()) && (pool_id != -1);
}

std::list<GroupSpec>
GroupSpec::generate_test_instances()
{
...
void
GroupSnapshotNamespace::encode(bufferlist& bl) const
{
  using ceph::encode;
...
void
GroupSnapshotNamespace::decode(bufferlist::const_iterator& it)
{
  using ceph::decode;
...
void
GroupSnapshotNamespace::dump(Formatter* f) const
{
...
void
TrashSnapshotNamespace::encode(bufferlist& bl) const
{
  using ceph::encode;
...
void
TrashSnapshotNamespace::decode(bufferlist::const_iterator& it)
{
  using ceph::decode;
  ...
  original_snapshot_namespace_type =
      static_cast<SnapshotNamespaceType>(snap_type);
}

void
TrashSnapshotNamespace::dump(Formatter* f) const
{
...
void
MirrorSnapshotNamespace::encode(bufferlist& bl) const
{
  using ceph::encode;
  encode(state, bl);
  encode(complete, bl);
...
void
MirrorSnapshotNamespace::decode(bufferlist::const_iterator& it)
{
  using ceph::decode;
  decode(state, it);
  decode(complete, it);
...
void
MirrorSnapshotNamespace::dump(Formatter* f) const
{
  f->dump_stream("state") << state;
...
public:
  explicit DumpSnapshotNamespaceVisitor(
      Formatter* formatter,
...
get_snap_namespace_type(const SnapshotNamespace& snapshot_namespace)
{
  return static_cast<SnapshotNamespaceType>(
      snapshot_namespace.visit(GetTypeVisitor()));
}

void
SnapshotInfo::encode(bufferlist& bl) const
{
  ENCODE_START(1, 1, bl);
  encode(id, bl);
...
void
SnapshotInfo::decode(bufferlist::const_iterator& it)
{
  DECODE_START(1, it);
  decode(id, it);
...
void
SnapshotInfo::dump(Formatter* f) const
{
...
std::list<SnapshotInfo>
SnapshotInfo::generate_test_instances()
{
  std::list<SnapshotInfo> o;
  o.push_back(SnapshotInfo(
      1ULL, UserSnapshotNamespace{}, "snap1", 123, {123456, 0}, 12));
  o.push_back(SnapshotInfo(
      2ULL, GroupSnapshotNamespace{567, "group1", "snap1"}, "snap1", 123,
      {123456, 0}, 987));
  o.push_back(SnapshotInfo(
      3ULL, TrashSnapshotNamespace{SNAPSHOT_NAMESPACE_TYPE_USER, "snap1"},
      "12345", 123, {123456, 0}, 429));
  o.push_back(SnapshotInfo(
      1ULL,
      MirrorSnapshotNamespace{
          MIRROR_SNAPSHOT_STATE_PRIMARY, {"1", "2"}, "", CEPH_NOSNAP},
      "snap1", 123, {123456, 0}, 12));
  o.push_back(SnapshotInfo(
      1ULL,
      MirrorSnapshotNamespace{
          MIRROR_SNAPSHOT_STATE_NON_PRIMARY, {"1", "2"}, "uuid", 123},
      "snap1", 123, {123456, 0}, 12));
  return o;
}

void
SnapshotNamespace::encode(bufferlist& bl) const
{
  ENCODE_START(1, 1, bl);
...
void
SnapshotNamespace::decode(bufferlist::const_iterator& p)
{
  DECODE_START(1, p);
  uint32_t snap_type;
  decode(snap_type, p);
...
void
SnapshotNamespace::dump(Formatter* f) const
{
  visit(DumpSnapshotNamespaceVisitor(f, "snapshot_namespace_type"));
}

std::list<SnapshotNamespace>
SnapshotNamespace::generate_test_instances()
{
  std::list<SnapshotNamespace> o;
  o.push_back(SnapshotNamespace(UserSnapshotNamespace()));
  o.push_back(SnapshotNamespace(
      GroupSnapshotNamespace(0, "10152ae8944a", "2118643c9732")));
  o.push_back(SnapshotNamespace(
      GroupSnapshotNamespace(5, "1018643c9869", "33352be8933c")));
  o.push_back(SnapshotNamespace(TrashSnapshotNamespace()));
  o.push_back(SnapshotNamespace(MirrorSnapshotNamespace(
      MIRROR_SNAPSHOT_STATE_PRIMARY, {"peer uuid"}, "", CEPH_NOSNAP)));
  o.push_back(SnapshotNamespace(MirrorSnapshotNamespace(
      MIRROR_SNAPSHOT_STATE_PRIMARY_DEMOTED, {"peer uuid"}, "", CEPH_NOSNAP)));
  o.push_back(SnapshotNamespace(MirrorSnapshotNamespace(
      MIRROR_SNAPSHOT_STATE_NON_PRIMARY, {"peer uuid"}, "uuid", 123)));
  o.push_back(SnapshotNamespace(MirrorSnapshotNamespace(
      MIRROR_SNAPSHOT_STATE_NON_PRIMARY_DEMOTED, {"peer uuid"}, "uuid", 123)));
  return o;
}

std::ostream&
operator<<(std::ostream& os, const SnapshotNamespace& ns)
{
  return ns.visit([&os](const auto& val) -> std::ostream& { return os << val; });
}

std::ostream&
operator<<(std::ostream& os, const SnapshotNamespaceType& type)
{
  switch (type) {
...
std::ostream&
operator<<(std::ostream& os, const UserSnapshotNamespace& ns)
{
...
std::ostream&
operator<<(std::ostream& os, const GroupSnapshotNamespace& ns)
{
  os << "[" << SNAPSHOT_NAMESPACE_TYPE_GROUP << " "
     << "group_pool=" << ns.group_pool << ", " << "group_id=" << ns.group_id
     << ", " << "group_snapshot_id=" << ns.group_snapshot_id << "]";
  return os;
}

std::ostream&
operator<<(std::ostream& os, const TrashSnapshotNamespace& ns)
{
...
std::ostream&
operator<<(std::ostream& os, const MirrorSnapshotNamespace& ns)
{
  os << "[" << SNAPSHOT_NAMESPACE_TYPE_MIRROR << " " << "state=" << ns.state
...
std::ostream&
operator<<(std::ostream& os, const UnknownSnapshotNamespace& ns)
{
  os << "[unknown]";
  return os;
}
...
std::ostream&
operator<<(std::ostream& os, MirrorSnapshotState type)
{
  switch (type) {
...
void
ImageSnapshotSpec::encode(bufferlist& bl) const
{
  using ceph::encode;
  ENCODE_START(1, 1, bl);
  encode(pool, bl);
...
void
ImageSnapshotSpec::decode(bufferlist::const_iterator& it)
{
  using ceph::decode;
  DECODE_START(1, it);
  decode(pool, it);
...
void
ImageSnapshotSpec::dump(Formatter* f) const
{
...
std::list<ImageSnapshotSpec>
ImageSnapshotSpec::generate_test_instances()
{
...
void
GroupSnapshot::encode(bufferlist& bl) const
{
  using ceph::encode;
  ENCODE_START(1, 1, bl);
  encode(id, bl);
...
void
GroupSnapshot::decode(bufferlist::const_iterator& it)
{
  using ceph::decode;
  DECODE_START(1, it);
  decode(id, it);
...
void
GroupSnapshot::dump(Formatter* f) const
{
  f->dump_string("id", id);
  f->dump_string("name", name);
...
std::list<GroupSnapshot>
GroupSnapshot::generate_test_instances()
{
  std::list<GroupSnapshot> o;
  o.push_back(GroupSnapshot(
      "10152ae8944a", "groupsnapshot1", GROUP_SNAPSHOT_STATE_INCOMPLETE));
  o.push_back(GroupSnapshot(
      "1018643c9869", "groupsnapshot2", GROUP_SNAPSHOT_STATE_COMPLETE));
  return o;
}

void
TrashImageSpec::encode(bufferlist& bl) const
{
  ENCODE_START(2, 1, bl);
  encode(source, bl);
  encode(name, bl);
...
void
TrashImageSpec::decode(bufferlist::const_iterator& it)
{
  DECODE_START(2, it);
  decode(source, it);
  decode(name, it);
...
void
TrashImageSpec::dump(Formatter* f) const
{
...
void
MirrorImageMap::encode(bufferlist& bl) const
{
  ENCODE_START(1, 1, bl);
...
void
MirrorImageMap::decode(bufferlist::const_iterator& it)
{
  DECODE_START(1, it);
...
void
MirrorImageMap::dump(Formatter* f) const
{
...
std::list<MirrorImageMap>
MirrorImageMap::generate_test_instances()
{
...
bool
MirrorImageMap::operator==(const MirrorImageMap& rhs) const
{
...
std::ostream&
operator<<(std::ostream& os, const MirrorImageMap& image_map)
{
  return os << "[" << "instance_id=" << image_map.instance_id
            << ", mapped_time=" << image_map.mapped_time << "]";
}

std::ostream&
operator<<(std::ostream& os, const MigrationHeaderType& type)
{
  switch (type) {
...
std::ostream&
operator<<(std::ostream& os, const MigrationState& migration_state)
{
...
void
MigrationSpec::encode(bufferlist& bl) const
{
...
void
MigrationSpec::decode(bufferlist::const_iterator& bl)
{
  DECODE_START(3, bl);
...
std::ostream&
operator<<(std::ostream& os, const std::map<uint64_t, uint64_t>& snap_seqs)
{
  os << "{";
  size_t count = 0;
...
void
MigrationSpec::dump(Formatter* f) const
{
...
std::list<MigrationSpec>
MigrationSpec::generate_test_instances()
{
  std::list<MigrationSpec> o;
  o.push_back(MigrationSpec());
  o.push_back(MigrationSpec(
      MIGRATION_HEADER_TYPE_SRC, 1, "ns", "image_name", "image_id", "",
      {{1, 2}}, 123, true, MIRROR_IMAGE_MODE_SNAPSHOT, true,
      MIGRATION_STATE_PREPARED, "description"));
  o.push_back(MigrationSpec(
      MIGRATION_HEADER_TYPE_DST, -1, "", "", "", "{\"format\": \"raw\"}",
      {{1, 2}}, 123, true, MIRROR_IMAGE_MODE_SNAPSHOT, true,
      MIGRATION_STATE_PREPARED, "description"));
  return o;
}
...
std::ostream&
operator<<(std::ostream& os, const MigrationSpec& migration_spec)
{
  os << "[" << "header_type=" << migration_spec.header_type << ", ";
...
std::ostream&
operator<<(std::ostream& os, const AssertSnapcSeqState& state)
{
  switch (state) {
...
void
sanitize_entity_inst(entity_inst_t* entity_inst)
{
