...
inline void
encode(DirectoryState state, ceph::buffer::list& bl, uint64_t features = 0)
{
  ceph::encode(static_cast<uint8_t>(state), bl);
}

inline void
decode(DirectoryState& state, ceph::buffer::list::const_iterator& it)
{
  uint8_t int_state;
...
inline void
encode(
    const GroupImageLinkState& state,
    ceph::buffer::list& bl,
    uint64_t features = 0)
{
  using ceph::encode;
...
inline void
decode(GroupImageLinkState& state, ceph::buffer::list::const_iterator& it)
{
  uint8_t int_state;
  using ceph::decode;
  decode(int_state, it);
...
struct MirrorPeer {
  ...
  bool
  operator!=(const MirrorPeer& rhs) const
  {
    return (!(*this == rhs));
  }
};
...
inline void
decode(MirrorImageStatusState& state, ceph::buffer::list::const_iterator& it)
{
  uint8_t int_state;
  using ceph::decode;
  decode(int_state, it);
...
struct ParentImageSpec {
  ...
  bool
  operator==(const ParentImageSpec& rhs) const
  {
    return (
...
struct ChildImageSpec {
  ...
  inline bool
  operator==(const ChildImageSpec& rhs) const
  {
    return (
        pool_id == rhs.pool_id && pool_namespace == rhs.pool_namespace &&
...
struct UserSnapshotNamespace {
  ...
  inline bool
  operator==(const UserSnapshotNamespace& usn) const
  {
    return true;
  }
...
struct GroupSnapshotNamespace {
  ...
  inline bool
  operator==(const GroupSnapshotNamespace& gsn) const
  {
    return group_pool == gsn.group_pool && group_id == gsn.group_id &&
...
struct TrashSnapshotNamespace {
  ...
  inline bool
  operator==(const TrashSnapshotNamespace& usn) const
  {
    return true;
  }
...
inline void
encode(
    const MirrorSnapshotState& state,
    ceph::buffer::list& bl,
    uint64_t features = 0)
{
  using ceph::encode;
...
inline void
decode(MirrorSnapshotState& state, ceph::buffer::list::const_iterator& it)
{
  using ceph::decode;
  uint8_t int_state;
  decode(int_state, it);
...
struct MirrorSnapshotNamespace {
  ...
  {
    return (
        state == MIRROR_SNAPSHOT_STATE_PRIMARY ||
        state == MIRROR_SNAPSHOT_STATE_PRIMARY_DEMOTED);
  }

  inline bool
  is_non_primary() const
  {
    return (
        state == MIRROR_SNAPSHOT_STATE_NON_PRIMARY ||
  ...
  {
    return (
        is_non_primary() && primary_mirror_uuid.empty() &&
  ...
  inline bool
  operator==(const MirrorSnapshotNamespace& rhs) const
  {
    return state == rhs.state && complete == rhs.complete &&
...
struct UnknownSnapshotNamespace {
  ...
  inline bool
  operator==(const UnknownSnapshotNamespace& gsn) const
  {
    return true;
  }
...
struct SnapshotNamespace : public SnapshotNamespaceVariant {
  ...
  {
    return std::visit(
        std::forward<F>(f), static_cast<const SnapshotNamespaceVariant&>(*this));
  }
  ...
  {
    return std::visit(
        std::forward<F>(f), static_cast<SnapshotNamespaceVariant&>(*this));
  }
...
inline void
encode(
    const GroupSnapshotState& state,
    ceph::buffer::list& bl,
    uint64_t features = 0)
{
  using ceph::encode;
...
inline void
decode(GroupSnapshotState& state, ceph::buffer::list::const_iterator& it)
{
  using ceph::decode;
  uint8_t int_state;
  decode(int_state, it);
...
struct ImageSnapshotSpec {
  ...
  ImageSnapshotSpec(int64_t _pool, std::string _image_id, snapid_t _snap_id) :
    pool(_pool), image_id(_image_id), snap_id(_snap_id)
  {}
...
inline std::ostream&
operator<<(std::ostream& os, const TrashImageSource& source)
{
  switch (source) {
...
inline void
decode(TrashImageSource& source, ceph::buffer::list::const_iterator& it)
{
  uint8_t int_source;
  using ceph::decode;
...
inline void
encode(const TrashImageState& state, ceph::buffer::list& bl)
{
  using ceph::encode;
  encode(static_cast<uint8_t>(state), bl);
}
...
inline void
decode(TrashImageState& state, ceph::buffer::list::const_iterator& it)
{
  uint8_t int_state;
  using ceph::decode;
  decode(int_state, it);
...
struct TrashImageSpec {
  ...
  inline bool
  operator==(const TrashImageSpec& rhs) const
  {
    return (
        source == rhs.source && name == rhs.name &&
...
struct MirrorImageMap {
  ...
  MirrorImageMap(
    ...
    instance_id(instance_id), mapped_time(mapped_time), data(data)
  {}
...
inline void
encode(const MigrationHeaderType& type, ceph::buffer::list& bl)
{
  using ceph::encode;
...
inline void
decode(MigrationHeaderType& type, ceph::buffer::list::const_iterator& it)
{
  uint8_t int_type;
  using ceph::decode;
  decode(int_type, it);
...
inline void
encode(const MigrationState& state, ceph::buffer::list& bl)
{
  using ceph::encode;
  encode(static_cast<uint8_t>(state), bl);
}
...
inline void
decode(MigrationState& state, ceph::buffer::list::const_iterator& it)
{
  uint8_t int_state;
  using ceph::decode;
  decode(int_state, it);
...
struct MigrationSpec {
  ...
  MigrationSpec(
      MigrationHeaderType header_type,
      int64_t pool_id,
      const std::string& pool_namespace,
  ...
  inline bool
  operator==(const MigrationSpec& ms) const
  {
...
inline void
encode(const AssertSnapcSeqState& state, ceph::buffer::list& bl)
{
  using ceph::encode;
  encode(static_cast<uint8_t>(state), bl);
}
...
inline void
decode(AssertSnapcSeqState& state, ceph::buffer::list::const_iterator& it)
{
  uint8_t int_state;
  using ceph::decode;
  decode(int_state, it);
