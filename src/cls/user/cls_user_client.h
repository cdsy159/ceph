...
void cls_user_bucket_list(
    ...
    bool* truncated,
    int* pret);
void cls_user_get_header(
    librados::ObjectReadOperation& op,
    cls_user_header* header,
    int* pret);
int cls_user_get_header_async(
...
void cls_user_account_resource_add(
    librados::ObjectWriteOperation& op,
...
void cls_user_account_resource_get(
    librados::ObjectReadOperation& op,
...
void cls_user_account_resource_rm(
    librados::ObjectWriteOperation& op,
    std::string_view name);

/// List the resources linked to an account.
void cls_user_account_resource_list(
    librados::ObjectReadOperation& op,
