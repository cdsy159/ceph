...
void
cls_version_set(librados::ObjectWriteOperation& op, obj_version& objv)
{
  bufferlist in;
...
void
cls_version_inc(librados::ObjectWriteOperation& op)
{
  bufferlist in;
...
void
cls_version_read(librados::ObjectReadOperation& op, obj_version* objv)
{
  bufferlist inbl;
...
int
cls_version_read(librados::IoCtx& io_ctx, std::string& oid, obj_version* ver)
{
  bufferlist in, out;
