...
struct blocked_handler<D, Ts...> {
  ...
  void
  operator()(Arg0&& arg0, Args&&... args) noexcept
  {
    static_assert(sizeof...(Ts) == sizeof...(Args));
    std::scoped_lock l(*m);
    *dispo = std::move(arg0);
...
struct blocked_handler<D, T> {
  ...
  void
  operator()(Arg0&& arg0, Arg&& arg) noexcept
  {
    std::scoped_lock l(*m);
    *dispo = std::move(arg0);
    *val = std::move(arg);
...
public:
  ...
  static return_type
  initiate(Initiation&& init, use_blocked_t, Args&&... args)
  {
    ...
    std::move(init)(
        completion_handler_type(&vals, &m, &cv, &done),
...
public:
  ...
  initiate(Initiation&& init, use_blocked_t, Args&&... args)
  {
    ...
    std::move(init)(
        completion_handler_type(&dispo, &vals, &m, &cv, &done),
        std::forward<Args>(args)...);
...
public:
  ...
  initiate(Initiation&& init, use_blocked_t, Args&&... args)
  {
    ...
    std::move(init)(
        completion_handler_type(&val, &m, &cv, &done),
        std::forward<Args>(args)...);
...
public:
  ...
  initiate(Initiation&& init, use_blocked_t, Args&&... args)
  {
    ...
    std::move(init)(
        completion_handler_type(&dispo, &val, &m, &cv, &done),
        std::forward<Args>(args)...);
...
public:
  ...
  initiate(Initiation&& init, use_blocked_t, Args&&... args)
  {
    ...
    std::move(init)(
        completion_handler_type(&m, &cv, &done), std::forward<Args>(args)...);
...
public:
  ...
  initiate(Initiation&& init, use_blocked_t, Args&&... args)
  {
    ...
    std::move(init)(
        completion_handler_type(&dispo, &m, &cv, &done),
        std::forward<Args>(args)...);
