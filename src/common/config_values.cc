...
int
ConfigValues::rm_val(const std::string_view key, int level)
{
...
void
ConfigValues::set_logging(int which, const char* val)
{
  int log, gather;
...
bool
ConfigValues::contains(const std::string_view key) const
{
