...
protected:
  ...
  DataGenerator(const ObjectModel& model) :
    m_model(model)
  {}
};
...
public:
  ...
  bufferlist generate_wrong_data(uint64_t offset, uint64_t length) override;
};
...
private:
  ...
  const ErrorType getErrorTypeForBlock(
      uint64_t read_offset,
      uint64_t block_offset,
      const bufferlist& bufferlist);

  void printDebugInformationForBlock(
      uint64_t read_offset,
      uint64_t block_offset,
      const bufferlist& bufferlist);
  void printDebugInformationForRange(
      uint64_t read_offset,
  ...
  void printDebugInformationDataBodyMismatchRange(
      ...
      uint64_t range_length_in_blocks,
      const bufferlist& bufferlist);
  void printDebugInformationDataNotFoundRange(
      uint64_t ßread_offset,
      uint64_t start_block_offset,
      uint64_t range_length_in_blocks,
      const bufferlist& bufferlist);
  void printDebugInformationCorruptRange(
      uint64_t read_offset,
      uint64_t start_block_offset,
      uint64_t range_length_in_blocks,
      const bufferlist& bufferlist);

  void printDebugInformationForOffsets(
      uint64_t read_offset,
