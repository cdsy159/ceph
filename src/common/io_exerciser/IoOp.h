...
public:
  ...
  static std::unique_ptr<SingleReadOp> generate(uint64_t offset, uint64_t length);
};
...
public:
  DoubleReadOp(
      ...
      uint64_t offset2,
      uint64_t length2);
  static std::unique_ptr<DoubleReadOp> generate(
      uint64_t offset1,
      uint64_t length1,
      uint64_t offset2,
      uint64_t length2);
...
public:
  ...
  static std::unique_ptr<SingleWriteOp> generate(
      uint64_t offset,
      uint64_t length);
};
...
public:
  DoubleWriteOp(
      ...
      uint64_t offset2,
      uint64_t length2);
  static std::unique_ptr<DoubleWriteOp> generate(
      uint64_t offset1,
      uint64_t length1,
      uint64_t offset2,
      uint64_t length2);
...
public:
  ...
  static std::unique_ptr<SingleFailedWriteOp> generate(
      uint64_t offset,
      uint64_t length);
};
...
public:
  DoubleFailedWriteOp(
      ...
      uint64_t offset2,
      uint64_t length2);
  static std::unique_ptr<DoubleFailedWriteOp> generate(
      uint64_t offset1,
      uint64_t length1,
      uint64_t offset2,
      uint64_t length2);
...
protected:
  ...
  get_inject_type_string() const override
  {
    return "read";
  }
};
