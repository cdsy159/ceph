...
const std::string
Model::get_primary_oid() const
{
  return primary_oid;
}

const std::string
Model::get_secondary_oid() const
{
  return secondary_oid;
}

void
Model::set_primary_oid(const std::string& new_oid)
{
  primary_oid = new_oid;
}

void
Model::set_secondary_oid(const std::string& new_oid)
{
  secondary_oid = new_oid;
}

void
Model::swap_primary_secondary_oid()
{
...
const uint64_t
Model::get_block_size() const
{
  return block_size;
}

int
Model::get_num_io() const
{
  return num_io;
}
