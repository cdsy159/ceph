...
void
BalancerOffRequest::dump(Formatter* f) const
{
  encode_json("prefix", "balancer off", f);
}

void
BalancerOffRequest::decode_json(JSONObj* obj)
{}

void
BalancerStatusRequest::dump(Formatter* f) const
{
  encode_json("prefix", "balancer status", f);
}

void
BalancerStatusRequest::decode_json(JSONObj* obj)
{}

void
BalancerStatusReply::dump(Formatter* f) const
{
...
void
BalancerStatusReply::decode_json(JSONObj* obj)
{
  JSONDecoder::decode_json("active", active, obj);
  JSONDecoder::decode_json(
      "last_optimization_duration", last_optimization_duration, obj);
  JSONDecoder::decode_json(
      "last_optimization_started", last_optimization_started, obj);
  JSONDecoder::decode_json("mode", mode, obj);
  JSONDecoder::decode_json(
      "no_optimization_needed", no_optimization_needed, obj);
