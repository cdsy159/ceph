...
static void
choose_from(CryptoRandom* random, std::string_view table, char* dest, size_t size)
{
...
std::string
gen_rand_alphanumeric(CephContext* cct, size_t size)
{
  std::string str;
  str.resize(size + 1);
...
std::string
gen_rand_alphanumeric_lower(CephContext* cct, size_t size)
{
  std::string str;
  str.resize(size + 1);
...
std::string
gen_rand_alphanumeric_upper(CephContext* cct, size_t size)
{
  std::string str;
  str.resize(size + 1);
...
std::string
gen_rand_alphanumeric_no_underscore(CephContext* cct, size_t size)
{
  std::string str;
  str.resize(size + 1);
...
std::string
gen_rand_alphanumeric_plain(CephContext* cct, size_t size)
{
  std::string str;
  str.resize(size + 1);
...
std::string
gen_rand_numeric(CephContext* cct, size_t size)
{
  std::string str;
  str.resize(size + 1);
