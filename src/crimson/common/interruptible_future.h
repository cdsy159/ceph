...
#define INTR_FUT_DEBUG(FMT_MSG, ...)                 \
  crimson::get_logger(ceph_subsys_crimson_interrupt) \
      .trace(FMT_MSG, ##__VA_ARGS__)
#else
#define INTR_FUT_DEBUG(FMT_MSG, ...)
#endif
...
struct lw_shared_ptr_accessors<
    ...
    void>
  : lw_shared_ptr_accessors_no_esft<
        ::crimson::os::seastore::TransactionConflictCondition> {};
} // namespace seastar::internal
...
struct is_tuple_of_futures<std::tuple<
    crimson::interruptible::interruptible_future_detail<InterruptCond, FutureType>,
    Rest...>> : is_tuple_of_futures<std::tuple<Rest...>> {};
} // namespace seastar::impl
...
struct interrupt_cond_t {
  ...
  void
  set(InterruptCondRef<InterruptCond>& ic)
  {
    INTR_FUT_DEBUG(
        "{}: going to set interrupt_cond: {}, ic: {}", __func__,
        (void*)interrupt_cond.get(), (void*)ic.get());
    if (!interrupt_cond) {
      interrupt_cond = ic;
    }
    ...
    ref_count++;
    INTR_FUT_DEBUG(
        "{}: interrupt_cond: {}, ref_count: {}", __func__,
        (void*)interrupt_cond.get(), ref_count);
  }
  ...
  reset()
  {
    ...
    if (--ref_count == 0) {
      INTR_FUT_DEBUG(
          "{}: clearing interrupt_cond: {},{}", __func__,
          (void*)interrupt_cond.get(), typeid(InterruptCond).name());
      interrupt_cond.release();
    } else {
      INTR_FUT_DEBUG(
          "{}: end without clearing interrupt_cond: {},{}, ref_count: {}",
          __func__, (void*)interrupt_cond.get(), typeid(InterruptCond).name(),
          ref_count);
    }
  }
};
...
extern template thread_local interrupt_cond_t<
    crimson::os::seastore::TransactionConflictCondition>
...
struct is_interruptible_future<
    interruptible_future_detail<InterruptCond, FutureType>>
    ...
    Args&&... args)
{
  ...
  auto fut =
      interrupt_condition->template may_interrupt<typename futurator_t::type>();
  INTR_FUT_DEBUG(
      "call_with_interruption_impl: may_interrupt: {}, "
      "local interrupt_condition: {}, "
      "global interrupt_cond: {},{}",
      (bool)fut, (void*)interrupt_condition.get(),
    ...
    Ret&& fut)
{
  ...
  return internal::call_with_interruption_impl(
      interrupt_condition, std::forward<Func>(func), std::move(fut));
}
...
{
  return internal::call_with_interruption_impl(
      interrupt_condition, std::forward<Func>(func), std::forward<T>(arg));
}
...
Result
non_futurized_call_with_interruption(
    InterruptCondRef<InterruptCond> interrupt_condition,
    Func&& func,
    T&&... args)
{
  ...
  try {
    ...
    INTR_FUT_DEBUG(
        ...
        "interrupt_condition: {}, interrupt_cond: {},{}",
        e, (void*)interrupt_condition.get(),
        (void*)interrupt_cond<InterruptCond>.interrupt_cond.get(),
        typeid(InterruptCond).name());
    // Clear the global "interrupt_cond" to prevent it from interfering other
    // continuation chains.
...
public:
  ...
  void
  set_coroutine(seastar::task& coroutine) noexcept
  {
  ...
  get()
  {
    ...
    try {
      ...
      auto ifut =
          interruption_condition->template may_interrupt<seastar::future<>>();
      if (ifut) {
      ...
      INTR_FUT_DEBUG(
          ...
          e, (void*)interrupt_cond<InterruptCond>.interrupt_cond.get(),
          typeid(InterruptCond).name());
      throw;
    }
  }
  ...
  template <
      typename Func,
      typename Result =
          interrupt_futurize_t<std::invoke_result_t<Func, seastar::future<T>>>>
  [[gnu::always_inline]]
  Result
  then_wrapped_interruptible(Func&& func)
  {
        ...
        [func = std::move(func),
         interrupt_condition = interrupt_cond<InterruptCond>.interrupt_cond](
          ...
          return call_with_interruption(
              std::move(interrupt_condition), std::forward<Func>(func),
              std::move(fut));
        });
  }
  ...
  then_interruptible(Func&& func)
  {
    ...
    if constexpr (std::is_void_v<T>) {
      auto fut = core_type::then(
          [func = std::move(func),
           interrupt_condition =
               interrupt_cond<InterruptCond>.interrupt_cond]() mutable {
      ...
      auto fut = core_type::then(
          [func = std::move(func),
           interrupt_condition = interrupt_cond<InterruptCond>.interrupt_cond](
              T&& arg) mutable {
            return call_with_interruption(
                interrupt_condition, std::move(func), std::forward<T>(arg));
          });
      return (interrupt_futurize_t<decltype(fut)>)(std::move(fut));
    }
  }
  ...
  [[gnu::always_inline]]
  auto
  then_unpack_interruptible(Func&& func)
  {
    return then_interruptible(
        [func = std::forward<Func>(func)](T&& tuple) mutable {
  ...
  template <
      typename Func,
      typename Result =
          interrupt_futurize_t<std::result_of_t<Func(std::exception_ptr)>>>
  [[gnu::always_inline]]
  Result
  handle_exception_interruptible(Func&& func)
  {
    ceph_assert(interrupt_cond<InterruptCond>.interrupt_cond);
    return core_type::then_wrapped(
        [func = std::forward<Func>(func),
         interrupt_condition = interrupt_cond<InterruptCond>.interrupt_cond](
          ...
          if (!fut.failed()) {
            ...
            return call_with_interruption(
                interrupt_condition, std::move(func), fut.get_exception());
          }
        });
  }

  template <
      bool may_interrupt = true,
      typename Func,
      typename Result = interrupt_futurize_t<std::result_of_t<Func()>>>
  [[gnu::always_inline]]
  Result
  finally_interruptible(Func&& func)
  {
  ...
  [[gnu::always_inline]]
  Result
  handle_exception_type_interruptible(Func&& func)
  {
    ceph_assert(interrupt_cond<InterruptCond>.interrupt_cond);
         ...
         interrupt_condition = interrupt_cond<InterruptCond>.interrupt_cond](
          ...
          if (!fut.failed()) {
            ...
            try {
              ...
              return call_with_interruption(
                  interrupt_condition, std::move(func), ex);
            }
          }
        });
  }
...
private:
  ...
  template <
      typename Func,
      typename Result =
          interrupt_futurize_t<std::result_of_t<Func(seastar::future<T>)>>>
  [[gnu::always_inline]]
  Result
  ...
  friend inline auto ::seastar::internal::do_with_impl(
      T1&& rv1,
      T2&& rv2,
      T3_or_F&& rv3,
      More&&... more);
...
struct interruptible_errorator {
  ...
  using future = interruptible_future_detail<
      InterruptCond,
  ...
  static future<ValueT>
  make_interruptible(FutureType<ValueT>&& fut)
  {
    return std::move(fut);
  }
  ...
  {
    return interruptible_future_detail<
        InterruptCond, typename Errorator::template future<>>(Errorator::now());
  }
...
public:
  ...
  interruptible_future_detail(
      interruptible_future_detail<
          ...
          ErroratedFuture2<::crimson::errorated_future_marker<U...>>>&& fut) :
    core_type(
        static_cast<typename std::decay_t<decltype(fut)>::core_type&&>(fut))
  {
    using src_errorator_t = typename ErroratedFuture2<
        ::crimson::errorated_future_marker<U...>>::errorator_type;
    static_assert(
        core_type::errorator_type::template contains_once_v<src_errorator_t>,
  ...
  interruptible_future_detail(
    ...
    core_type(
        ::seastar::futurize<core_type>::make_exception_future(std::move(state)))
  {}
  ...
  interruptible_future_detail(
    ...
    core_type(
        ::seastar::futurize<core_type>::make_exception_future(std::move(ep)))
  {}
  ...
  [[gnu::always_inline]]
  auto
  safe_then_interruptible(ValueInterruptCondT&& valfunc, ErrorVisitorT&& errfunc)
  {
    ...
    auto fut = core_type::safe_then(
        [func = std::move(valfunc),
         interrupt_condition = interrupt_cond<InterruptCond>.interrupt_cond](
            T&& args) mutable {
          return call_with_interruption(
              interrupt_condition, std::move(func), std::forward<T>(args));
        },
        [func = std::move(errfunc),
         interrupt_condition = interrupt_cond<InterruptCond>.interrupt_cond](
            auto&& err) mutable -> decltype(auto) {
          static_assert(!std::is_void_v<std::invoke_result_t<
                            ErrorVisitorT, std::decay_t<decltype(err)>>>);
          constexpr bool is_assert = std::is_same_v<
              std::decay_t<std::invoke_result_t<
                  ErrorVisitorT, std::decay_t<decltype(err)>>>,
              ::crimson::no_touch_error_marker>;
          constexpr bool return_err = ::crimson::is_error_v<std::decay_t<
              std::invoke_result_t<ErrorVisitorT, std::decay_t<decltype(err)>>>>;
          if constexpr (return_err || is_assert) {
            return non_futurized_call_with_interruption(
                interrupt_condition, std::move(func), std::move(err));
          } else {
            return call_with_interruption(
                interrupt_condition, std::move(func), std::move(err));
          }
  ...
  [[gnu::always_inline]]
  auto
  safe_then_interruptible(ValueInterruptCondT&& valfunc)
  {
    ceph_assert(interrupt_cond<InterruptCond>.interrupt_cond);
    auto fut = core_type::safe_then(
        [func = std::move(valfunc),
  ...
  [[gnu::always_inline]]
  auto
  safe_then_unpack_interruptible(ValFuncT&& func, ErrorFuncT&& errfunc)
  {
  ...
  [[gnu::always_inline]]
  auto
  safe_then_unpack_interruptible(ValFuncT&& func)
  {
    return safe_then_interruptible(
        [func = std::forward<ValFuncT>(func)](T&& tuple) mutable {
          return std::apply(std::forward<ValFuncT>(func), std::move(tuple));
      ...
      ErrorVisitorTailT&&... err_func_tail)
  {
    return safe_then_interruptible(
        std::forward<ValueInterruptCondT>(valfunc),
        ::crimson::composer(
            std::forward<ErrorVisitorHeadT>(err_func_head),
  ...
  auto
  handle_error_interruptible(ErrorFunc&& errfunc)
  {
      ...
      auto fut = core_type::handle_error(
          [errfunc = std::move(errfunc),
           interrupt_condition = interrupt_cond<InterruptCond>.interrupt_cond](
              auto&& err) mutable -> decltype(auto) {
            static_assert(!std::is_void_v<std::invoke_result_t<
                              ErrorFunc, std::decay_t<decltype(err)>>>);
            constexpr bool is_assert = std::is_same_v<
                std::decay_t<
                    std::invoke_result_t<ErrorFunc, std::decay_t<decltype(err)>>>,
                ::crimson::no_touch_error_marker>;
            constexpr bool return_err = ::crimson::is_error_v<std::decay_t<
                std::invoke_result_t<ErrorFunc, std::decay_t<decltype(err)>>>>;
            if constexpr (return_err || is_assert) {
      ...
      ErrorFuncTail&&... error_func_tail)
  {
    ...
    return this->handle_error_interruptible(::crimson::composer(
...
using interruptible_errorated_future = interruptible_future_detail<
    InterruptCond,
...
public:
  ...
  {
    return interruptible_future_detail<InterruptCond, FutureType>(
        std::move(fut));
  }

  [[gnu::always_inline]]
  static interruptible_future_detail<InterruptCond, seastar::future<>>
  now()
  {
    return interruptible_future_detail<InterruptCond, seastar::future<>>(
        seastar::now());
  }
  ...
  struct futurize {
    using type = interruptible_future_detail<
        InterruptCond,
        typename seastar::futurize<T>::type>;
  };
  ...
  [[gnu::always_inline]]
  static auto
  do_for_each(Container& c, AsyncAction&& action)
  {
    return do_for_each(
        std::begin(c), std::end(c), std::forward<AsyncAction>(action));
  }

  template <typename OpFunc, typename OnInterrupt, typename... Params>
  static inline auto
  with_interruption_cond(
      OpFunc&& opfunc,
      OnInterrupt&& efunc,
      InterruptCond&& cond,
      Params&&... params)
  {
    ...
    INTR_FUT_DEBUG(
        ...
        (void*)ic.get());
    return internal::call_with_interruption_impl(
               std::move(ic), std::forward<OpFunc>(opfunc),
  ...
  with_interruption(
      OpFunc&& opfunc,
      OnInterrupt&& efunc,
      InterruptCondParams&&... params)
  {
    return with_interruption_cond(
        std::forward<OpFunc>(opfunc), std::forward<OnInterrupt>(efunc),
        InterruptCond(std::forward<InterruptCondParams>(params)...));
  }

  template <typename Error, typename Func, typename... Params>
  static inline auto
  with_interruption_to_error(Func&& f, InterruptCond&& cond, Params&&... params)
  {
    using func_result_t = std::invoke_result_t<Func, Params...>;
    using func_ertr_t = typename seastar::template futurize<
    ...
    return with_interruption_cond(
        std::forward<Func>(f), [](auto e) -> ftype { return Error::make(); },
        std::forward<InterruptCond>(cond), std::forward<Params>(params)...);
  }
  ...
  [[gnu::always_inline]]
  static auto
  with_lock(Lock& lock, Func&& func)
  {
    return seastar::with_lock(
        lock, [func = std::move(func),
               interrupt_condition =
                   interrupt_cond<InterruptCond>.interrupt_cond]() mutable {
  ...
  [[gnu::always_inline]]
  static auto
  do_for_each(Iterator begin, Iterator end, AsyncAction&& action)
  {
    using Result =
        std::invoke_result_t<AsyncAction, typename Iterator::reference>;
  ...
  template <typename Iterator, typename AsyncAction>
    requires(!InvokeReturnsInterruptibleFuture<
             AsyncAction,
  ...
  do_for_each(Iterator begin, Iterator end, AsyncAction&& action)
  {
    if constexpr (seastar::InvokeReturnsAnyFuture<
                      AsyncAction, typename Iterator::reference>) {
      return make_interruptible(::seastar::do_for_each(
          begin, end,
          [action = std::move(action),
           interrupt_condition = interrupt_cond<InterruptCond>.interrupt_cond](
              typename Iterator::reference x) mutable {
            return call_with_interruption(
                interrupt_condition, action, std::forward<decltype(*begin)>(x));
          }));
    } else {
      return make_interruptible(::crimson::do_for_each(
          begin, end,
    ...
    if constexpr (seastar::Future<typename Result::core_type>) {
      return make_interruptible(::seastar::repeat(
          [action = std::move(action),
           interrupt_condition =
               interrupt_cond<InterruptCond>.interrupt_cond]() mutable {
            return call_with_interruption(interrupt_condition, action)
                .to_future();
          }));
    } else {
  ...
  [[gnu::always_inline]]
  static auto
  repeat_eagain(AsyncAction&& action)
  {
    return seastar::do_with(std::forward<AsyncAction>(action), [](auto& f) {
      return repeat([&f] {
        return std::invoke(f)
            .si_then([] { return seastar::stop_iteration::yes; })
            .handle_error_interruptible(
  ...
  static inline auto
  parallel_for_each(Container& container, Func&& func) noexcept
  {
  ...
  static inline interruptible_future<InterruptCond, Initial>
  map_reduce(
      Iterator begin,
      Iterator end,
      Mapper&& mapper,
      ...
      Reduce&& reduce)
  {
    ...
    auto s =
        seastar::make_lw_shared(state{std::move(initial), std::move(reduce)});
    interruptible_future<InterruptCond> ret = seastar::make_ready_future<>();
    while (begin != end) {
      ret = seastar::futurize_invoke(mapper, *begin++)
                .then_wrapped_interruptible(
                    [s = s.get(), ret = std::move(ret)](auto f) mutable {
                      try {
                        s->result =
                            s->reduce(std::move(s->result), std::move(f).get());
                        return std::move(ret);
                      } catch (...) {
                        return std::move(ret).then_wrapped_interruptible(
                            [ex = std::current_exception()](auto f) {
  ...
  {
    return map_reduce(
        std::begin(range), std::end(range), std::forward<Mapper>(mapper),
  ...
  static auto
  futurize_invoke_if_func(Fut&& fut) noexcept
  {
  ...
  static inline auto
  when_all(FutOrFuncs&&... fut_or_funcs) noexcept
  {
  ...
  template <typename... FutOrFuncs>
  static inline auto
  when_all_succeed(FutOrFuncs&&... fut_or_funcs) noexcept
  {
  ...
  static inline auto
  when_all_succeed(
      std::vector<interruptible_future<InterruptCond, T>>&& futures) noexcept
  {
    return interruptor::parallel_for_each(
        futures, [](auto&& ifut) -> interruptible_future<InterruptCond, T> {
  ...
  async(Func&& func)
  {
    ...
    INTR_FUT_DEBUG(
        ...
        (void*)interruption_condition.get(), typeid(InterruptCond).name());
    interrupt_cond<InterruptCond>.reset();
  ...
  green_get(FutureT&& fut)
  {
    ...
    try {
      ...
      interrupt_cond<InterruptCond>.set(interruption_condition);
      INTR_FUT_DEBUG(
          "green_get() error {}, interrupt_cond: {},{}", e,
          (void*)interrupt_cond<InterruptCond>.interrupt_cond.get(),
          typeid(InterruptCond).name());
      throw;
    }
  ...
  maybe_yield()
  {
    ...
    if (seastar::thread::should_yield()) {
      ...
      try {
        ...
        interrupt_cond<InterruptCond>.set(interruption_condition);
        INTR_FUT_DEBUG(
            "interruptible_future_detail::may_yield() yield back, "
            "interrupt_cond: {},{}",
            (void*)interrupt_cond<InterruptCond>.interrupt_cond.get(),
            typeid(InterruptCond).name());
      } catch (std::exception& e) {
        interrupt_cond<InterruptCond>.set(interruption_condition);
        INTR_FUT_DEBUG(
            "interruptible_future_detail::may_yield() error {}, "
            "interrupt_cond: {},{}",
            e, (void*)interrupt_cond<InterruptCond>.interrupt_cond.get(),
            typeid(InterruptCond).name());
        throw;
...
struct futurize<::crimson::interruptible::interruptible_future_detail<
    InterruptCond,
    seastar::future<T...>>> {
  using type = ::crimson::interruptible::
      interruptible_future_detail<InterruptCond, seastar::future<T...>>;
  ...
  static type
  from_tuple(tuple_type&& value)
  {
    return type(ready_future_marker(), std::move(value));
  }

  static type
  from_tuple(const tuple_type& value)
  {
    return type(ready_future_marker(), value);
  }

  static type
  from_tuple(value_type&& value)
  {
    return type(ready_future_marker(), std::move(value));
  }

  static type
  from_tuple(const value_type& value)
  {
    return type(ready_future_marker(), value);
  }
  ...
  [[gnu::always_inline]]
  static type
  invoke(Func&& func, seastar::internal::monostate) noexcept
  {
    try {
      return ::seastar::futurize_invoke(std::forward<Func>(func));
    } catch (...) {
  ...
  static inline type
  make_exception_future(Arg&& arg) noexcept
  {
    return seastar::make_exception_future<T...>(std::forward<Arg>(arg));
  }

  static inline type
  make_exception_future(future_state_base&& state) noexcept
  {
  ...
  static void
  satisfy_with_result_of(PromiseT&& pr, Func&& func)
  {
...
template <typename InterruptCond, typename FutureType>
struct is_future<::crimson::interruptible::
                     interruptible_future_detail<InterruptCond, FutureType>>
  : std::true_type {};
} // namespace seastar
