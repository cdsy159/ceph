...
static inline seastar::log_level
to_log_level(int level)
{
  if (level < 0) {
...
#define SET_SUBSYS(subname_) \
  static constexpr auto SOURCE_SUBSYS = ceph_subsys_##subname_
...
#define LOGI(level_, MSG, ...)                                         \
  LOCAL_LOGGER.log(                                                    \
      level_, "{} {}: " MSG, interruptor::get_interrupt_cond(), FNAME, \
      ##__VA_ARGS__)
...
#define SUBTRACE(subname_, ...) \
  SUBLOG(subname_, seastar::log_level::trace, __VA_ARGS__)
#define SUBTRACEI(subname_, ...) \
  SUBLOGI(subname_, seastar::log_level::trace, __VA_ARGS__)

#define DEBUG(...) LOG(seastar::log_level::debug, __VA_ARGS__)
#define DEBUGI(...) LOGI(seastar::log_level::debug, __VA_ARGS__)
#define SUBDEBUG(subname_, ...) \
  SUBLOG(subname_, seastar::log_level::debug, __VA_ARGS__)
#define SUBDEBUGI(subname_, ...) \
  SUBLOGI(subname_, seastar::log_level::debug, __VA_ARGS__)

#define INFO(...) LOG(seastar::log_level::info, __VA_ARGS__)
#define INFOI(...) LOGI(seastar::log_level::info, __VA_ARGS__)
#define SUBINFO(subname_, ...) \
  SUBLOG(subname_, seastar::log_level::info, __VA_ARGS__)
#define SUBINFOI(subname_, ...) \
  SUBLOGI(subname_, seastar::log_level::info, __VA_ARGS__)

#define WARN(...) LOG(seastar::log_level::warn, __VA_ARGS__)
#define WARNI(...) LOGI(seastar::log_level::warn, __VA_ARGS__)
#define SUBWARN(subname_, ...) \
  SUBLOG(subname_, seastar::log_level::warn, __VA_ARGS__)
#define SUBWARNI(subname_, ...) \
  SUBLOGI(subname_, seastar::log_level::warn, __VA_ARGS__)
...
#define SUBERROR(subname_, ...) \
  SUBLOG(subname_, seastar::log_level::error, __VA_ARGS__)
#define SUBERRORI(subname_, ...) \
  SUBLOGI(subname_, seastar::log_level::error, __VA_ARGS__)
...
#define SUBLOGDPPI(subname_, level_, MSG, dpp, ...)                            \
  LOGGER(subname_).log(                                                        \
      level_, "{} {} {}: " MSG, interruptor::get_interrupt_cond(), dpp, FNAME, \
      ##__VA_ARGS__)
#define SUBTRACEDPP(subname_, ...) \
  SUBLOGDPP(subname_, seastar::log_level::trace, __VA_ARGS__)
#define SUBTRACEDPPI(subname_, ...) \
  SUBLOGDPPI(subname_, seastar::log_level::trace, __VA_ARGS__)
#define SUBDEBUGDPP(subname_, ...) \
  SUBLOGDPP(subname_, seastar::log_level::debug, __VA_ARGS__)
#define SUBDEBUGDPPI(subname_, ...) \
  SUBLOGDPPI(subname_, seastar::log_level::debug, __VA_ARGS__)
#define SUBINFODPP(subname_, ...) \
  SUBLOGDPP(subname_, seastar::log_level::info, __VA_ARGS__)
#define SUBINFODPPI(subname_, ...) \
  SUBLOGDPPI(subname_, seastar::log_level::info, __VA_ARGS__)
#define SUBWARNDPP(subname_, ...) \
  SUBLOGDPP(subname_, seastar::log_level::warn, __VA_ARGS__)
#define SUBWARNDPPI(subname_, ...) \
  SUBLOGDPPI(subname_, seastar::log_level::warn, __VA_ARGS__)
#define SUBERRORDPP(subname_, ...) \
  SUBLOGDPP(subname_, seastar::log_level::error, __VA_ARGS__)
#define SUBERRORDPPI(subname_, ...) \
  SUBLOGDPPI(subname_, seastar::log_level::error, __VA_ARGS__)
