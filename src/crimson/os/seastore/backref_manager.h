...
public:
  ...
  virtual Cache::backref_entry_query_mset_t get_cached_backref_entries_in_range(
      paddr_t start,
      paddr_t end) = 0;

  using retrieve_backref_extents_in_range_iertr = base_iertr;
  using retrieve_backref_extents_in_range_ret =
      retrieve_backref_extents_in_range_iertr::future<
          std::vector<CachedExtentRef>>;
  virtual retrieve_backref_extents_in_range_ret retrieve_backref_extents_in_range(
      Transaction& t,
      paddr_t start,
      paddr_t end) = 0;
  ...
  using merge_cached_backrefs_ret =
      merge_cached_backrefs_iertr::future<journal_seq_t>;
  ...
  using remove_mapping_ret =
      remove_mapping_iertr::future<remove_mapping_result_t>;
