...
struct FLTreeOnode final : Onode, Value {
  ...
  FLTreeOnode(uint32_t ddr, uint32_t dmr, const hobject_t& hobj, T&&... args) :
    Onode(ddr, dmr, hobj), Value(std::forward<T>(args)...)
  {}

  template <typename... T>
  FLTreeOnode(const hobject_t& hobj, T&&... args) :
    Onode(0, 0, hobj), Value(std::forward<T>(args)...)
  {}
  ...
  void
  with_mutable_layout(Transaction& t, layout_func_t&& layout_func)
  {
    assert(status != status_t::DELETED);
  ...
  void
  swap_layout(Transaction& t, Onode& onode) final
  {
    _swap_layout(t, static_cast<FLTreeOnode&>(onode));
  }

  void
  _swap_layout(Transaction& t, FLTreeOnode& other)
  {
    assert(status != status_t::DELETED);
    assert(other.status != status_t::DELETED);
    auto [payload_mut, recorder] =
        prepare_mutate_payload<onode_layout_t, Recorder>(t);
    auto& mlayout = *reinterpret_cast<onode_layout_t*>(payload_mut.get_write());
    auto [o_payload_mut, o_recorder] =
        other.prepare_mutate_payload<onode_layout_t, Recorder>(t);
    auto& o_mlayout =
        *reinterpret_cast<onode_layout_t*>(o_payload_mut.get_write());
  ...
  void
  create_default_layout(Transaction& t)
  {
    with_mutable_layout(
        t, [](NodeExtentMutable& payload_mut, Recorder* recorder) {
          auto& mlayout =
              *reinterpret_cast<onode_layout_t*>(payload_mut.get_write());
  ...
  {
    with_mutable_layout(
        t, [size](NodeExtentMutable& payload_mut, Recorder* recorder) {
          auto& mlayout =
              *reinterpret_cast<onode_layout_t*>(payload_mut.get_write());
          mlayout.size = size;
          if (recorder) {
  ...
  {
    assert(
        oroot.get_type() == omap_type_t::OMAP ||
        oroot.get_type() == omap_type_t::LOG);
    with_mutable_layout(
        t, [&oroot](NodeExtentMutable& payload_mut, Recorder* recorder) {
          auto& mlayout =
              *reinterpret_cast<onode_layout_t*>(payload_mut.get_write());
  ...
  update_xattr_root(Transaction& t, omap_root_t& xroot) final
  {
    ...
    with_mutable_layout(
        t, [&xroot](NodeExtentMutable& payload_mut, Recorder* recorder) {
          auto& mlayout =
              *reinterpret_cast<onode_layout_t*>(payload_mut.get_write());
  ...
  {
    with_mutable_layout(
        t, [&odata](NodeExtentMutable& payload_mut, Recorder* recorder) {
          auto& mlayout =
              *reinterpret_cast<onode_layout_t*>(payload_mut.get_write());
  ...
  {
    with_mutable_layout(
        t, [&oi_bl](NodeExtentMutable& payload_mut, Recorder* recorder) {
          auto& mlayout =
              *reinterpret_cast<onode_layout_t*>(payload_mut.get_write());
          maybe_inline_memcpy(
  ...
  {
    with_mutable_layout(
        t, [&ss_bl](NodeExtentMutable& payload_mut, Recorder* recorder) {
          auto& mlayout =
              *reinterpret_cast<onode_layout_t*>(payload_mut.get_write());
          maybe_inline_memcpy(
