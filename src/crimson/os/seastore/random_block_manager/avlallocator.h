...
struct extent_range_t {
  ...
  struct shorter_t {
    ...
    bool
    operator()(const extent_range_t& lhs, const KeyType& rhs) const
    {
...
public:
  ...
  std::optional<interval_set<rbm_abs_addr>> alloc_extents(size_t size) final;
  ...
  uint64_t
  get_max_alloc_size() const final
  {
  ...
  void
  complete_allocation(rbm_abs_addr start, size_t size) final
  {
    if (detailed) {
  ...
  bool
  is_reserved_extent(rbm_abs_addr start, size_t size)
  {
    if (detailed) {
  ...
  rbm_extent_state_t
  get_extent_state(rbm_abs_addr addr, size_t size) final
  {
...
private:
  ...
  void
  _extent_size_tree_rm(extent_range_t& r)
  {
  ...
  void
  _extent_size_tree_try_insert(extent_range_t& r)
  {
  ...
  using extent_tree_t = boost::intrusive::avl_set<
      extent_range_t,
  ...
  using extent_size_tree_t = boost::intrusive::avl_set<
      extent_range_t,
