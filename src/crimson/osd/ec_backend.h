...
public:
  ...
  void
  on_actingset_changed(bool same_primary) final
  {}
  ...
  ll_read_ierrorator::future<ECSubReadReply> handle_rep_read_op(
      Ref<MOSDECSubOpRead>);
...
private:
  ...
  seastar::future<>
  request_committed(const osd_reqid_t& reqid, const eversion_t& version) final
  {
    return seastar::now();
  }
