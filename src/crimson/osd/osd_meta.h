...
public:
  ...
  void store_inc_map(ceph::os::Transaction& t, epoch_t e, const bufferlist& m);
  ...
  seastar::future<std::tuple<pg_pool_t, std::string, ec_profile_t>>
