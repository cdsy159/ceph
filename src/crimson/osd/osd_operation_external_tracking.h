...
struct LttngBackend
  ...
  void
  handle(ClientRequest::StartEvent&, const Operation&) override
  {}

  void
  handle(
      ConnectionPipeline::AwaitActive::BlockingEvent& ev,
      const Operation& op,
  ...
  void
  handle(
      ConnectionPipeline::AwaitMap::BlockingEvent& ev,
      const Operation& op,
  ...
  void
  handle(
      ConnectionPipeline::GetPGMapping::BlockingEvent& ev,
      const Operation& op,
  ...
  void
  handle(
      PerShardPipeline::CreateOrWaitPG::BlockingEvent& ev,
      const Operation& op,
  ...
  void
  handle(
      CommonPGPipeline::WaitPGReady::BlockingEvent& ev,
      const Operation& op,
  ...
  void
  handle(
      CommonPGPipeline::WaitPGReady::BlockingEvent::ExitBarrierEvent& ev,
      const Operation& op) override
  {}

  void
  handle(
      CommonPGPipeline::GetOBC::BlockingEvent& ev,
      const Operation& op,
  ...
  void
  handle(
      PGActivationBlocker::BlockingEvent& ev,
      const Operation& op,
  ...
  void
  handle(
      scrub::PGScrubber::BlockingEvent& ev,
      const Operation& op,
  ...
  void
  handle(
      CommonOBCPipeline::Process::BlockingEvent& ev,
      const Operation& op,
  ...
  void
  handle(
      CommonOBCPipeline::WaitRepop::BlockingEvent& ev,
      const Operation& op,
  ...
  void
  handle(
      CommonOBCPipeline::WaitRepop::BlockingEvent::ExitBarrierEvent& ev,
      const Operation& op) override
  {}

  void
  handle(
      CommonOBCPipeline::SendReply::BlockingEvent& ev,
      const Operation& op,
  ...
  void
  handle(
      PGRepopPipeline::Process::BlockingEvent& ev,
      const Operation& op,
  ...
  void
  handle(
      PGRepopPipeline::WaitCommit::BlockingEvent& ev,
      const Operation& op,
  ...
  void
  handle(
      PGRepopPipeline::WaitCommit::BlockingEvent::ExitBarrierEvent& ev,
      const Operation& op) override
  {}

  void
  handle(
      PGRepopPipeline::SendReply::BlockingEvent& ev,
      const Operation& op,
      const PGRepopPipeline::SendReply& blocker) override
  {}

  void
  handle(ClientRequest::CompletionEvent&, const Operation&) override
  {}
};
...
struct HistoricBackend
  ...
  static const ClientRequest&
  to_client_request(const Operation& op)
  {
#ifdef NDEBUG
  ...
  void
  handle(ClientRequest::CompletionEvent&, const Operation& op) override
  {
...
struct EventBackendRegistry<osd::ClientRequest> {
  static std::tuple<osd::LttngBackend, osd::HistoricBackend>
  get_backends()
  {
    return {{}, {}};
  }
