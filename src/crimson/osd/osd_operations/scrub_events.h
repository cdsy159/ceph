...
public:
  ...
  ScrubMessage(MessageRef m, Args&&... base_args) :
    RemoteScrubEventBaseT<ScrubMessage>(std::forward<Args>(base_args)...), m(m)
  {
...
public:
  ...
  print(std::ostream& out) const final
  {
    out << "(deep=" << deep << ", local=" << local << ", begin=" << begin
        << ", end=" << end << ")";
  }
...
struct fmt::formatter<crimson::osd::obj_scrub_progress_t> {
  ...
  auto
  format(
      const crimson::osd::obj_scrub_progress_t& progress,
...
template <>
struct fmt::formatter<crimson::osd::ScrubRequested> : fmt::ostream_formatter {};

template <>
struct fmt::formatter<crimson::osd::ScrubMessage> : fmt::ostream_formatter {};

template <typename T>
struct fmt::formatter<crimson::osd::ScrubAsyncOpT<T>> : fmt::ostream_formatter {
};

template <>
struct fmt::formatter<crimson::osd::ScrubFindRange> : fmt::ostream_formatter {};

template <>
struct fmt::formatter<crimson::osd::ScrubReserveRange>
  : fmt::ostream_formatter {};

template <>
struct fmt::formatter<crimson::osd::ScrubScan> : fmt::ostream_formatter {};
