...
protected:
  ...
  using ll_read_ierrorator = ::crimson::interruptible::interruptible_errorator<
      ::crimson::osd::IOInterruptCondition,
      ll_read_errorator>;

public:
  using load_metadata_ertr =
      crimson::errorator<crimson::ct_error::object_corrupted>;
  using load_metadata_iertr = ::crimson::interruptible::interruptible_errorator<
      ::crimson::osd::IOInterruptCondition,
      load_metadata_ertr>;
  using interruptor =
  ...
  using read_errorator =
      ll_read_errorator::extend<crimson::ct_error::object_corrupted>;
  using read_ierrorator = ::crimson::interruptible::interruptible_errorator<
      ::crimson::osd::IOInterruptCondition,
      read_errorator>;
  ...
  read_ierrorator::future<> sparse_read(
      ...
      OSDOp& osd_op,
      object_stat_sum_t& delta_stats);
  using checksum_errorator = ll_read_errorator::
      extend<crimson::ct_error::object_corrupted, crimson::ct_error::invarg>;
  using checksum_ierrorator = ::crimson::interruptible::interruptible_errorator<
      ::crimson::osd::IOInterruptCondition,
      checksum_errorator>;
  checksum_ierrorator::future<> checksum(const ObjectState& os, OSDOp& osd_op);
  using cmp_ext_errorator = ll_read_errorator::
      extend<crimson::ct_error::invarg, crimson::ct_error::cmp_fail>;
  using cmp_ext_ierrorator = ::crimson::interruptible::interruptible_errorator<
      ::crimson::osd::IOInterruptCondition,
      cmp_ext_errorator>;
  ...
  using stat_ierrorator = ::crimson::interruptible::interruptible_errorator<
      ::crimson::osd::IOInterruptCondition,
      stat_errorator>;
  ...
  using write_ertr = crimson::
      errorator<crimson::ct_error::file_too_large, crimson::ct_error::invarg>;
  using write_iertr = ::crimson::interruptible::
      interruptible_errorator<::crimson::osd::IOInterruptCondition, write_ertr>;
  using create_ertr =
      crimson::errorator<crimson::ct_error::invarg, crimson::ct_error::eexist>;
  using create_iertr = ::crimson::interruptible::
      interruptible_errorator<::crimson::osd::IOInterruptCondition, create_ertr>;
  ...
  using remove_iertr = ::crimson::interruptible::
      interruptible_errorator<::crimson::osd::IOInterruptCondition, remove_ertr>;
  ...
  using append_ierrorator = ::crimson::interruptible::interruptible_errorator<
      ::crimson::osd::IOInterruptCondition,
      append_errorator>;
  ...
  using rollback_iertr = ::crimson::interruptible::interruptible_errorator<
      ::crimson::osd::IOInterruptCondition,
      rollback_ertr>;
   ...
   */
  interruptible_future<std::tuple<std::vector<hobject_t>, hobject_t>>
  list_objects(const hobject_t& start, const hobject_t& end, uint64_t limit)
      const;

  interruptible_future<std::tuple<std::vector<hobject_t>, hobject_t>>
  list_objects(const hobject_t& start, uint64_t limit) const
  {
    return list_objects(start, hobject_t::get_max(), limit);
  }

  interruptible_future<std::tuple<std::vector<hobject_t>, hobject_t>>
  list_objects(const hobject_t& start, const hobject_t& end)
  {
  ...
  using setxattr_ierrorator = ::crimson::interruptible::interruptible_errorator<
      ::crimson::osd::IOInterruptCondition,
      setxattr_errorator>;
  ...
  using get_attr_ierrorator = ::crimson::interruptible::interruptible_errorator<
      ::crimson::osd::IOInterruptCondition,
      get_attr_errorator>;
  ...
  get_attr_ierrorator::future<> get_xattrs(
      ...
      OSDOp& osd_op,
      object_stat_sum_t& delta_stats) const;
  using cmp_xattr_errorator = get_attr_errorator::
      extend<crimson::ct_error::ecanceled, crimson::ct_error::invarg>;
  using cmp_xattr_ierrorator = ::crimson::interruptible::interruptible_errorator<
      ::crimson::osd::IOInterruptCondition,
      cmp_xattr_errorator>;
  ...
  using rm_xattr_iertr = ::crimson::interruptible::interruptible_errorator<
      ::crimson::osd::IOInterruptCondition,
      rm_xattr_ertr>;
  ...
  using tmapup_ertr =
      write_ertr::extend<crimson::ct_error::enoent, crimson::ct_error::eexist>;
  using tmapup_iertr = ::crimson::interruptible::
      interruptible_errorator<::crimson::osd::IOInterruptCondition, tmapup_ertr>;
  ...
  ll_read_ierrorator::future<> omap_get_keys(
      ...
      OSDOp& osd_op,
      object_stat_sum_t& delta_stats) const;
  using omap_cmp_ertr = crimson::os::FuturizedStore::Shard::read_errorator::
      extend<crimson::ct_error::ecanceled, crimson::ct_error::invarg>;
  using omap_cmp_iertr = ::crimson::interruptible::interruptible_errorator<
      ::crimson::osd::IOInterruptCondition,
      omap_cmp_ertr>;
  ...
  using omap_clear_iertr = ::crimson::interruptible::interruptible_errorator<
      ::crimson::osd::IOInterruptCondition,
      omap_clear_ertr>;
  ...
  virtual rep_op_fut_t submit_transaction(
  ...
  virtual void
  got_rep_op_reply(const MOSDRepOpReply&)
  {}
...
public:
  ...
  load_metadata_iertr::future<loaded_object_md_t::ref> load_metadata(
      const hobject_t& oid);
...
private:
  ...
  bool maybe_create_new_object(
      ObjectState& os,
      ceph::os::Transaction& txn,
      object_stat_sum_t& delta_stats);
  void update_size_and_usage(
      object_stat_sum_t& delta_stats,
...
protected:
  template <class... Args>
  void
  add_temp_obj(Args&&... args)
  {
    temp_contents.insert(std::forward<Args>(args)...);
  }

  void
  clear_temp_obj(const hobject_t& oid)
  {
