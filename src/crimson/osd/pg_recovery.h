...
private:
  ...
  hobject_t get_temp_recovery_object(const hobject_t& target, eversion_t version);
  ...
  recover_object(const hobject_t& soid, eversion_t need)
  {
  ...
  void start_backfill_recovery(const EventT& evt);
