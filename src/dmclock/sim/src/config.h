...
struct cli_group_t {
  ...
  friend std::ostream&
  operator<<(std::ostream& out, const cli_group_t& cli_group)
  {
    out << "client_count = " << cli_group.client_count << "\n"
        ...
        << cli_group.client_server_select_range << "\n"
...
struct srv_group_t {
  ...
  friend std::ostream&
  operator<<(std::ostream& out, const srv_group_t& srv_group)
  {
...
struct sim_config_t {
  ...
  friend std::ostream&
  operator<<(std::ostream& out, const sim_config_t& sim_config)
  {
