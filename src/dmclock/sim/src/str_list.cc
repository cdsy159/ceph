...
static bool
get_next_token(const string& s, size_t& pos, const char* delims, string& token)
{
...
void
get_str_vec(const string& str, const char* delims, vector<string>& str_vec)
{
  size_t pos = 0;
  string token;
  str_vec.clear();
...
void
get_str_vec(const string& str, vector<string>& str_vec)
{
  const char* delims = ";,= \t";
...
void
get_str_set(const string& str, const char* delims, set<string>& str_set)
{
  size_t pos = 0;
  string token;
...
void
get_str_set(const string& str, set<string>& str_set)
{
  const char* delims = ";,= \t";
