...
static_assert(
    std::is_same<crimson::qos_simulation::Cost, crimson::dmclock::Cost>::value,
    "Please make sure the simulator type crimson::qos_simulation::Cost matches "
    "the dmclock type crimson::dmclock::Cost.");
