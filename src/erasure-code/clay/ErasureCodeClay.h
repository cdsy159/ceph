...
private:
  ...
  int decode_erasures(
      const std::set<int>& erased_chunks,
      int z,
      std::map<int, ceph::bufferlist>* chunks,
      int sc_size);
  ...
  void get_uncoupled_from_coupled(
      std::map<int, ceph::bufferlist>* chunks,
      int x,
      int y,
      int z,
  ...
  void get_coupled_from_uncoupled(
      std::map<int, ceph::bufferlist>* chunks,
      int x,
      int y,
      int z,
