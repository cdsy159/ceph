...
public:
  ...
  virtual int
  jerasure_decode(int* erasures, char** data, char** coding, int blocksize) = 0;
  virtual unsigned get_alignment() const = 0;
  virtual void prepare() = 0;
  static bool is_prime(int value);

  void matrix_apply_delta(
      const shard_id_map<bufferptr>& in,
  ...
  void
  do_scheduled_ops(char** ptrs, int** operations, int packetsize, int s, int d);
...
public:
  ...
  ErasureCodeJerasureReedSolomonVandermonde() :
    ErasureCodeJerasure("reed_sol_van"), matrix(0)
  {
    DEFAULT_K = "7";
    DEFAULT_M = "3";
    DEFAULT_W = "8";
  ...
  int jerasure_decode(int* erasures, char** data, char** coding, int blocksize)
      override;
  void apply_delta(
      const shard_id_map<ceph::bufferptr>& in,
...
public:
  ...
  ErasureCodeJerasureReedSolomonRAID6() :
    ErasureCodeJerasure("reed_sol_r6_op"), matrix(0)
  {
    DEFAULT_K = "7";
    DEFAULT_M = "2";
    DEFAULT_W = "8";
...
public:
  ...
  {
    DEFAULT_W =
        "6"; //The recommended default value of w when using blaum-roth is 6, see Jerasure documentation for more details.
  }
