...
public:
  ...
  typedef
      typename std::pointer_traits<std::unique_ptr<T>>::element_type element_type;
  ...
  alloc_ptr&
  operator=(const alloc_ptr<pointer>&& rhs)
  {
    ptr = rhs.ptr;
  }
  ...
  friend bool
  operator<(const alloc_ptr& lhs, const alloc_ptr& rhs)
  {
