...
#define LIBRADOS_VERSION_CODE \
  LIBRADOS_VERSION(LIBRADOS_VER_MAJOR, LIBRADOS_VER_MINOR, LIBRADOS_VER_EXTRA)
 ...
 */
CEPH_RADOS_API int rados_create2(
    rados_t* pcluster,
 ...
 * @returns 0 on success, negative error code on failure
 */
CEPH_RADOS_API int rados_create_with_context(
    rados_t* cluster,
    rados_config_t cct);
 ...
 */
CEPH_RADOS_API int rados_ping_monitor(
    rados_t cluster,
    const char* mon_id,
    char** outstr,
    size_t* outstrlen);
 ...
 * @returns 0 on success, negative error code on failure
 */
CEPH_RADOS_API int rados_conf_parse_argv(
    rados_t cluster,
    int argc,
    const char** argv);
 ...
 * @returns 0 on success, negative error code on failure
 */
CEPH_RADOS_API int rados_conf_parse_argv_remainder(
    rados_t cluster,
    int argc,
    const char** argv,
    const char** remargv);
 ...
 */
CEPH_RADOS_API int rados_conf_set(
    rados_t cluster,
    const char* option,
    const char* value);
 ...
 * @returns 0 on success, negative error code on failure
 */
CEPH_RADOS_API int rados_cluster_stat(
    rados_t cluster,
 ...
 * @returns length of the buffer we would need to list all pools
 */
CEPH_RADOS_API int rados_inconsistent_pg_list(
    rados_t cluster,
    int64_t pool,
    char* buf,
    size_t len);
 ...
 */
CEPH_RADOS_API int rados_get_min_compatible_osd(
    rados_t cluster,
 ...
 * @returns 0 on success, negative error code on failure
 */
CEPH_RADOS_API int rados_get_min_compatible_client(
    rados_t cluster,
 ...
 * @returns 0 on success, negative error code on failure
 */
CEPH_RADOS_API int rados_ioctx_create(
    rados_t cluster,
    const char* pool_name,
    rados_ioctx_t* ioctx);
CEPH_RADOS_API int rados_ioctx_create2(
    rados_t cluster,
    int64_t pool_id,
    rados_ioctx_t* ioctx);
 ...
 * @returns 0 on success, negative error code on failure
 */
CEPH_RADOS_API int rados_ioctx_pool_stat(
    rados_ioctx_t io,
 ...
 */
CEPH_RADOS_API int rados_pool_reverse_lookup(
    rados_t cluster,
    int64_t id,
    char* buf,
    size_t maxlen);
 ...
 * @returns 0 on success, negative error code on failure
 */
CEPH_RADOS_API int rados_pool_create_with_auid(
    rados_t cluster,
    const char* pool_name,
    uint64_t auid) __attribute__((deprecated));
 ...
 * @returns 0 on success, negative error code on failure
 */
CEPH_RADOS_API int rados_pool_create_with_crush_rule(
    rados_t cluster,
    const char* pool_name,
 ...
 * @returns 0 on success, negative error code on failure
 */
CEPH_RADOS_API int rados_pool_create_with_all(
    rados_t cluster,
    const char* pool_name,
    uint64_t auid,
 ...
 * @returns 0 on success, negative error code on failure
 */
CEPH_RADOS_API int rados_pool_get_base_tier(
    rados_t cluster,
    int64_t pool,
    int64_t* base_tier);
 ...
 * @returns 0 on success, negative error code on failure
 */
CEPH_RADOS_API int rados_ioctx_pool_requires_alignment2(
    rados_ioctx_t io,
    int* req);
 ...
 * @returns 0 on success, negative error code on failure
 */
CEPH_RADOS_API int rados_ioctx_pool_required_alignment2(
    rados_ioctx_t io,
    uint64_t* alignment);
 ...
 * @returns length of string stored, or -ERANGE if buffer too small
 */
CEPH_RADOS_API int rados_ioctx_get_pool_name(
    rados_ioctx_t io,
    char* buf,
    unsigned maxlen);
 ...
 */
CEPH_RADOS_API void rados_ioctx_locator_set_key(
    rados_ioctx_t io,
    const char* key);
 ...
 * @returns length of string stored, or -ERANGE if buffer too small
 */
CEPH_RADOS_API int rados_ioctx_get_namespace(
    rados_ioctx_t io,
    char* buf,
    unsigned maxlen);
 ...
 * @returns 0 on success, negative error code on failure
 */
CEPH_RADOS_API int rados_nobjects_list_open(
    rados_ioctx_t io,
...
rados_nobjects_list_seek(rados_list_ctx_t ctx, uint32_t pos);
 ...
 */
CEPH_RADOS_API uint32_t rados_nobjects_list_seek_cursor(
    rados_list_ctx_t ctx,
 ...
 * @returns 0 on success, negative error code on failure
 */
CEPH_RADOS_API int rados_nobjects_list_get_cursor(
    rados_list_ctx_t ctx,
    rados_object_list_cursor* cursor);
 ...
 */
CEPH_RADOS_API int rados_nobjects_list_next(
    rados_list_ctx_t ctx,
    const char** entry,
    const char** key,
    const char** nspace);
 ...
 * @returns -ENOENT when there are no more objects to list
 */
CEPH_RADOS_API int rados_nobjects_list_next2(
    rados_list_ctx_t ctx,
    const char** entry,
    const char** key,
    const char** nspace,
 ...
 */
CEPH_RADOS_API int rados_object_list_is_end(
    rados_ioctx_t io,
 ...
 * @param cur cursor
 */
CEPH_RADOS_API void rados_object_list_cursor_free(
    rados_ioctx_t io,
    rados_object_list_cursor cur);
 ...
 */
CEPH_RADOS_API int rados_object_list_cursor_cmp(
    rados_ioctx_t io,
 ...
 */
CEPH_RADOS_API int rados_object_list(
    rados_ioctx_t io,
 ...
 * @returns 0 on success, negative error code on failure
 */
CEPH_RADOS_API int rados_ioctx_snap_create(
    rados_ioctx_t io,
    const char* snapname);
 ...
 * @returns 0 on success, negative error code on failure
 */
CEPH_RADOS_API int rados_ioctx_snap_remove(
    rados_ioctx_t io,
    const char* snapname);
 ...
 * @returns 0 on success, negative error code on failure
 */
CEPH_RADOS_API int rados_ioctx_snap_rollback(
    rados_ioctx_t io,
    const char* oid,
    const char* snapname);
 ...
 */
CEPH_RADOS_API int rados_rollback(
    rados_ioctx_t io,
    const char* oid,
    const char* snapname) __attribute__((deprecated));
 ...
 */
CEPH_RADOS_API void rados_ioctx_snap_set_read(
    rados_ioctx_t io,
    rados_snap_t snap);
 ...
 * @returns 0 on success, negative error code on failure
 */
CEPH_RADOS_API int rados_ioctx_selfmanaged_snap_create(
    rados_ioctx_t io,
    rados_snap_t* snapid);
CEPH_RADOS_API void rados_aio_ioctx_selfmanaged_snap_create(
    rados_ioctx_t io,
    rados_snap_t* snapid,
 ...
 * @returns 0 on success, negative error code on failure
 */
CEPH_RADOS_API int rados_ioctx_selfmanaged_snap_remove(
    rados_ioctx_t io,
    rados_snap_t snapid);
CEPH_RADOS_API void rados_aio_ioctx_selfmanaged_snap_remove(
    rados_ioctx_t io,
    rados_snap_t snapid,
    rados_completion_t completion);
 ...
 * @returns 0 on success, negative error code on failure
 */
CEPH_RADOS_API int rados_ioctx_selfmanaged_snap_rollback(
    rados_ioctx_t io,
    const char* oid,
    rados_snap_t snapid);
 ...
 */
CEPH_RADOS_API int rados_ioctx_selfmanaged_snap_set_write_ctx(
    rados_ioctx_t io,
    rados_snap_t seq,
    rados_snap_t* snaps,
    int num_snaps);
 ...
 */
CEPH_RADOS_API int rados_ioctx_snap_list(
    rados_ioctx_t io,
    rados_snap_t* snaps,
    int maxlen);
 ...
 * @returns 0 on success, negative error code on failure
 */
CEPH_RADOS_API int rados_ioctx_snap_lookup(
    rados_ioctx_t io,
    const char* name,
    rados_snap_t* id);
 ...
 */
CEPH_RADOS_API int rados_ioctx_snap_get_name(
    rados_ioctx_t io,
    rados_snap_t id,
    char* name,
    int maxlen);
 ...
 * @returns 0 on success, negative error code on failure
 */
CEPH_RADOS_API int rados_ioctx_snap_get_stamp(
    rados_ioctx_t io,
    rados_snap_t id,
    time_t* t);
 ...
 * @returns 0 on success, negative error code on failure
 */
CEPH_RADOS_API int rados_write(
    rados_ioctx_t io,
    const char* oid,
    const char* buf,
    size_t len,
 ...
 * @returns 0 on success, negative error code on failure
 */
CEPH_RADOS_API int rados_write_full(
    rados_ioctx_t io,
    const char* oid,
    const char* buf,
    size_t len);
 ...
 * @returns 0 on success, negative error code on failure
 */
CEPH_RADOS_API int rados_writesame(
    rados_ioctx_t io,
    const char* oid,
    const char* buf,
    size_t data_len,
 ...
 */
CEPH_RADOS_API int
rados_append(rados_ioctx_t io, const char* oid, const char* buf, size_t len);
 ...
 */
CEPH_RADOS_API int rados_checksum(
    rados_ioctx_t io,
    const char* oid,
 ...
 */
CEPH_RADOS_API int rados_cmpext(
    rados_ioctx_t io,
    const char* o,
    const char* cmp_buf,
    size_t cmp_len,
 ...
 */
CEPH_RADOS_API int rados_getxattr(
    rados_ioctx_t io,
    const char* o,
    const char* name,
    char* buf,
 ...
 * @returns 0 on success, negative error code on failure
 */
CEPH_RADOS_API int rados_setxattr(
    rados_ioctx_t io,
    const char* o,
    const char* name,
    const char* buf,
 ...
 * @returns 0 on success, negative error code on failure
 */
CEPH_RADOS_API int rados_rmxattr(
    rados_ioctx_t io,
    const char* o,
    const char* name);
 ...
 * @returns 0 on success, negative error code on failure
 */
CEPH_RADOS_API int rados_getxattrs(
    rados_ioctx_t io,
    const char* oid,
 ...
 * @returns 0 on success, negative error code on failure
 */
CEPH_RADOS_API int rados_getxattrs_next(
    rados_xattrs_iter_t iter,
    const char** name,
    const char** val,
    size_t* len);
 ...
 * @returns 0 on success, negative error code on failure
 */
CEPH_RADOS_API int rados_omap_get_next(
 ...
 * @returns 0 on success, negative error code on failure
 */
CEPH_RADOS_API int rados_omap_get_next2(
    rados_omap_iter_t iter,
    char** key,
    char** val,
    size_t* key_len,
...
CEPH_RADOS_API int rados_stat2(
    rados_ioctx_t io,
    const char* o,
    uint64_t* psize,
 ...
 * @returns 0
 */
CEPH_RADOS_API int rados_aio_create_completion(
    void* cb_arg,
 ...
 * @returns 0
 */
CEPH_RADOS_API int rados_aio_create_completion2(
    void* cb_arg,
    rados_callback_t cb_complete,
    rados_completion_t* pc);
 ...
 * other than LIBRADOS_SNAP_HEAD
 */
CEPH_RADOS_API int rados_aio_append(
    rados_ioctx_t io,
    const char* oid,
    rados_completion_t completion,
    const char* buf,
 ...
 * other than LIBRADOS_SNAP_HEAD
 */
CEPH_RADOS_API int rados_aio_write_full(
    rados_ioctx_t io,
    const char* oid,
    rados_completion_t completion,
    const char* buf,
 ...
 * other than LIBRADOS_SNAP_HEAD
 */
CEPH_RADOS_API int rados_aio_writesame(
    rados_ioctx_t io,
    const char* oid,
    rados_completion_t completion,
    const char* buf,
 ...
 * other than LIBRADOS_SNAP_HEAD
 */
CEPH_RADOS_API int rados_aio_remove(
    rados_ioctx_t io,
    const char* oid,
    rados_completion_t completion);
 ...
 * @returns 0 on success, negative error code on failure
 */
CEPH_RADOS_API int rados_aio_read(
    rados_ioctx_t io,
    const char* oid,
    rados_completion_t completion,
    char* buf,
 ...
 * @returns 0 on success, negative error code on failure
 */
CEPH_RADOS_API int rados_aio_flush_async(
    rados_ioctx_t io,
    rados_completion_t completion);
 ...
 * @returns 0 on success, negative error code on failure
 */
CEPH_RADOS_API int rados_aio_stat(
    rados_ioctx_t io,
    const char* o,
    rados_completion_t completion,
    uint64_t* psize,
...
CEPH_RADOS_API int rados_aio_stat2(
    rados_ioctx_t io,
    const char* o,
    rados_completion_t completion,
    uint64_t* psize,
 ...
 *  (-MAX_ERRNO - mismatch_off) on mismatch
 */
CEPH_RADOS_API int rados_aio_cmpext(
    rados_ioctx_t io,
    const char* o,
    rados_completion_t completion,
    const char* cmp_buf,
 ...
 * @returns 0 on success, negative error code on failure
 */
CEPH_RADOS_API int rados_aio_cancel(
    rados_ioctx_t io,
    rados_completion_t completion);
 ...
 * @returns 0 on success, negative error code on failure
 */
CEPH_RADOS_API int rados_aio_exec(
    rados_ioctx_t io,
    const char* o,
    rados_completion_t completion,
    const char* cls,
 ...
 * @returns length of xattr value on success, negative error code on failure
 */
CEPH_RADOS_API int rados_aio_getxattr(
    rados_ioctx_t io,
    const char* o,
    rados_completion_t completion,
    const char* name,
 ...
 * @returns 0 on success, negative error code on failure
 */
CEPH_RADOS_API int rados_aio_setxattr(
    rados_ioctx_t io,
    const char* o,
    rados_completion_t completion,
    const char* name,
 ...
 * @returns 0 on success, negative error code on failure
 */
CEPH_RADOS_API int rados_aio_rmxattr(
    rados_ioctx_t io,
    const char* o,
    rados_completion_t completion,
    const char* name);
 ...
 * @returns 0 on success, negative error code on failure
 */
CEPH_RADOS_API int rados_aio_getxattrs(
    rados_ioctx_t io,
    const char* oid,
    rados_completion_t completion,
    rados_xattrs_iter_t* iter);
 ...
 */
CEPH_RADOS_API int rados_watch(
    rados_ioctx_t io,
    const char* o,
    uint64_t ver,
    uint64_t* cookie,
 ...
 * @returns 0 on success, negative error code on failure
 */
CEPH_RADOS_API int rados_watch2(
    rados_ioctx_t io,
    const char* o,
    uint64_t* cookie,
 ...
 * @returns 0 on success, negative error code on failure
 */
CEPH_RADOS_API int rados_watch3(
    rados_ioctx_t io,
    const char* o,
    uint64_t* cookie,
    rados_watchcb2_t watchcb,
 ...
 * @returns 0 on success, negative error code on failure
 */
CEPH_RADOS_API int rados_aio_watch(
    rados_ioctx_t io,
    const char* o,
    rados_completion_t completion,
    uint64_t* handle,
 ...
 * @returns 0 on success, negative error code on failure
 */
CEPH_RADOS_API int rados_aio_watch2(
    rados_ioctx_t io,
    const char* o,
    rados_completion_t completion,
    uint64_t* handle,
 ...
 * @returns 0 on success, negative error code on failure
 */
CEPH_RADOS_API int rados_aio_unwatch(
    rados_ioctx_t io,
    uint64_t cookie,
    rados_completion_t completion);
 ...
 * @returns 0 on success, negative error code on failure
 */
CEPH_RADOS_API int rados_notify(
    rados_ioctx_t io,
    const char* o,
    uint64_t ver,
    const char* buf,
    int buf_len) __attribute__((deprecated));
 ...
 * @returns 0 on success, negative error code on failure
 */
CEPH_RADOS_API int rados_aio_notify(
    rados_ioctx_t io,
    const char* o,
    rados_completion_t completion,
    const char* buf,
...
CEPH_RADOS_API int rados_notify2(
    rados_ioctx_t io,
    const char* o,
    const char* buf,
    int buf_len,
 ...
 */
CEPH_RADOS_API int rados_decode_notify_response(
    char* reply_buffer,
    size_t reply_buffer_len,
 ...
 */
CEPH_RADOS_API void rados_free_notify_response(
    struct notify_ack_t* acks,
    size_t nr_acks,
    struct notify_timeout_t* timeouts);
 ...
 * @returns 0 on success
 */
CEPH_RADOS_API int rados_notify_ack(
    rados_ioctx_t io,
    const char* o,
    uint64_t notify_id,
    uint64_t cookie,
 ...
 * @param completion what to do when operation has been attempted
 */
CEPH_RADOS_API int rados_aio_watch_flush(
    rados_t cluster,
    rados_completion_t completion);
 ...
 * @returns 0 on success, negative error code on failure
 */
CEPH_RADOS_API int rados_set_alloc_hint(
    rados_ioctx_t io,
    const char* o,
 ...
 * @returns 0 on success, negative error code on failure
 */
CEPH_RADOS_API int rados_set_alloc_hint2(
    rados_ioctx_t io,
    const char* o,
    uint64_t expected_object_size,
    uint64_t expected_write_size,
 ...
 */
CEPH_RADOS_API void rados_write_op_set_flags(
 ...
 */
CEPH_RADOS_API void rados_write_op_assert_version(
    rados_write_op_t write_op,
    uint64_t ver);
 ...
 */
CEPH_RADOS_API void rados_write_op_cmpext(
    rados_write_op_t write_op,
    const char* cmp_buf,
    size_t cmp_len,
    uint64_t off,
 ...
 */
CEPH_RADOS_API void rados_write_op_cmpxattr(
    rados_write_op_t write_op,
    const char* name,
 ...
 */
CEPH_RADOS_API void rados_write_op_omap_cmp(
    rados_write_op_t write_op,
    const char* key,
    uint8_t comparison_operator,
    const char* val,
 ...
 * @param prval where to store the return value from this action
 */
CEPH_RADOS_API void rados_write_op_omap_cmp2(
    rados_write_op_t write_op,
    const char* key,
    uint8_t comparison_operator,
    const char* val,
 ...
 */
CEPH_RADOS_API void rados_write_op_setxattr(
    rados_write_op_t write_op,
    const char* name,
    const char* value,
    size_t value_len);
 ...
 */
CEPH_RADOS_API void rados_write_op_rmxattr(
    rados_write_op_t write_op,
    const char* name);
 ...
 */
CEPH_RADOS_API void rados_write_op_create(
    rados_write_op_t write_op,
    int exclusive,
    const char* category);
 ...
 */
CEPH_RADOS_API void rados_write_op_write(
    rados_write_op_t write_op,
    const char* buffer,
    size_t len,
    uint64_t offset);
 ...
 * @param len length of buffer
 */
CEPH_RADOS_API void rados_write_op_write_full(
    rados_write_op_t write_op,
    const char* buffer,
    size_t len);
 ...
 * @param offset offset to write to
 */
CEPH_RADOS_API void rados_write_op_writesame(
    rados_write_op_t write_op,
    const char* buffer,
    size_t data_len,
    size_t write_len,
 ...
 * @param len length of buffer
 */
CEPH_RADOS_API void rados_write_op_append(
    rados_write_op_t write_op,
    const char* buffer,
    size_t len);
/**
 ...
 */
CEPH_RADOS_API void rados_write_op_truncate(
    rados_write_op_t write_op,
    uint64_t offset);
 ...
 */
CEPH_RADOS_API void rados_write_op_zero(
    rados_write_op_t write_op,
    uint64_t offset,
    uint64_t len);
 ...
 */
CEPH_RADOS_API void rados_write_op_exec(
    rados_write_op_t write_op,
    const char* cls,
    const char* method,
    const char* in_buf,
 ...
 */
CEPH_RADOS_API void rados_write_op_omap_set(
    rados_write_op_t write_op,
 ...
 * @param num number of key/value pairs to set
 */
CEPH_RADOS_API void rados_write_op_omap_set2(
    rados_write_op_t write_op,
    char const* const* keys,
    char const* const* vals,
 ...
 */
CEPH_RADOS_API void rados_write_op_omap_rm_keys(
    rados_write_op_t write_op,
    char const* const* keys,
    size_t keys_len);
 ...
 * @param keys_len number of key/value pairs to remove
 */
CEPH_RADOS_API void rados_write_op_omap_rm_keys2(
    rados_write_op_t write_op,
    char const* const* keys,
    const size_t* key_lens,
    size_t keys_len);
 ...
 */
CEPH_RADOS_API void rados_write_op_omap_rm_range2(
    rados_write_op_t write_op,
 ...
 * @param expected_write_size expected size of writes to the object, in bytes
 */
CEPH_RADOS_API void rados_write_op_set_alloc_hint(
    rados_write_op_t write_op,
    uint64_t expected_object_size,
    uint64_t expected_write_size);
 ...
 * @param flags hints about future IO patterns
 */
CEPH_RADOS_API void rados_write_op_set_alloc_hint2(
    rados_write_op_t write_op,
    uint64_t expected_object_size,
    uint64_t expected_write_size,
    uint32_t flags);
 ...
 */
CEPH_RADOS_API int rados_write_op_operate(
    rados_write_op_t write_op,
    rados_ioctx_t io,
    const char* oid,
    time_t* mtime,
...
CEPH_RADOS_API int rados_write_op_operate2(
    rados_write_op_t write_op,
    rados_ioctx_t io,
    const char* oid,
 ...
 * @param flags flags to apply to the entire operation (LIBRADOS_OPERATION_*)
 */
CEPH_RADOS_API int rados_aio_write_op_operate(
    rados_write_op_t write_op,
    rados_ioctx_t io,
    rados_completion_t completion,
    const char* oid,
 ...
 * @param flags flags to apply to the entire operation (LIBRADOS_OPERATION_*)
 */
CEPH_RADOS_API int rados_aio_write_op_operate2(
    rados_write_op_t write_op,
    rados_ioctx_t io,
    rados_completion_t completion,
    const char* oid,
 ...
 * @param ver object version number
 */
CEPH_RADOS_API void rados_read_op_assert_version(
 ...
 *  on failure, (-MAX_ERRNO - mismatch_off) on mismatch
 */
CEPH_RADOS_API void rados_read_op_cmpext(
    rados_read_op_t read_op,
    const char* cmp_buf,
    size_t cmp_len,
    uint64_t off,
 ...
 * @param value_len length of buffer to compare actual xattr value to
 */
CEPH_RADOS_API void rados_read_op_cmpxattr(
    rados_read_op_t read_op,
    const char* name,
    uint8_t comparison_operator,
    const char* value,
 ...
 */
CEPH_RADOS_API void rados_read_op_getxattrs(
    rados_read_op_t read_op,
    rados_xattrs_iter_t* iter,
    int* prval);
 ...
 * @param prval where to store the return value from this action
 */
CEPH_RADOS_API void rados_read_op_omap_cmp(
    rados_read_op_t read_op,
    const char* key,
    uint8_t comparison_operator,
    const char* val,
 ...
 * @param prval where to store the return value from this action
 */
CEPH_RADOS_API void rados_read_op_omap_cmp2(
    rados_read_op_t read_op,
    const char* key,
    uint8_t comparison_operator,
    const char* val,
 ...
 * @param prval where to store the return value of this action
 */
CEPH_RADOS_API void rados_read_op_stat(
    rados_read_op_t read_op,
    uint64_t* psize,
    time_t* pmtime,
    int* prval);

CEPH_RADOS_API void rados_read_op_stat2(
    rados_read_op_t read_op,
    uint64_t* psize,
    struct timespec* pmtime,
    int* prval);
 ...
 * @param prval where to store the return value of this action
 */
CEPH_RADOS_API void rados_read_op_read(
    rados_read_op_t read_op,
    uint64_t offset,
    size_t len,
    char* buffer,
 ...
 */
CEPH_RADOS_API void rados_read_op_checksum(
    rados_read_op_t read_op,
    rados_checksum_type_t type,
    const char* init_value,
    size_t init_value_len,
 ...
 * @param prval where to store the return value from the method
 */
CEPH_RADOS_API void rados_read_op_exec(
    rados_read_op_t read_op,
    const char* cls,
    const char* method,
    const char* in_buf,
 ...
 * @param prval where to store the return value from the method
 */
CEPH_RADOS_API void rados_read_op_exec_user_buf(
    rados_read_op_t read_op,
    const char* cls,
    const char* method,
    const char* in_buf,
 ...
 * @param prval where to store the return value from this action
 */
CEPH_RADOS_API void rados_read_op_omap_get_vals(
    rados_read_op_t read_op,
 ...
 * @param prval where to store the return value from this action
 */
CEPH_RADOS_API void rados_read_op_omap_get_vals2(
    rados_read_op_t read_op,
    const char* start_after,
    const char* filter_prefix,
    uint64_t max_return,
 ...
 * @param prval where to store the return value from this action
 */
CEPH_RADOS_API void rados_read_op_omap_get_keys(
    rados_read_op_t read_op,
    const char* start_after,
    uint64_t max_return,
    rados_omap_iter_t* iter,
 ...
 * @param prval where to store the return value from this action
 */
CEPH_RADOS_API void rados_read_op_omap_get_keys2(
    rados_read_op_t read_op,
    const char* start_after,
    uint64_t max_return,
    rados_omap_iter_t* iter,
 ...
 * @param prval where to store the return value from this action
 */
CEPH_RADOS_API void rados_read_op_omap_get_vals_by_keys(
    rados_read_op_t read_op,
    char const* const* keys,
    size_t keys_len,
    rados_omap_iter_t* iter,
 ...
 * @param prval where to store the return value from this action
 */
CEPH_RADOS_API void rados_read_op_omap_get_vals_by_keys2(
    rados_read_op_t read_op,
    char const* const* keys,
    size_t num_keys,
    const size_t* key_lens,
 ...
 * @param flags flags to apply to the entire operation (LIBRADOS_OPERATION_*)
 */
CEPH_RADOS_API int rados_read_op_operate(
    rados_read_op_t read_op,
    rados_ioctx_t io,
    const char* oid,
    int flags);
 ...
 * @param flags flags to apply to the entire operation (LIBRADOS_OPERATION_*)
 */
CEPH_RADOS_API int rados_aio_read_op_operate(
    rados_read_op_t read_op,
    rados_ioctx_t io,
    rados_completion_t completion,
    const char* oid,
 ...
 */
CEPH_RADOS_API int rados_lock_exclusive(
    rados_ioctx_t io,
    const char* oid,
    const char* name,
    const char* cookie,
 ...
 * @returns -EEXIST if the lock is already held by the same (client, cookie) pair
 */
CEPH_RADOS_API int rados_lock_shared(
    rados_ioctx_t io,
    const char* o,
    const char* name,
    const char* cookie,
 ...
 */
CEPH_RADOS_API int rados_unlock(
    rados_ioctx_t io,
    const char* o,
    const char* name,
    const char* cookie);
 ...
 * @returns 0 on success, negative error code on failure
 */
CEPH_RADOS_API int rados_aio_unlock(
    rados_ioctx_t io,
    const char* o,
    const char* name,
    const char* cookie,
 ...
 */
CEPH_RADOS_API ssize_t rados_list_lockers(
    rados_ioctx_t io,
    const char* o,
    const char* name,
    int* exclusive,
 ...
 */
CEPH_RADOS_API int rados_break_lock(
    rados_ioctx_t io,
    const char* o,
    const char* name,
    const char* client,
 ...
 * @returns 0 on success, negative error code on failure
 */
CEPH_RADOS_API int rados_blocklist_add(
    rados_t cluster,
    char* client_address,
    uint32_t expire_seconds);
CEPH_RADOS_API int rados_blacklist_add(
    rados_t cluster,
    char* client_address,
    uint32_t expire_seconds) __attribute__((deprecated));
 ...
 * @returns 0 on success, negative error code on failure
 */
CEPH_RADOS_API int rados_application_enable(
    rados_ioctx_t io,
    const char* app_name,
    int force);
 ...
 */
CEPH_RADOS_API int rados_application_list(
    rados_ioctx_t io,
    char* values,
    size_t* values_len);
 ...
 * @returns 0 on success, negative error code on failure
 */
CEPH_RADOS_API int rados_application_metadata_get(
    rados_ioctx_t io,
    const char* app_name,
    const char* key,
    char* value,
 ...
 * @returns 0 on success, negative error code on failure
 */
CEPH_RADOS_API int rados_application_metadata_set(
    rados_ioctx_t io,
    const char* app_name,
    const char* key,
    const char* value);
 ...
 * @returns 0 on success, negative error code on failure
 */
CEPH_RADOS_API int rados_application_metadata_remove(
    rados_ioctx_t io,
    const char* app_name,
    const char* key);
 ...
 * @returns -ERANGE if either buffer is too short
 */
CEPH_RADOS_API int rados_application_metadata_list(
    rados_ioctx_t io,
    const char* app_name,
    char* keys,
    size_t* key_len,
 ...
 * @returns 0 on success, negative error code on failure
 */
CEPH_RADOS_API int rados_mon_command(
    rados_t cluster,
    const char** cmd,
    size_t cmdlen,
    const char* inbuf,
 ...
 * @returns 0 on success, negative error code on failure
 */
CEPH_RADOS_API int rados_mgr_command(
    rados_t cluster,
    const char** cmd,
    size_t cmdlen,
    const char* inbuf,
 ...
 * @returns 0 on success, negative error code on failure
 */
CEPH_RADOS_API int rados_mon_command_target(
    rados_t cluster,
    const char* name,
    const char** cmd,
    size_t cmdlen,
...
CEPH_RADOS_API int rados_osd_command(
    rados_t cluster,
    int osdid,
    const char** cmd,
    size_t cmdlen,
...
CEPH_RADOS_API int rados_pg_command(
    rados_t cluster,
    const char* pgstr,
    const char** cmd,
    size_t cmdlen,
 ...
 */
typedef void (*rados_log_callback_t)(
    void* arg,
    const char* line,
    const char* who,
    uint64_t sec,
 ...
 * @returns 0 on success, negative code on error
 */
typedef void (*rados_log_callback2_t)(
    void* arg,
    const char* line,
    const char* channel,
    const char* who,
...
CEPH_RADOS_API int rados_monitor_log(
    rados_t cluster,
    const char* level,
    rados_log_callback_t cb,
    void* arg);
CEPH_RADOS_API int rados_monitor_log2(
    rados_t cluster,
    const char* level,
