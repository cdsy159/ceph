...
inline std::ostream& operator<<(
    std::ostream& out,
    const std::list<A, Alloc>& ilist);
template <class A, class Comp, class Alloc>
inline std::ostream& operator<<(
    std::ostream& out,
    const std::set<A, Comp, Alloc>& iset);
template <class A, class Comp, class Alloc>
inline std::ostream& operator<<(
    std::ostream& out,
    const std::unordered_set<A, Comp, Alloc>& iset);
template <class A, class Comp, class Alloc>
inline std::ostream& operator<<(
    std::ostream& out,
    const std::multiset<A, Comp, Alloc>& iset);
template <class A, class B, class Comp, class Alloc>
inline std::ostream& operator<<(
    std::ostream& out,
    const std::map<A, B, Comp, Alloc>& m);
...
inline std::ostream& operator<<(
    std::ostream& out,
    const std::multimap<A, B, Comp, Alloc>& m);
} // namespace std
...
inline std::ostream& operator<<(
    std::ostream& out,
    const boost::container::flat_set<A, Comp, Alloc>& iset);
template <class A, class B, class Comp, class Alloc>
inline std::ostream& operator<<(
    std::ostream& out,
    const boost::container::flat_map<A, B, Comp, Alloc>& iset);
} // namespace container
} // namespace boost
...
template <class A, class B>
inline std::ostream&
operator<<(std::ostream& out, const std::pair<A, B>& v)
{
...
template <class A, class Alloc>
inline std::ostream&
operator<<(std::ostream& out, const std::vector<A, Alloc>& v)
{
  bool first = true;
  out << "[";
  for (const auto& p : v) {
...
template <class T, std::size_t Extent>
inline std::ostream&
operator<<(std::ostream& out, const std::span<T, Extent>& s)
{
  bool first = true;
  out << "[";
  for (const auto& p : s) {
...
template <class A, class Alloc>
inline std::ostream&
operator<<(std::ostream& out, const std::deque<A, Alloc>& v)
{
  out << "<";
...
template <typename... Ts>
inline std::ostream&
operator<<(std::ostream& out, const std::tuple<Ts...>& t)
{
...
template <typename T>
inline std::ostream&
operator<<(std::ostream& out, const std::optional<T>& t)
{
  if (!t)
    out << "--";
  else
...
template <class A, class Alloc>
inline std::ostream&
operator<<(std::ostream& out, const std::list<A, Alloc>& ilist)
{
...
template <class A, class Comp, class Alloc>
inline std::ostream&
operator<<(std::ostream& out, const std::set<A, Comp, Alloc>& iset)
{
...
template <class A, class Comp, class Alloc>
inline std::ostream&
operator<<(std::ostream& out, const std::unordered_set<A, Comp, Alloc>& iset)
{
  for (auto it = iset.begin(); it != iset.end(); ++it) {
    if (it != iset.begin())
      out << ",";
...
template <class A, class Comp, class Alloc>
inline std::ostream&
operator<<(std::ostream& out, const std::multiset<A, Comp, Alloc>& iset)
{
  for (auto it = iset.begin(); it != iset.end(); ++it) {
    if (it != iset.begin())
      out << ",";
...
template <class A, class B, class Comp, class Alloc>
inline std::ostream&
operator<<(std::ostream& out, const std::map<A, B, Comp, Alloc>& m)
{
  out << "{";
...
template <class A, class B, class Hash, class KeyEqual>
inline std::ostream&
operator<<(std::ostream& out, const std::unordered_map<A, B, Hash, KeyEqual>& m)
{
  out << "{";
  for (auto it = m.begin(); it != m.end(); ++it) {
    if (it != m.begin())
...
template <class A, class B, class Comp, class Alloc>
inline std::ostream&
operator<<(std::ostream& out, const std::multimap<A, B, Comp, Alloc>& m)
{
  out << "{{";
  for (auto it = m.begin(); it != m.end(); ++it) {
    if (it != m.begin())
...
inline std::ostream&
operator<<(std::ostream& out, const boost::tuples::tuple<A, B, C>& t)
{
  return out << boost::get<0>(t) << "," << boost::get<1>(t) << ","
             << boost::get<2>(t);
}
} // namespace tuples
...
operator<<(
    std::ostream& out,
    const boost::container::flat_map<A, B, Comp, Alloc>& m)
{
  for (auto it = m.begin(); it != m.end(); ++it) {
    if (it != m.begin())
      out << ",";
...
static inline bool
operator==(const client_t& l, const client_t& r)
{
  return l.v == r.v;
}
...
static inline bool
operator>=(const client_t& l, int64_t o)
{
  return l.v >= o;
}
...
template <>
struct fmt::formatter<byte_u_t> : fmt::ostream_formatter {};
#endif
...
struct shard_id_t {
  ...
  explicit constexpr shard_id_t(int8_t _id) :
    id(_id)
  {}
  ...
  operator<=>(const shard_id_t& lhs, const shard_id_t& rhs)
  {
    return lhs.id <=> rhs.id;
  }

  friend constexpr std::strong_ordering
  operator<=>(int lhs, const shard_id_t& rhs)
  {
    return lhs <=> rhs.id;
  }

  friend constexpr std::strong_ordering
  operator<=>(const shard_id_t& lhs, int rhs)
  {
    return lhs.id <=> rhs;
  }
  ...
  bool
  operator==(const shard_id_t& other) const
  {
    return id == other.id;
  }
...
struct errorcode32_t {
  ...
  // cppcheck-suppress noExplicitConstructor
  explicit errorcode32_t(code_t i) :
    code(i)
  {}
  ...
  inline code_t
  get_host_to_wire() const
  {
    return hostos_to_ceph_errno(code);
  }

  inline void
  set_wire_to_host(code_t wire_code)
  {
...
struct sha_digest_t {
  ...
  bool
  operator==(const sha_digest_t& r) const
  {
...
template <uint8_t S>
inline std::ostream&
operator<<(std::ostream& out, const sha_digest_t<S>& b)
{
...
#if FMT_VERSION >= 90000
template <uint8_t S>
struct fmt::formatter<sha_digest_t<S>> : fmt::ostream_formatter {};
#endif
