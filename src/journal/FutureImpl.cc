...
void
FutureImpl::init(const ceph::ref_t<FutureImpl>& prev_future)
{
...
void
FutureImpl::flush(Context* on_safe)
{
...
ceph::ref_t<FutureImpl>
FutureImpl::prepare_flush(FlushHandlers* flush_handlers)
{
  std::lock_guard locker{m_lock};
...
ceph::ref_t<FutureImpl>
FutureImpl::prepare_flush(FlushHandlers* flush_handlers, ceph::mutex& lock)
{
...
void
FutureImpl::wait(Context* on_safe)
{
...
int
FutureImpl::get_return_value() const
{
  std::lock_guard locker{m_lock};
...
bool
FutureImpl::attach(FlushHandler::ref flush_handler)
{
  std::lock_guard locker{m_lock};
...
std::ostream&
operator<<(std::ostream& os, const FutureImpl& future)
{
