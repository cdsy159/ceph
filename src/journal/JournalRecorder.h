...
private:
  ...
  struct Listener : public JournalMetadataListener {
    ...
    void
    handle_update(JournalMetadata*) override
    {
  ...
  struct ObjectHandler : public ObjectRecorder::Handler {
    ...
    void
    closed(ObjectRecorder* object_recorder) override
    {
      journal_recorder->handle_closed(object_recorder);
    }

    void
    overflow(ObjectRecorder* object_recorder) override
    {
  ...
  ceph::ref_t<ObjectRecorder> create_object_recorder(
