...
private:
  ...
  struct FlushHandler : public FutureImpl::FlushHandler {
    ...
    virtual void
    flush(const ceph::ref_t<FutureImpl>& future) override
    {
...
inline void
intrusive_ptr_add_ref(ObjectRecorder* o)
{
  o->get();
}

inline void
intrusive_ptr_release(ObjectRecorder* o)
{
  o->put();
}
