...
//deprcated
void
librados::ObjectOperation::set_op_flags(ObjectOperationFlags flags)
{
  set_op_flags2((int)flags);
}

void
librados::ObjectOperation::set_op_flags2(int flags)
{
  ceph_assert(impl);
...
void
librados::ObjectOperation::cmpext(
    uint64_t off,
...
void
librados::ObjectOperation::cmpxattr(
    const char* name,
    uint8_t op,
    const bufferlist& v)
{
...
void
librados::ObjectOperation::cmpxattr(const char* name, uint8_t op, uint64_t v)
{
  ceph_assert(impl);
  ::ObjectOperation* o = &impl->o;
  bufferlist bl;
...
void
librados::ObjectOperation::assert_version(uint64_t ver)
{
  ceph_assert(impl);
  ::ObjectOperation* o = &impl->o;
...
void
librados::ObjectOperation::assert_exists()
{
  ceph_assert(impl);
  ::ObjectOperation* o = &impl->o;
...
void
librados::ObjectReadOperation::stat(uint64_t* psize, time_t* pmtime, int* prval)
{
  ceph_assert(impl);
  ::ObjectOperation* o = &impl->o;
...
void
librados::ObjectReadOperation::stat2(
    uint64_t* psize,
    struct timespec* pts,
    int* prval)
{
...
void
librados::ObjectReadOperation::checksum(
    ...
    int* prval)
{
  ...
  ::ObjectOperation* o = &impl->o;
  o->checksum(
      get_checksum_op_type(type), init_value_bl, off, len, chunk_size, pbl,
      prval, nullptr);
}

void
librados::ObjectReadOperation::getxattr(
    const char* name,
    bufferlist* pbl,
    int* prval)
{
...
void
librados::ObjectReadOperation::omap_get_vals(
    ...
    int* prval)
{
  ...
  ::ObjectOperation* o = &impl->o;
  o->omap_get_vals(
      start_after, filter_prefix, max_return, out_vals, nullptr, prval);
}

void
librados::ObjectReadOperation::omap_get_vals2(
    const std::string& start_after,
    const std::string& filter_prefix,
    uint64_t max_return,
    std::map<std::string, bufferlist>* out_vals,
    ...
    int* prval)
{
  ...
  ::ObjectOperation* o = &impl->o;
  o->omap_get_vals(
      start_after, filter_prefix, max_return, out_vals, pmore, prval);
}
...
void
librados::ObjectReadOperation::omap_get_keys(
    const std::string& start_after,
    uint64_t max_return,
...
void
librados::ObjectReadOperation::omap_get_keys2(
    const std::string& start_after,
    uint64_t max_return,
    std::set<std::string>* out_keys,
    bool* pmore,
...
void
librados::ObjectReadOperation::omap_get_header(bufferlist* bl, int* prval)
{
  ceph_assert(impl);
  ::ObjectOperation* o = &impl->o;
...
void
librados::ObjectReadOperation::omap_get_vals_by_keys(
...
void
librados::ObjectOperation::omap_cmp(
...
void
librados::ObjectReadOperation::list_watchers(
...
void
librados::ObjectReadOperation::list_snaps(snap_set_t* out_snaps, int* prval)
{
  ceph_assert(impl);
  ::ObjectOperation* o = &impl->o;
...
void
librados::ObjectReadOperation::is_dirty(bool* is_dirty, int* prval)
{
  ceph_assert(impl);
  ::ObjectOperation* o = &impl->o;
    ...
    std::map<std::string, bufferlist>* out_vals)
{
  ...
  while (max_return > 0 && more) {
    ...
    op.omap_get_vals2(
        start_after, filter_prefix, max_return, &out, &more, nullptr);
    bufferlist bl;
...
void
librados::ObjectReadOperation::getxattrs(
...
void
librados::ObjectWriteOperation::mtime(time_t* pt)
{
  ceph_assert(impl);
  if (pt) {
...
void
librados::ObjectWriteOperation::mtime2(struct timespec* pts)
{
  ceph_assert(impl);
  if (pts) {
...
void
librados::ObjectWriteOperation::create(bool exclusive)
{
  ceph_assert(impl);
  ::ObjectOperation* o = &impl->o;
  o->create(exclusive);
...
void
librados::ObjectWriteOperation::write(uint64_t off, const bufferlist& bl)
{
  ceph_assert(impl);
  ::ObjectOperation* o = &impl->o;
  bufferlist c = bl;
...
void
librados::ObjectWriteOperation::write_full(const bufferlist& bl)
{
  ceph_assert(impl);
  ::ObjectOperation* o = &impl->o;
  bufferlist c = bl;
...
void
librados::ObjectWriteOperation::writesame(
    uint64_t off,
    uint64_t write_len,
    const bufferlist& bl)
{
...
void
librados::ObjectWriteOperation::append(const bufferlist& bl)
{
  ceph_assert(impl);
  ::ObjectOperation* o = &impl->o;
  bufferlist c = bl;
...
void
librados::ObjectWriteOperation::remove()
{
  ceph_assert(impl);
  ::ObjectOperation* o = &impl->o;
  o->remove();
...
void
librados::ObjectWriteOperation::truncate(uint64_t off)
{
  ceph_assert(impl);
  ::ObjectOperation* o = &impl->o;
  o->truncate(off);
...
void
librados::ObjectWriteOperation::zero(uint64_t off, uint64_t len)
{
  ceph_assert(impl);
  ::ObjectOperation* o = &impl->o;
  o->zero(off, len);
...
void
librados::ObjectWriteOperation::rmxattr(const char* name)
{
  ceph_assert(impl);
  ::ObjectOperation* o = &impl->o;
  o->rmxattr(name);
...
void
librados::ObjectWriteOperation::setxattr(const char* name, const bufferlist& v)
{
  ceph_assert(impl);
  ::ObjectOperation* o = &impl->o;
  o->setxattr(name, v);
...
void
librados::ObjectWriteOperation::setxattr(const char* name, const buffer::list&& v)
{
  ceph_assert(impl);
  ::ObjectOperation* o = &impl->o;
...
void
librados::ObjectWriteOperation::omap_set(const map<string, bufferlist>& map)
{
  ceph_assert(impl);
  ::ObjectOperation* o = &impl->o;
  o->omap_set(map);
...
void
librados::ObjectWriteOperation::omap_set_header(const bufferlist& bl)
{
  ceph_assert(impl);
  bufferlist c = bl;
  ::ObjectOperation* o = &impl->o;
...
void
librados::ObjectWriteOperation::omap_clear()
{
  ceph_assert(impl);
  ::ObjectOperation* o = &impl->o;
  o->omap_clear();
...
void
librados::ObjectWriteOperation::omap_rm_keys(const std::set<std::string>& to_rm)
{
  ceph_assert(impl);
  ::ObjectOperation* o = &impl->o;
...
void
librados::ObjectWriteOperation::omap_rm_range(
...
void
librados::ObjectWriteOperation::copy_from(
    ...
    uint32_t src_fadvise_flags)
{
  ...
  ::ObjectOperation* o = &impl->o;
  o->copy_from(
      object_t(src), src_ioctx.io_ctx_impl->snap_seq,
      src_ioctx.io_ctx_impl->oloc, src_version, 0, src_fadvise_flags);
}

void
librados::ObjectWriteOperation::copy_from2(
    const std::string& src,
    const IoCtx& src_ioctx,
    uint64_t src_version,
    uint32_t truncate_seq,
    ...
    uint32_t src_fadvise_flags)
{
  ...
  o->copy_from2(
      object_t(src), src_ioctx.io_ctx_impl->snap_seq,
      src_ioctx.io_ctx_impl->oloc, src_version, 0, truncate_seq, truncate_size,
      src_fadvise_flags);
}

void
librados::ObjectWriteOperation::undirty()
{
  ceph_assert(impl);
  ::ObjectOperation* o = &impl->o;
  o->undirty();
...
void
librados::ObjectReadOperation::cache_flush()
{
  ceph_assert(impl);
  ::ObjectOperation* o = &impl->o;
  o->cache_flush();
...
void
librados::ObjectReadOperation::cache_try_flush()
{
  ceph_assert(impl);
  ::ObjectOperation* o = &impl->o;
  o->cache_try_flush();
...
void
librados::ObjectReadOperation::cache_evict()
{
  ceph_assert(impl);
  ::ObjectOperation* o = &impl->o;
  o->cache_evict();
...
void
librados::ObjectReadOperation::tier_flush()
{
  ceph_assert(impl);
  ::ObjectOperation* o = &impl->o;
  o->tier_flush();
...
void
librados::ObjectReadOperation::tier_evict()
{
  ceph_assert(impl);
  ::ObjectOperation* o = &impl->o;
  o->tier_evict();
...
void
librados::ObjectWriteOperation::set_redirect(
    const std::string& tgt_obj,
    ...
    int flag)
{
  ...
  ::ObjectOperation* o = &impl->o;
  o->set_redirect(
      object_t(tgt_obj), tgt_ioctx.io_ctx_impl->snap_seq,
      tgt_ioctx.io_ctx_impl->oloc, tgt_version, flag);
}

void
librados::ObjectReadOperation::set_chunk(
    uint64_t src_offset,
    uint64_t src_length,
    const IoCtx& tgt_ioctx,
    string tgt_oid,
    ...
    int flag)
{
  ...
  ::ObjectOperation* o = &impl->o;
  o->set_chunk(
      src_offset, src_length, tgt_ioctx.io_ctx_impl->oloc, object_t(tgt_oid),
      tgt_offset, flag);
}

void
librados::ObjectWriteOperation::tier_promote()
{
  ceph_assert(impl);
  ::ObjectOperation* o = &impl->o;
  o->tier_promote();
...
void
librados::ObjectWriteOperation::unset_manifest()
{
  ceph_assert(impl);
  ::ObjectOperation* o = &impl->o;
  o->unset_manifest();
...
void
librados::ObjectWriteOperation::tmap_update(const bufferlist& cmdbl)
{
  ceph_assert(impl);
  ::ObjectOperation* o = &impl->o;
  bufferlist c = cmdbl;
...
void
librados::ObjectWriteOperation::selfmanaged_snap_rollback(snap_t snapid)
{
  ceph_assert(impl);
  ::ObjectOperation* o = &impl->o;
  o->rollback(snapid);
...
void
librados::ObjectWriteOperation::snap_rollback(snap_t snapid)
{
  ceph_assert(impl);
  ::ObjectOperation* o = &impl->o;
  o->rollback(snapid);
...
void
librados::ObjectWriteOperation::set_alloc_hint(
...
void
librados::ObjectWriteOperation::set_alloc_hint2(
    uint64_t expected_object_size,
    uint64_t expected_write_size,
    uint32_t flags)
{
...
void
librados::ObjectWriteOperation::cache_pin()
{
  ceph_assert(impl);
  ::ObjectOperation* o = &impl->o;
  o->cache_pin();
...
void
librados::ObjectWriteOperation::cache_unpin()
{
  ceph_assert(impl);
  ::ObjectOperation* o = &impl->o;
  o->cache_unpin();
...
librados::NObjectIteratorImpl::~NObjectIteratorImpl() { ctx.reset(); }

librados::NObjectIteratorImpl::NObjectIteratorImpl(
    const NObjectIteratorImpl& rhs)
{
  *this = rhs;
}

librados::NObjectIteratorImpl&
librados::NObjectIteratorImpl::operator=(
    const librados::NObjectIteratorImpl& rhs)
{
  if (&rhs == this)
    return *this;
  if (rhs.ctx.get() == NULL) {
...
bool
librados::NObjectIteratorImpl::operator==(
    const librados::NObjectIteratorImpl& rhs) const
{
...
uint32_t
librados::NObjectIteratorImpl::seek(uint32_t pos)
{
...
uint32_t
librados::NObjectIteratorImpl::seek(const ObjectCursor& cursor)
{
  uint32_t r = rados_nobjects_list_seek_cursor(
      ctx.get(), (rados_object_list_cursor)cursor.c_cursor);
  get_next();
  return r;
}
...
void
librados::NObjectIteratorImpl::set_filter(const bufferlist& bl)
{
  ceph_assert(ctx);
  ctx->nlc->filter = bl;
}
...
void
librados::NObjectIteratorImpl::get_next()
{
  const char *entry, *key, *nspace;
  size_t entry_size, key_size, nspace_size;
  if (ctx->nlc->at_end())
    return;
  int ret = rados_nobjects_list_next2(
      ctx.get(), &entry, &key, &nspace, &entry_size, &key_size, &nspace_size);
  if (ret == -ENOENT) {
    return;
  } else if (ret) {
    throw std::system_error(
        -ret, std::system_category(), "rados_nobjects_list_next2");
  }
...
uint32_t
librados::NObjectIteratorImpl::get_pg_hash_position() const
{
...
librados::NObjectIterator::~NObjectIterator() { delete impl; }
...
librados::NObjectIterator::operator=(const librados::NObjectIterator& rhs)
{
  if (rhs.impl == NULL) {
    delete impl;
    impl = NULL;
...
bool
librados::NObjectIterator::operator==(const librados::NObjectIterator& rhs) const
{
  if (impl && rhs.impl) {
...
uint32_t
librados::NObjectIterator::seek(uint32_t pos)
{
  ceph_assert(impl);
...
uint32_t
librados::NObjectIterator::seek(const ObjectCursor& cursor)
{
  ceph_assert(impl);
...
void
librados::NObjectIterator::set_filter(const bufferlist& bl)
{
  impl->set_filter(bl);
}

void
librados::NObjectIterator::get_next()
{
  ceph_assert(impl);
  impl->get_next();
}
...
uint32_t
librados::NObjectIterator::get_pg_hash_position() const
{
  ceph_assert(impl);
...
int
librados::PoolAsyncCompletion::set_callback(void* cb_arg, rados_callback_t cb)
{
...
int
librados::PoolAsyncCompletion::wait()
{
  PoolAsyncCompletionImpl* c = (PoolAsyncCompletionImpl*)pc;
  return c->wait();
}
...
bool
librados::PoolAsyncCompletion::is_complete()
{
  PoolAsyncCompletionImpl* c = (PoolAsyncCompletionImpl*)pc;
...
int
librados::PoolAsyncCompletion::get_return_value()
{
  PoolAsyncCompletionImpl* c = (PoolAsyncCompletionImpl*)pc;
...
void
librados::PoolAsyncCompletion::release()
{
  delete this;
}
...
int
librados::AioCompletion::set_complete_callback(void* cb_arg, rados_callback_t cb)
{
...
int
librados::AioCompletion::set_safe_callback(void* cb_arg, rados_callback_t cb)
{
  AioCompletionImpl* c = (AioCompletionImpl*)pc;
...
int
librados::AioCompletion::wait_for_complete()
{
  AioCompletionImpl* c = (AioCompletionImpl*)pc;
...
int
librados::AioCompletion::wait_for_safe()
{
  AioCompletionImpl* c = (AioCompletionImpl*)pc;
  return c->wait_for_complete();
}
...
bool
librados::AioCompletion::is_complete()
{
  AioCompletionImpl* c = (AioCompletionImpl*)pc;
  return c->is_complete();
}
...
bool
librados::AioCompletion::is_safe()
{
  AioCompletionImpl* c = (AioCompletionImpl*)pc;
  return c->is_safe();
}
...
int
librados::AioCompletion::wait_for_complete_and_cb()
{
  AioCompletionImpl* c = (AioCompletionImpl*)pc;
...
int
librados::AioCompletion::wait_for_safe_and_cb()
{
  AioCompletionImpl* c = (AioCompletionImpl*)pc;
...
bool
librados::AioCompletion::is_complete_and_cb()
{
  AioCompletionImpl* c = (AioCompletionImpl*)pc;
...
bool
librados::AioCompletion::is_safe_and_cb()
{
  AioCompletionImpl* c = (AioCompletionImpl*)pc;
...
int
librados::AioCompletion::get_return_value()
{
  AioCompletionImpl* c = (AioCompletionImpl*)pc;
  return c->get_return_value();
}
...
int
librados::AioCompletion::get_version()
{
  AioCompletionImpl* c = (AioCompletionImpl*)pc;
...
uint64_t
librados::AioCompletion::get_version64()
{
  AioCompletionImpl* c = (AioCompletionImpl*)pc;
  return c->get_version();
}
...
void
librados::AioCompletion::release()
{
  delete this;
}

int
librados::AioCompletion::cancel()
{
  if (!pc->io) {
...
void
librados::IoCtx::from_rados_ioctx_t(rados_ioctx_t p, IoCtx& io)
{
...
librados::IoCtx&
librados::IoCtx::operator=(const IoCtx& rhs)
{
  if (io_ctx_impl)
    io_ctx_impl->put();
  io_ctx_impl = rhs.io_ctx_impl;
...
librados::IoCtx&
librados::IoCtx::operator=(IoCtx&& rhs) noexcept
{
  if (io_ctx_impl)
    io_ctx_impl->put();
  io_ctx_impl = std::exchange(rhs.io_ctx_impl, nullptr);
...
librados::IoCtx::~IoCtx() { close(); }

bool
librados::IoCtx::is_valid() const
{
  return io_ctx_impl != nullptr;
}

void
librados::IoCtx::close()
{
  if (io_ctx_impl)
    io_ctx_impl->put();
  io_ctx_impl = 0;
...
void
librados::IoCtx::dup(const IoCtx& rhs)
{
  if (io_ctx_impl)
    io_ctx_impl->put();
...
int
librados::IoCtx::set_auid(uint64_t auid_)
{
  return -EOPNOTSUPP;
}

int
librados::IoCtx::set_auid_async(uint64_t auid_, PoolAsyncCompletion* c)
{
  return -EOPNOTSUPP;
}
...
bool
librados::IoCtx::pool_requires_alignment()
{
  return io_ctx_impl->client->pool_requires_alignment(get_id());
}

int
librados::IoCtx::pool_requires_alignment2(bool* req)
{
  return io_ctx_impl->client->pool_requires_alignment2(get_id(), req);
}

uint64_t
librados::IoCtx::pool_required_alignment()
{
  return io_ctx_impl->client->pool_required_alignment(get_id());
}

int
librados::IoCtx::pool_required_alignment2(uint64_t* alignment)
{
...
uint64_t
librados::IoCtx::get_instance_id() const
{
  return io_ctx_impl->client->get_instance_id();
}

int
librados::IoCtx::create(const std::string& oid, bool exclusive)
{
  object_t obj(oid);
...
int
librados::IoCtx::append(const std::string& oid, bufferlist& bl, size_t len)
{
  object_t obj(oid);
...
int
librados::IoCtx::write_full(const std::string& oid, bufferlist& bl)
{
  object_t obj(oid);
...
{
  object_t obj(oid);
  return io_ctx_impl->checksum(
      obj, get_checksum_op_type(type), init_value_bl, len, off, chunk_size, pbl);
}

int
librados::IoCtx::remove(const std::string& oid)
{
  object_t obj(oid);
...
int
librados::IoCtx::remove(const std::string& oid, int flags)
{
  object_t obj(oid);
...
int
librados::IoCtx::trunc(const std::string& oid, uint64_t size)
{
  object_t obj(oid);
...
int
librados::IoCtx::cmpext(const std::string& oid, uint64_t off, bufferlist& cmp_bl)
{
  object_t obj(oid);
...
int
librados::IoCtx::rmxattr(const std::string& oid, const char* name)
{
  object_t obj(oid);
...
int
librados::IoCtx::stat(const std::string& oid, uint64_t* psize, time_t* pmtime)
{
  object_t obj(oid);
...
int
librados::IoCtx::tmap_update(const std::string& oid, bufferlist& cmdbl)
{
  object_t obj(oid);
...
int
librados::IoCtx::omap_get_header(const std::string& oid, bufferlist* bl)
{
  ObjectReadOperation op;
  int r;
...
int
librados::IoCtx::omap_get_vals_by_keys(
    const std::string& oid,
    const std::set<std::string>& keys,
...
int
librados::IoCtx::omap_set_header(const std::string& oid, const bufferlist& bl)
{
  ObjectWriteOperation op;
...
int
librados::IoCtx::omap_clear(const std::string& oid)
{
  ObjectWriteOperation op;
  op.omap_clear();
  return operate(oid, &op);
    ...
    int flags)
{
  ...
  if (unlikely(!o->impl))
    return -EINVAL;
  return io_ctx_impl->operate(
      obj, &o->impl->o, (ceph::real_time*)o->impl->prt, translate_flags(flags));
}
    ...
    int flags)
{
  ...
  if (unlikely(!o->impl))
    return -EINVAL;
  return io_ctx_impl->operate_read(
      obj, &o->impl->o, pbl, translate_flags(flags));
}
    ...
    librados::ObjectWriteOperation* o)
{
  ...
  if (unlikely(!o->impl))
    return -EINVAL;
  return io_ctx_impl->aio_operate(
      obj, &o->impl->o, c->pc, io_ctx_impl->snapc, o->impl->prt, 0);
}
    ...
    int flags)
{
  ...
  if (unlikely(!o->impl))
    return -EINVAL;
  return io_ctx_impl->aio_operate(
      obj, &o->impl->o, c->pc, io_ctx_impl->snapc, o->impl->prt,
    ...
    std::vector<snap_t>& snaps)
{
  ...
  return io_ctx_impl->aio_operate(
      obj, &o->impl->o, c->pc, snapc, o->impl->prt, 0);
}
    ...
    const blkin_trace_info* trace_info)
{
  ...
  SnapContext snapc(snap_seq, snv);
  return io_ctx_impl->aio_operate(
      obj, &o->impl->o, c->pc, snapc, o->impl->prt, 0, trace_info);
}
    ...
    const blkin_trace_info* trace_info)
{
  ...
  SnapContext snapc(snap_seq, snv);
  return io_ctx_impl->aio_operate(
      obj, &o->impl->o, c->pc, snapc, o->impl->prt, translate_flags(flags),
      trace_info);
}
    ...
    bufferlist* pbl)
{
  if (unlikely(!o->impl))
    return -EINVAL;
  object_t obj(oid);
  return io_ctx_impl->aio_operate_read(
      obj, &o->impl->o, c->pc, translate_flags(flags), pbl);
}
    ...
    const blkin_trace_info* trace_info)
{
  ...
  object_t obj(oid);
  return io_ctx_impl->aio_operate_read(
      obj, &o->impl->o, c->pc, translate_flags(flags), pbl, trace_info);
}

void
librados::IoCtx::snap_set_read(snap_t seq)
{
  io_ctx_impl->set_snap_read(seq);
}

int
librados::IoCtx::selfmanaged_snap_set_write_ctx(snap_t seq, vector<snap_t>& snaps)
{
  vector<snapid_t> snv;
  snv.resize(snaps.size());
...
int
librados::IoCtx::snap_create(const char* snapname)
{
  return io_ctx_impl->snap_create(snapname);
}

int
librados::IoCtx::snap_lookup(const char* name, snap_t* snapid)
{
  return io_ctx_impl->snap_lookup(name, snapid);
}

int
librados::IoCtx::snap_get_stamp(snap_t snapid, time_t* t)
{
  return io_ctx_impl->snap_get_stamp(snapid, t);
}

int
librados::IoCtx::snap_get_name(snap_t snapid, std::string* s)
{
  return io_ctx_impl->snap_get_name(snapid, s);
}

int
librados::IoCtx::snap_remove(const char* snapname)
{
  return io_ctx_impl->snap_remove(snapname);
}

int
librados::IoCtx::snap_list(std::vector<snap_t>* snaps)
{
  return io_ctx_impl->snap_list(snaps);
}

int
librados::IoCtx::snap_rollback(const std::string& oid, const char* snapname)
{
...
int
librados::IoCtx::rollback(const std::string& oid, const char* snapname)
{
  return snap_rollback(oid, snapname);
}

int
librados::IoCtx::selfmanaged_snap_create(uint64_t* snapid)
{
  return io_ctx_impl->selfmanaged_snap_create(snapid);
}

void
librados::IoCtx::aio_selfmanaged_snap_create(uint64_t* snapid, AioCompletion* c)
{
  io_ctx_impl->aio_selfmanaged_snap_create(snapid, c->pc);
}

int
librados::IoCtx::selfmanaged_snap_remove(uint64_t snapid)
{
  return io_ctx_impl->selfmanaged_snap_remove(snapid);
}

void
librados::IoCtx::aio_selfmanaged_snap_remove(uint64_t snapid, AioCompletion* c)
{
  io_ctx_impl->aio_selfmanaged_snap_remove(snapid, c->pc);
}

int
librados::IoCtx::selfmanaged_snap_rollback(
    const std::string& oid,
    uint64_t snapid)
{
  return io_ctx_impl->selfmanaged_snap_rollback_object(
      oid, io_ctx_impl->snapc, snapid);
}

int
librados::IoCtx::lock_exclusive(
    const std::string& oid,
    ...
    uint8_t flags)
{
  ...
  return rados::cls::lock::lock(
      this, oid, name, ClsLockType::EXCLUSIVE, cookie, "", description, dur,
      flags);
}

int
librados::IoCtx::lock_shared(
    const std::string& oid,
    const std::string& name,
    const std::string& cookie,
    ...
    uint8_t flags)
{
  ...
  return rados::cls::lock::lock(
      this, oid, name, ClsLockType::SHARED, cookie, tag, description, dur,
      flags);
}

int
librados::IoCtx::unlock(
    const std::string& oid,
    const std::string& name,
    const std::string& cookie)
{
...
struct AioUnlockCompletion : public librados::ObjectOperationCompletion {
  ...
  void
  handle_completion(int r, bufferlist& outbl) override
  {
    ...
    std::list<librados::locker_t>* lockers)
{
  ...
  int r = rados::cls::lock::get_lock_info(
...
librados::NObjectIterator
librados::IoCtx::nobjects_begin(const bufferlist& filter)
{
...
librados::NObjectIterator
librados::IoCtx::nobjects_begin(uint32_t pos, const bufferlist& filter)
{
  rados_list_ctx_t listh;
  rados_nobjects_list_open(io_ctx_impl, &listh);
  NObjectIterator iter((ObjListCtx*)listh);
...
uint64_t
librados::IoCtx::get_last_version()
{
  return io_ctx_impl->last_version();
}

int
librados::IoCtx::aio_read(
    const std::string& oid,
...
int
librados::IoCtx::aio_sparse_read(
    const std::string& oid,
    librados::AioCompletion* c,
    std::map<uint64_t, uint64_t>* m,
    bufferlist* data_bl,
    ...
    uint64_t off)
{
  return io_ctx_impl->aio_sparse_read(
      oid, c->pc, m, data_bl, len, off, io_ctx_impl->snap_seq);
}
...
int
librados::IoCtx::aio_remove(const std::string& oid, librados::AioCompletion* c)
{
  return io_ctx_impl->aio_remove(oid, c->pc);
}

int
librados::IoCtx::aio_remove(
    const std::string& oid,
    librados::AioCompletion* c,
    int flags)
{
...
int
librados::IoCtx::aio_flush_async(librados::AioCompletion* c)
{
...
static void
rados_aio_getxattr_completepp(rados_completion_t c, void* arg)
{
...
int
librados::IoCtx::aio_cancel(librados::AioCompletion* c)
{
...
int
librados::IoCtx::unwatch(const string& oid, uint64_t handle)
{
  return io_ctx_impl->unwatch(handle);
}

int
librados::IoCtx::unwatch2(uint64_t handle)
{
  return io_ctx_impl->unwatch(handle);
}

int
librados::IoCtx::aio_unwatch(uint64_t handle, AioCompletion* c)
{
  return io_ctx_impl->aio_unwatch(handle, c->pc);
}

int
librados::IoCtx::watch_check(uint64_t handle)
{
  return io_ctx_impl->watch_check(handle);
}

int
librados::IoCtx::notify(const string& oid, uint64_t ver, bufferlist& bl)
{
  object_t obj(oid);
...
{
  object_t obj(oid);
  return io_ctx_impl->aio_notify(
      obj, c->pc, bl, timeout_ms, preplybl, NULL, NULL);
}

void
librados::IoCtx::decode_notify_response(
    bufferlist& bl,
...
int
librados::IoCtx::list_snaps(const std::string& oid, snap_set_t* out_snaps)
{
  ObjectReadOperation op;
  int r;
...
void
librados::IoCtx::set_notify_timeout(uint32_t timeout)
{
  io_ctx_impl->set_notify_timeout(timeout);
}

int
librados::IoCtx::set_alloc_hint(
    const std::string& o,
    uint64_t expected_object_size,
    uint64_t expected_write_size)
{
  object_t oid(o);
  return io_ctx_impl->set_alloc_hint(
      oid, expected_object_size, expected_write_size, 0);
}

int
librados::IoCtx::set_alloc_hint2(
    const std::string& o,
    uint64_t expected_object_size,
    uint64_t expected_write_size,
    uint32_t flags)
...
void
librados::IoCtx::set_assert_version(uint64_t ver)
{
  io_ctx_impl->set_assert_version(ver);
}

void
librados::IoCtx::locator_set_key(const string& key)
{
  io_ctx_impl->oloc.key = key;
}

void
librados::IoCtx::set_namespace(const string& nspace)
{
  io_ctx_impl->oloc.nspace = nspace;
}

std::string
librados::IoCtx::get_namespace() const
{
  return io_ctx_impl->oloc.nspace;
}

int64_t
librados::IoCtx::get_id()
{
  return io_ctx_impl->get_id();
}

uint32_t
librados::IoCtx::get_object_hash_position(const std::string& oid)
{
  uint32_t hash;
...
uint32_t
librados::IoCtx::get_object_pg_hash_position(const std::string& oid)
{
  uint32_t hash;
...
int
librados::IoCtx::get_object_hash_position2(
    const std::string& oid,
...
int
librados::IoCtx::get_object_pg_hash_position2(
    const std::string& oid,
...
void
librados::IoCtx::set_osdmap_full_try()
{
  io_ctx_impl->extra_op_flags |= CEPH_OSD_FLAG_FULL_TRY;
}

void
librados::IoCtx::unset_osdmap_full_try()
{
  io_ctx_impl->extra_op_flags &= ~CEPH_OSD_FLAG_FULL_TRY;
}

bool
librados::IoCtx::get_pool_full_try()
{
  return (io_ctx_impl->extra_op_flags & CEPH_OSD_FLAG_FULL_TRY) != 0;
}

void
librados::IoCtx::set_pool_full_try()
{
  io_ctx_impl->extra_op_flags |= CEPH_OSD_FLAG_FULL_TRY;
}

void
librados::IoCtx::unset_pool_full_try()
{
  io_ctx_impl->extra_op_flags &= ~CEPH_OSD_FLAG_FULL_TRY;
}
...
///////////////////////////// Rados //////////////////////////////
void
librados::Rados::version(int* major, int* minor, int* extra)
{
...
librados::Rados::~Rados() { shutdown(); }

void
librados::Rados::from_rados_t(rados_t cluster, Rados& rados)
{
  if (rados.client) {
    rados.client->put();
  }
...
int
librados::Rados::init(const char* const id)
{
...
int
librados::Rados::init_with_context(config_t cct_)
{
...
int
librados::Rados::aio_watch_flush(AioCompletion* c)
{
  if (!client)
    return -EINVAL;
...
uint64_t
librados::Rados::get_instance_id()
{
  return client->get_instance_id();
}

int
librados::Rados::get_min_compatible_osd(int8_t* require_osd_release)
{
  return client->get_min_compatible_osd(require_osd_release);
}

int
librados::Rados::get_min_compatible_client(
...
int
librados::Rados::conf_read_file(const char* const path) const
{
  return rados_conf_read_file((rados_t)client, path);
}

int
librados::Rados::conf_parse_argv(int argc, const char** argv) const
{
  return rados_conf_parse_argv((rados_t)client, argc, argv);
}

int
librados::Rados::conf_parse_argv_remainder(
    int argc,
    const char** argv,
...
int
librados::Rados::conf_parse_env(const char* name) const
{
  return rados_conf_parse_env((rados_t)client, name);
}

int
librados::Rados::conf_set(const char* option, const char* value)
{
  return rados_conf_set((rados_t)client, option, value);
}

int
librados::Rados::conf_get(const char* option, std::string& val)
{
  char* str = NULL;
...
int
librados::Rados::service_daemon_register(
...
int
librados::Rados::service_daemon_update_status(
...
int
librados::Rados::pool_create(const char* name)
{
  string str(name);
...
int
librados::Rados::pool_create(const char* name, uint64_t auid)
{
...
int
librados::Rados::pool_create(const char* name, uint64_t auid, __u8 crush_rule)
{
  if (auid != CEPH_AUTH_UID_DEFAULT) {
    return -EINVAL;
  }
...
int
librados::Rados::pool_create_with_rule(const char* name, __u8 crush_rule)
{
  string str(name);
  return client->pool_create(str, crush_rule);
}
...
int
librados::Rados::pool_create_async(const char* name, PoolAsyncCompletion* c)
{
  string str(name);
...
int
librados::Rados::pool_create_async(
    const char* name,
    uint64_t auid,
...
int
librados::Rados::pool_create_with_rule_async(
    const char* name,
    __u8 crush_rule,
    PoolAsyncCompletion* c)
{
...
int
librados::Rados::pool_get_base_tier(int64_t pool_id, int64_t* base_tier)
{
...
int
librados::Rados::pool_delete(const char* name)
{
  return client->pool_delete(name);
}

int
librados::Rados::pool_delete_async(const char* name, PoolAsyncCompletion* c)
{
  return client->pool_delete_async(name, c->pc);
}

int
librados::Rados::pool_list(std::list<std::string>& v)
{
...
int
librados::Rados::pool_list2(std::list<std::pair<int64_t, std::string>>& v)
{
  return client->pool_list(v);
}

int64_t
librados::Rados::pool_lookup(const char* name)
{
  return client->lookup_pool(name);
}

int
librados::Rados::pool_reverse_lookup(int64_t id, std::string* name)
{
...
librados::Rados::osd_command(
    ...
    std::string* outs)
{
  return client->osd_command(
      osdid, {std::move(cmd)}, std::move(inbl), outbl, outs);
}
    ...
    std::string* outs)
{
  ...
  return client->pg_command(
      pgid, std::move(cmdvec), std::move(inbl), outbl, outs);
}
...
int
librados::Rados::ioctx_create2(int64_t pool_id, IoCtx& io)
{
  rados_ioctx_t p;
...
void
librados::Rados::test_blocklist_self(bool set)
{
  client->blocklist_self(set);
}

int
librados::Rados::get_pool_stats(std::list<string>& v, stats_map& result)
{
...
bool
librados::Rados::get_pool_is_selfmanaged_snaps_mode(const std::string& pool)
{
...
int
librados::Rados::pool_is_in_selfmanaged_snaps_mode(const std::string& pool)
{
  return client->pool_is_in_selfmanaged_snaps_mode(pool);
}

int
librados::Rados::cluster_stat(cluster_stat_t& result)
{
  ceph_statfs stats;
...
int
librados::Rados::cluster_fsid(string* fsid)
{
...
bool
PlacementGroup::parse(const char* s)
{
...
std::ostream&
librados::operator<<(std::ostream& out, const librados::PlacementGroup& pg)
{
  return out << pg.impl->pgid;
}

int
librados::Rados::get_inconsistent_pgs(
    int64_t pool_id,
...
int
librados::Rados::get_inconsistent_objects(
    ...
    uint32_t* interval)
{
  ...
  return ioctx.io_ctx_impl->get_inconsistent_objects(
      pgid, start_after, max_return, c->pc, objects, interval);
}

int
librados::Rados::get_inconsistent_snapsets(
    const PlacementGroup& pg,
    const object_id_t& start_after,
    unsigned max_return,
    AioCompletion* c,
    ...
    uint32_t* interval)
{
  ...
  return ioctx.io_ctx_impl->get_inconsistent_snapsets(
      pgid, start_after, max_return, c->pc, snapsets, interval);
}

int
librados::Rados::wait_for_latest_osdmap()
{
  return client->wait_for_latest_osdmap();
}

int
librados::Rados::blocklist_add(
...
std::string
librados::Rados::get_addrs() const
{
...
librados::AioCompletion*
librados::Rados::aio_create_completion(void* cb_arg, callback_t cb_complete)
{
  AioCompletionImpl* c;
...
librados::ObjectOperation::~ObjectOperation() { delete impl; }
...
librados::ListObject&
librados::ListObject::operator=(const ListObject& rhs)
{
  if (rhs.impl == NULL) {
    delete impl;
    impl = NULL;
...
std::ostream&
librados::operator<<(std::ostream& out, const librados::ListObject& lop)
{
  out << *(lop.impl);
  return out;
}
...
librados::ObjectCursor&
librados::ObjectCursor::operator=(const librados::ObjectCursor& rhs)
{
...
bool
librados::ObjectCursor::operator<(const librados::ObjectCursor& rhs) const
{
  const hobject_t lhs_hobj = (c_cursor == nullptr) ? hobject_t()
                                                   : *((hobject_t*)c_cursor);
  const hobject_t rhs_hobj = (rhs.c_cursor == nullptr)
                                 ? hobject_t()
                                 : *((hobject_t*)(rhs.c_cursor));
...
void
librados::ObjectCursor::set(rados_object_list_cursor c)
{
...
bool
librados::ObjectCursor::from_str(const string& s)
{
  if (s.empty()) {
...
bool
librados::IoCtx::object_list_is_end(const ObjectCursor& oc)
{
    ...
    ObjectCursor* next)
{
  ...
  io_ctx_impl->objecter->enumerate_objects<librados::ListObjectImpl>(
      io_ctx_impl->poolid, io_ctx_impl->oloc.nspace,
      *((hobject_t*)start.c_cursor), *((hobject_t*)finish.c_cursor),
      result_item_count, filter, w);
...
void
librados::IoCtx::object_list_slice(
    const ObjectCursor start,
    const ObjectCursor finish,
    const size_t n,
    const size_t m,
    ...
    ObjectCursor* split_finish)
{
  ...
  io_ctx_impl->object_list_slice(
      *((hobject_t*)(start.c_cursor)), *((hobject_t*)(finish.c_cursor)), n, m,
      (hobject_t*)(split_start->c_cursor),
      (hobject_t*)(split_finish->c_cursor));
}

int
librados::IoCtx::application_enable(const std::string& app_name, bool force)
{
  return io_ctx_impl->application_enable(app_name, force);
}

int
librados::IoCtx::application_enable_async(
...
int
librados::IoCtx::application_list(std::set<std::string>* app_names)
{
  return io_ctx_impl->application_list(app_names);
}

int
librados::IoCtx::application_metadata_get(
    const std::string& app_name,
...
int
librados::IoCtx::application_metadata_set(
    const std::string& app_name,
    const std::string& key,
...
int
librados::IoCtx::application_metadata_remove(
    const std::string& app_name,
    const std::string& key)
{
...
int
librados::IoCtx::application_metadata_list(
    const std::string& app_name,
...
void
librados::IoCtx::set_no_version_on_read(bool value)
{
