...
int
libradosstriper::MultiAioCompletion::set_complete_callback(
    void* cb_arg,
    rados_callback_t cb)
{
...
int
libradosstriper::MultiAioCompletion::set_safe_callback(
    void* cb_arg,
    rados_callback_t cb)
{
  MultiAioCompletionImpl* c = (MultiAioCompletionImpl*)pc;
...
void
libradosstriper::MultiAioCompletion::wait_for_complete()
{
  MultiAioCompletionImpl* c = (MultiAioCompletionImpl*)pc;
  c->wait_for_complete();
}
...
void
libradosstriper::MultiAioCompletion::wait_for_safe()
{
  MultiAioCompletionImpl* c = (MultiAioCompletionImpl*)pc;
  c->wait_for_safe();
}
...
bool
libradosstriper::MultiAioCompletion::is_complete()
{
  MultiAioCompletionImpl* c = (MultiAioCompletionImpl*)pc;
...
bool
libradosstriper::MultiAioCompletion::is_safe()
{
  MultiAioCompletionImpl* c = (MultiAioCompletionImpl*)pc;
  return c->is_safe();
}
...
void
libradosstriper::MultiAioCompletion::wait_for_complete_and_cb()
{
  MultiAioCompletionImpl* c = (MultiAioCompletionImpl*)pc;
...
void
libradosstriper::MultiAioCompletion::MultiAioCompletion::wait_for_safe_and_cb()
{
  MultiAioCompletionImpl* c = (MultiAioCompletionImpl*)pc;
...
bool
libradosstriper::MultiAioCompletion::is_complete_and_cb()
{
  MultiAioCompletionImpl* c = (MultiAioCompletionImpl*)pc;
...
bool
libradosstriper::MultiAioCompletion::is_safe_and_cb()
{
  MultiAioCompletionImpl* c = (MultiAioCompletionImpl*)pc;
...
int
libradosstriper::MultiAioCompletion::get_return_value()
{
  MultiAioCompletionImpl* c = (MultiAioCompletionImpl*)pc;
...
void
libradosstriper::MultiAioCompletion::release()
{
  MultiAioCompletionImpl* c = (MultiAioCompletionImpl*)pc;
  c->put();
  delete this;
...
void
libradosstriper::RadosStriper::to_rados_striper_t(
...
libradosstriper::RadosStriper::operator=(const RadosStriper& rs)
{
  if (rados_striper_impl)
    ...
    RadosStriper* striper)
{
  try {
    striper->rados_striper_impl =
        new libradosstriper::RadosStriperImpl(ioctx, ioctx.io_ctx_impl);
    striper->rados_striper_impl->get();
  } catch (int rc) {
    return rc;
  }
...
int
libradosstriper::RadosStriper::set_object_layout_stripe_unit(
...
int
libradosstriper::RadosStriper::set_object_layout_stripe_count(
...
int
libradosstriper::RadosStriper::set_object_layout_object_size(
...
int
libradosstriper::RadosStriper::getxattr(
...
int
libradosstriper::RadosStriper::setxattr(
    const std::string& oid,
    const char* name,
    bufferlist& bl)
{
...
int
libradosstriper::RadosStriper::rmxattr(const std::string& oid, const char* name)
{
  return rados_striper_impl->rmxattr(oid, name);
}

int
libradosstriper::RadosStriper::getxattrs(
    const std::string& oid,
...
int
libradosstriper::RadosStriper::write(
...
int
libradosstriper::RadosStriper::write_full(
    const std::string& soid,
    const bufferlist& bl)
{
...
int
libradosstriper::RadosStriper::append(
    const std::string& soid,
    const bufferlist& bl,
    size_t len)
{
...
int
libradosstriper::RadosStriper::aio_write(
    const std::string& soid,
...
int
libradosstriper::RadosStriper::aio_write_full(
    const std::string& soid,
    librados::AioCompletion* c,
    const bufferlist& bl)
{
...
int
libradosstriper::RadosStriper::aio_append(
    const std::string& soid,
    librados::AioCompletion* c,
    const bufferlist& bl,
    size_t len)
...
int
libradosstriper::RadosStriper::read(
    const std::string& soid,
    bufferlist* bl,
    size_t len,
    uint64_t off)
...
int
libradosstriper::RadosStriper::aio_read(
    const std::string& soid,
    librados::AioCompletion* c,
    bufferlist* bl,
    size_t len,
...
int
libradosstriper::RadosStriper::stat(
    const std::string& soid,
    uint64_t* psize,
    time_t* pmtime)
{
...
int
libradosstriper::RadosStriper::aio_stat(
    const std::string& soid,
    librados::AioCompletion* c,
    uint64_t* psize,
    time_t* pmtime)
...
int
libradosstriper::RadosStriper::stat2(
    const std::string& soid,
    uint64_t* psize,
    struct timespec* pts)
{
...
int
libradosstriper::RadosStriper::aio_stat2(
    const std::string& soid,
    librados::AioCompletion* c,
    uint64_t* psize,
    struct timespec* pts)
...
int
libradosstriper::RadosStriper::remove(const std::string& soid)
{
  return rados_striper_impl->remove(soid);
}

int
libradosstriper::RadosStriper::aio_remove(
    const std::string& soid,
    librados::AioCompletion* c)
{
...
int
libradosstriper::RadosStriper::remove(const std::string& soid, int flags)
{
...
int
libradosstriper::RadosStriper::trunc(const std::string& soid, uint64_t size)
{
  return rados_striper_impl->trunc(soid, size);
}

int
libradosstriper::RadosStriper::aio_flush()
{
...
extern "C" int
rados_striper_create(rados_ioctx_t ioctx, rados_striper_t* striper)
{
  librados::IoCtx ctx;
...
extern "C" void
rados_striper_destroy(rados_striper_t striper)
{
  libradosstriper::RadosStriperImpl* impl =
      (libradosstriper::RadosStriperImpl*)striper;
  impl->put();
}

extern "C" int
rados_striper_set_object_layout_stripe_unit(
...
extern "C" int
rados_striper_set_object_layout_stripe_count(
    rados_striper_t striper,
    unsigned int stripe_count)
{
  libradosstriper::RadosStriperImpl* impl =
...
extern "C" int
rados_striper_set_object_layout_object_size(
    rados_striper_t striper,
    unsigned int object_size)
{
  libradosstriper::RadosStriperImpl* impl =
...
extern "C" int
rados_striper_remove(rados_striper_t striper, const char* soid)
{
  libradosstriper::RadosStriperImpl* impl =
      (libradosstriper::RadosStriperImpl*)striper;
...
extern "C" int
rados_striper_trunc(rados_striper_t striper, const char* soid, uint64_t size)
{
  libradosstriper::RadosStriperImpl* impl =
      (libradosstriper::RadosStriperImpl*)striper;
...
extern "C" int
rados_striper_rmxattr(rados_striper_t striper, const char* oid, const char* name)
{
  libradosstriper::RadosStriperImpl* impl =
      (libradosstriper::RadosStriperImpl*)striper;
  object_t obj(oid);
...
extern "C" void
rados_striper_getxattrs_end(rados_xattrs_iter_t iter)
{
...
extern "C" void
rados_striper_multi_aio_wait_for_complete(rados_striper_multi_completion_t c)
{
  ((libradosstriper::MultiAioCompletionImpl*)c)->wait_for_complete();
}

extern "C" void
rados_striper_multi_aio_wait_for_safe(rados_striper_multi_completion_t c)
{
  ((libradosstriper::MultiAioCompletionImpl*)c)->wait_for_safe();
}

extern "C" int
rados_striper_multi_aio_is_complete(rados_striper_multi_completion_t c)
{
  return ((libradosstriper::MultiAioCompletionImpl*)c)->is_complete();
}

extern "C" int
rados_striper_multi_aio_is_safe(rados_striper_multi_completion_t c)
{
  return ((libradosstriper::MultiAioCompletionImpl*)c)->is_safe();
}

extern "C" void
rados_striper_multi_aio_wait_for_complete_and_cb(
...
extern "C" void
rados_striper_multi_aio_wait_for_safe_and_cb(rados_striper_multi_completion_t c)
{
  ((libradosstriper::MultiAioCompletionImpl*)c)->wait_for_safe_and_cb();
}

extern "C" int
rados_striper_multi_aio_is_complete_and_cb(rados_striper_multi_completion_t c)
{
  return ((libradosstriper::MultiAioCompletionImpl*)c)->is_complete_and_cb();
}

extern "C" int
rados_striper_multi_aio_is_safe_and_cb(rados_striper_multi_completion_t c)
{
  return ((libradosstriper::MultiAioCompletionImpl*)c)->is_safe_and_cb();
}

extern "C" int
rados_striper_multi_aio_get_return_value(rados_striper_multi_completion_t c)
{
  return ((libradosstriper::MultiAioCompletionImpl*)c)->get_return_value();
}

extern "C" void
rados_striper_multi_aio_release(rados_striper_multi_completion_t c)
{
    ...
    uint64_t off)
{
  ...
  bufferlist bl;
  bl.append(buf, len);
  return impl->aio_write(
      soid, (librados::AioCompletionImpl*)completion, bl, len, off);
}
    ...
    size_t len)
{
  ...
  bufferlist bl;
  bl.append(buf, len);
  return impl->aio_append(
      soid, (librados::AioCompletionImpl*)completion, bl, len);
}
...
extern "C" void
rados_striper_aio_flush(rados_striper_t striper)
{
  libradosstriper::RadosStriperImpl* impl =
      (libradosstriper::RadosStriperImpl*)striper;
  impl->aio_flush();
    ...
    time_t* pmtime)
{
  libradosstriper::RadosStriperImpl* impl =
      (libradosstriper::RadosStriperImpl*)striper;
  return impl->aio_stat(
      soid, (librados::AioCompletionImpl*)completion, psize, pmtime);
}

extern "C" int
rados_striper_aio_stat2(
    rados_striper_t striper,
    const char* soid,
    rados_completion_t completion,
    uint64_t* psize,
