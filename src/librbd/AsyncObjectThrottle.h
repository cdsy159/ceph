...
public:
  C_AsyncObjectThrottle(
      AsyncObjectThrottleFinisher& finisher,
      ImageCtxT& image_ctx) :
...
public:
  typedef boost::function<
      C_AsyncObjectThrottle<ImageCtxT>*(AsyncObjectThrottle&, uint64_t)>
      ContextFactory;

  AsyncObjectThrottle(
      const AsyncRequest<ImageCtxT>* async_request,
      ImageCtxT& image_ctx,
