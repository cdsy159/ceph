...
struct ImageCtx {
  ...
  struct SnapKeyComparator {
    inline bool
    operator()(const SnapKey& lhs, const SnapKey& rhs) const
    {
  ...
  mutable ceph::shared_mutex
      image_lock; // protects snapshot-related member variables,
