...
public:
      ...
      uint32_t blocklist_expire_seconds)
  {
    return new ManagedLock(
        ioctx, asio_engine, oid, watcher, mode, blocklist_on_break_lock,
...
protected:
  ...
  inline bool
  is_state_waiting_for_lock() const
  {
    ceph_assert(ceph_mutex_is_locked(m_lock));
