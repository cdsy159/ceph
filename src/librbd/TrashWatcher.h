...
public:
  ...
  static void notify_image_added(
...
private:
  ...
  bool handle_payload(
      const trash_watcher::ImageAddedPayload& payload,
      Context* on_notify_ack);
  bool handle_payload(
      const trash_watcher::ImageRemovedPayload& payload,
      Context* on_notify_ack);
  bool handle_payload(
      const trash_watcher::UnknownPayload& payload,
      Context* on_notify_ack);
};
