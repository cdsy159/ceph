...
public:
  static ParentCacheObjectDispatch*
  create(ImageCtxT* image_ctx, plugin::Api<ImageCtxT>& plugin_api)
  {
  ...
  bool
  invalidate_cache(Context* on_finish)
  {
    return false;
  }

  bool
  reset_existence_cache(Context* on_finish)
  {
    return false;
  }
