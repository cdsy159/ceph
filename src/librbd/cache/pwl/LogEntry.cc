...
#undef dout_prefix
#define dout_prefix \
  *_dout << "librbd::cache::pwl::LogEntry: " << this << " " << __func__ << ": "
...
std::ostream&
GenericLogEntry::format(std::ostream& os) const
{
...
std::ostream&
operator<<(std::ostream& os, const GenericLogEntry& entry)
{
  return entry.format(os);
}

std::ostream&
SyncPointLogEntry::format(std::ostream& os) const
{
  os << "(Sync Point) ";
  GenericLogEntry::format(os);
  os << ", writes=" << writes << ", bytes=" << bytes
...
std::ostream&
operator<<(std::ostream& os, const SyncPointLogEntry& entry)
{
  return entry.format(os);
}

bool
GenericWriteLogEntry::can_writeback() const
{
  return (
      this->completed && (ram_entry.is_sequenced() ||
                          (sync_point_entry && sync_point_entry->completed)));
}

std::ostream&
GenericWriteLogEntry::format(std::ostream& os) const
{
  GenericLogEntry::format(os);
  os << ", sync_point_entry=[";
  if (sync_point_entry) {
...
std::ostream&
operator<<(std::ostream& os, const GenericWriteLogEntry& entry)
{
  return entry.format(os);
}
...
std::ostream&
WriteLogEntry::format(std::ostream& os) const
{
  os << "(Write) ";
...
std::ostream&
DiscardLogEntry::format(std::ostream& os) const
{
  os << "(Discard) ";
  GenericWriteLogEntry::format(os);
  return os;
...
std::ostream&
operator<<(std::ostream& os, const DiscardLogEntry& entry)
{
  return entry.format(os);
}
