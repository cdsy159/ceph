...
public:
  ...
  virtual std::shared_ptr<SyncPointLogEntry>
  ...
  virtual void
  writeback(librbd::cache::ImageWritebackInterface& image_writeback, Context* ctx)
  {
    ceph_assert(false);
  };
  ...
  virtual bool
  is_write_entry() const
  {
    return false;
  }

  virtual bool
  is_writesame_entry() const
  {
    return false;
  }
...
public:
  ...
  bool
  can_retire() const override
  {
    return this->completed;
  }

  bool
  is_sync_point() const override
  {
    return true;
  }
...
public:
  ...
  std::shared_ptr<SyncPointLogEntry>
  ...
  void
  set_flushed(bool flushed) override
  {
    m_flushed = flushed;
  }
...
protected:
  ...
  virtual void
  init_bl(buffer::ptr& bp, buffer::list& bl)
  {}
...
public:
  ...
  WriteLogEntry(
    ...
    m_entry_bl_lock(ceph::make_mutex(pwl::unique_lock_name(
        "librbd::cache::pwl::WriteLogEntry::m_entry_bl_lock",
        this)))
  {}
  ...
  virtual void
  init_cache_buffer(std::vector<WriteBufferAllocation>::iterator allocation)
  {}

  virtual void
  init_cache_bl(bufferlist& src_bl, uint64_t off, uint64_t len)
  {}
  ...
  bool
  is_write_entry() const override
  {
    return true;
  }

  bool
  is_writesame_entry() const override
  {
    return is_writesame;
  }
...
public:
  ...
  void
  copy_cache_bl(bufferlist* out_bl) override
  {
    ceph_assert(false);
  }
