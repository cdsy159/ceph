...
public:
  ...
  const std::shared_ptr<GenericLogEntry>
  get_log_entry() override
  {
...
public:
  ...
  void
  mark_log_entry_completed() override
  {
    sync_point->log_entry->writes_completed++;
  }

  bool
  reserved_allocated() const override
  {
    return true;
  }

  bool
  is_writing_op() const override
  {
    return true;
  }
