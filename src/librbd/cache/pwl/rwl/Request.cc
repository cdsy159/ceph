...
#undef dout_prefix
#define dout_prefix                                                         \
  *_dout << "librbd::cache::pwl::rwl::Request: " << this << " " << __func__ \
         << ": "
...
template class librbd::cache::pwl::rwl::C_WriteRequest<
    librbd::cache::pwl::AbstractWriteLog<librbd::ImageCtx>>;
template class librbd::cache::pwl::rwl::C_WriteSameRequest<
    librbd::cache::pwl::AbstractWriteLog<librbd::ImageCtx>>;
template class librbd::cache::pwl::rwl::C_CompAndWriteRequest<
    librbd::cache::pwl::AbstractWriteLog<librbd::ImageCtx>>;
