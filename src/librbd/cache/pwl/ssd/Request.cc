...
#undef dout_prefix
#define dout_prefix                                                         \
  *_dout << "librbd::cache::pwl::ssd::Request: " << this << " " << __func__ \
         << ": "
...
template <typename T>
void
C_WriteRequest<T>::setup_buffer_resources(
...
template <typename T>
std::ostream&
operator<<(std::ostream& os, const C_CompAndWriteRequest<T>& req)
{
...
template <typename T>
void
C_WriteSameRequest<T>::setup_buffer_resources(
    uint64_t* bytes_cached,
    uint64_t* bytes_dirtied,
    uint64_t* bytes_allocated,
    uint64_t* number_lanes,
...
template class librbd::cache::pwl::ssd::C_WriteRequest<
    librbd::cache::pwl::AbstractWriteLog<librbd::ImageCtx>>;
template class librbd::cache::pwl::ssd::C_WriteSameRequest<
    librbd::cache::pwl::AbstractWriteLog<librbd::ImageCtx>>;
template class librbd::cache::pwl::ssd::C_CompAndWriteRequest<
    librbd::cache::pwl::AbstractWriteLog<librbd::ImageCtx>>;
