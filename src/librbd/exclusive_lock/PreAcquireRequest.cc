...
#undef dout_prefix
#define dout_prefix                                                      \
  *_dout << "librbd::exclusive_lock::PreAcquireRequest: " << this << " " \
         << __func__ << ": "
...
template <typename I>
PreAcquireRequest<I>*
PreAcquireRequest<I>::create(I& image_ctx, Context* on_finish)
{
...
template <typename I>
void
PreAcquireRequest<I>::send_prepare_lock()
{
...
template <typename I>
void
PreAcquireRequest<I>::handle_prepare_lock(int r)
{
  CephContext* cct = m_image_ctx.cct;
...
template <typename I>
void
PreAcquireRequest<I>::send_flush_notifies()
{
  CephContext* cct = m_image_ctx.cct;
  ldout(cct, 10) << dendl;
...
template <typename I>
void
PreAcquireRequest<I>::handle_flush_notifies(int r)
{
  CephContext* cct = m_image_ctx.cct;
  ldout(cct, 10) << dendl;
