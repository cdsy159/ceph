...
#undef dout_prefix
#define dout_prefix                                                           \
  *_dout << "librbd::image::AttachParentRequest: " << this << " " << __func__ \
         << ": "
...
template <typename I>
void
AttachParentRequest<I>::attach_parent()
{
  ...
  auto aio_comp = create_rados_callback<
      AttachParentRequest<I>, &AttachParentRequest<I>::handle_attach_parent>(
      this);
...
template <typename I>
void
AttachParentRequest<I>::handle_attach_parent(int r)
{
  auto cct = m_image_ctx.cct;
  ldout(cct, 5) << dendl;
...
template <typename I>
void
AttachParentRequest<I>::finish(int r)
{
  auto cct = m_image_ctx.cct;
