...
#undef dout_prefix
#define dout_prefix                                                           \
  *_dout << "librbd::image::DetachParentRequest: " << this << " " << __func__ \
         << ": "
...
template <typename I>
void
DetachParentRequest<I>::detach_parent()
{
  ...
  auto aio_comp = create_rados_callback<
      DetachParentRequest<I>, &DetachParentRequest<I>::handle_detach_parent>(
      this);
...
template <typename I>
void
DetachParentRequest<I>::handle_detach_parent(int r)
{
  auto cct = m_image_ctx.cct;
  ldout(cct, 5) << dendl;
...
template <typename I>
void
DetachParentRequest<I>::finish(int r)
{
  auto cct = m_image_ctx.cct;
