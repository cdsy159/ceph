...
#undef dout_prefix
#define dout_prefix                                                        \
  *_dout << "librbd::image::PreRemoveRequest: " << this << " " << __func__ \
         << ": "
...
bool
auto_delete_snapshot(const SnapInfo& snap_info)
{
  auto snap_namespace_type =
...
bool
ignore_snapshot(const SnapInfo& snap_info)
{
  auto snap_namespace_type =
      cls::rbd::get_snap_namespace_type(snap_info.snap_namespace);
  switch (snap_namespace_type) {
...
template <typename I>
void
PreRemoveRequest<I>::acquire_exclusive_lock()
{
  ...
  auto ctx = create_context_callback<
      PreRemoveRequest<I>, &PreRemoveRequest<I>::handle_exclusive_lock>(
...
template <typename I>
void
PreRemoveRequest<I>::handle_exclusive_lock(int r)
{
  auto cct = m_image_ctx->cct;
...
template <typename I>
void
PreRemoveRequest<I>::shut_down_exclusive_lock()
{
  ...
  auto ctx = create_context_callback<
      PreRemoveRequest<I>, &PreRemoveRequest<I>::handle_shut_down_exclusive_lock>(
      this);
...
template <typename I>
void
PreRemoveRequest<I>::handle_shut_down_exclusive_lock(int r)
{
  auto cct = m_image_ctx->cct;
  ldout(cct, 5) << "r=" << r << dendl;
...
template <typename I>
void
PreRemoveRequest<I>::validate_image_removal()
{
  auto cct = m_image_ctx->cct;
  ldout(cct, 5) << dendl;
...
template <typename I>
void
PreRemoveRequest<I>::check_image_snaps()
{
  auto cct = m_image_ctx->cct;
  ldout(cct, 5) << dendl;
...
template <typename I>
void
PreRemoveRequest<I>::list_image_watchers()
{
  auto cct = m_image_ctx->cct;
  ldout(cct, 5) << dendl;
  ...
  auto ctx = create_context_callback<
      PreRemoveRequest<I>, &PreRemoveRequest<I>::handle_list_image_watchers>(
      this);
  auto req =
      ListWatchersRequest<I>::create(*m_image_ctx, flags, &m_watchers, ctx);
  req->send();
}

template <typename I>
void
PreRemoveRequest<I>::handle_list_image_watchers(int r)
{
  auto cct = m_image_ctx->cct;
  ldout(cct, 5) << "r=" << r << dendl;
...
template <typename I>
void
PreRemoveRequest<I>::check_image_watchers()
{
  auto cct = m_image_ctx->cct;
  ldout(cct, 5) << dendl;
...
template <typename I>
void
PreRemoveRequest<I>::check_group()
{
  ...
  int r = m_image_ctx->md_ctx.aio_operate(
      m_image_ctx->header_oid, rados_completion, &op, &m_out_bl);
  ceph_assert(r == 0);
...
template <typename I>
void
PreRemoveRequest<I>::handle_check_group(int r)
{
  auto cct = m_image_ctx->cct;
  ldout(cct, 5) << "r=" << r << dendl;
...
template <typename I>
void
PreRemoveRequest<I>::remove_snapshot()
{
...
template <typename I>
void
PreRemoveRequest<I>::handle_remove_snapshot(int r)
{
  auto cct = m_image_ctx->cct;
  ldout(cct, 5) << "r=" << r << dendl;
...
template <typename I>
void
PreRemoveRequest<I>::finish(int r)
{
  auto cct = m_image_ctx->cct;
  ldout(cct, 5) << "r=" << r << dendl;
