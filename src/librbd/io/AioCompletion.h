...
struct AioCompletion {
  ...
  static void
  callback_adapter(completion_t cb, void* arg)
  {
  ...
  static AioCompletion*
  create(void* cb_arg, callback_t cb_complete, rbd_completion_t rbd_comp)
  {
  ...
  template <typename T, void (T::*MF)(int) = &T::complete>
  static AioCompletion*
  create_and_start(T* obj, ImageCtx* image_ctx, aio_type_t type)
  {
  ...
  inline bool
  is_initialized(aio_type_t type) const
  {
  ...
  void
  set_complete_cb(void* cb_arg, callback_t cb)
  {
    complete_cb = cb;
    complete_arg = cb_arg;
  }
