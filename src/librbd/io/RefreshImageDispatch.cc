...
template <typename I>
void
RefreshImageDispatch<I>::shut_down(Context* on_finish)
{
...
template <typename I>
bool
RefreshImageDispatch<I>::discard(
    AioCompletion* aio_comp,
    Extents&& image_extents,
...
template <typename I>
bool
RefreshImageDispatch<I>::write_same(
    AioCompletion* aio_comp,
    Extents&& image_extents,
    bufferlist&& bl,
    int op_flags,
...
template <typename I>
bool
RefreshImageDispatch<I>::compare_and_write(
    AioCompletion* aio_comp,
    Extents&& image_extents,
    bufferlist&& cmp_bl,
    bufferlist&& bl,
...
template <typename I>
bool
RefreshImageDispatch<I>::needs_refresh(
    DispatchResult* dispatch_result,
    Context* on_dispatched)
{
  auto cct = m_image_ctx->cct;
