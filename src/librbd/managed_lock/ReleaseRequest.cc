...
#undef dout_prefix
#define dout_prefix                                                 \
  *_dout << "librbd::managed_lock::ReleaseRequest: " << this << " " \
         << __func__ << ": "
...
template <typename I>
void
ReleaseRequest<I>::handle_unlock(int r)
{
  CephContext* cct = reinterpret_cast<CephContext*>(m_ioctx.cct());
