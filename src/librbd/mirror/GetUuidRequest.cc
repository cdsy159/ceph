...
#undef dout_prefix
#define dout_prefix                                                       \
  *_dout << "librbd::mirror::GetUuidRequest: " << this << " " << __func__ \
         << ": "
...
template <typename I>
void
GetUuidRequest<I>::get_mirror_uuid()
{
...
template <typename I>
void
GetUuidRequest<I>::handle_get_mirror_uuid(int r)
{
