...
template <typename I>
void
Api<I>::execute_image_metadata_set(
    I* image_ctx,
...
template <typename I>
void
Api<I>::execute_image_metadata_remove(
    I* image_ctx,
    const std::string& key,
    Context* on_finish)
{
...
template <typename I>
void
Api<I>::get_image_timer_instance(
    CephContext* cct,
    SafeTimer** timer,
...
template <typename I>
bool
Api<I>::test_image_features(I* image_ctx, uint64_t features)
{
...
template <typename I>
void
Api<I>::update_aio_comp(io::AioCompletion* aio_comp, uint32_t request_count)
{
  aio_comp->set_request_count(request_count);
  start_in_flight_io(aio_comp);
}
...
template <typename I>
io::ReadResult::C_ImageReadRequest*
Api<I>::create_image_read_request(
    io::AioCompletion* aio_comp,
...
template <typename I>
io::C_AioRequest*
Api<I>::create_aio_request(io::AioCompletion* aio_comp)
{
...
template <typename I>
void
Api<I>::start_in_flight_io(io::AioCompletion* aio_comp)
{
