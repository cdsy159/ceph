...
#undef dout_prefix
#define dout_prefix                                                           \
  *_dout << "librbd::plugin::WriteLogImageCache: " << this << " " << __func__ \
         << ": "
...
template <typename I>
void
WriteLogImageCache<I>::HookPoints::acquired_exclusive_lock(Context* on_finish)
{
...
template <typename I>
void
WriteLogImageCache<I>::HookPoints::prerelease_exclusive_lock(Context* on_finish)
{
...
template <typename I>
void
WriteLogImageCache<I>::HookPoints::discard(Context* on_finish)
{
