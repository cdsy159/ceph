...
public:
  ...
  auto&
  get_module_finisher(const std::string& name)
  {
    return modules.at(name)->finisher;
  }

  bool
  is_pending(std::string_view name) const
  {
  ...
  bool
  module_exists(const std::string& name) const
  {
