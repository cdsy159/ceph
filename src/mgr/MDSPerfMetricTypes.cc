...
std::ostream&
operator<<(std::ostream& os, const MDSPerfMetricSubKeyDescriptor& d)
{
  switch (d.type) {
...
void
MDSPerformanceCounterDescriptor::pack_counter(
...
void
MDSPerformanceCounterDescriptor::unpack_counter(
...
std::ostream&
operator<<(std::ostream& os, const MDSPerformanceCounterDescriptor& d)
{
  switch (d.type) {
  case MDSPerformanceCounterType::CAP_HIT_METRIC:
    os << "cap_hit_metric";
...
std::ostream&
operator<<(std::ostream& os, const MDSPerfMetricLimit& limit)
{
...
void
MDSPerfMetricQuery::pack_counters(
...
std::ostream&
operator<<(std::ostream& os, const MDSPerfMetricQuery& query)
{
  return os << "[key=" << query.key_descriptor
            << ", counter=" << query.performance_counter_descriptors << "]";
}
