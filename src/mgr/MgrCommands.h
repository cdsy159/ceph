...
COMMAND(
    "pg dump "
    "name=dumpcontents,type=CephChoices,strings=all|summary|sum|delta|pools|"
    "osds|pgs|pgs_brief,n=N,req=false",
    "show human-readable versions of pg map (only 'all' valid with plain)",
    "pg",
    "r")
COMMAND(
    "pg dump_json "
    "name=dumpcontents,type=CephChoices,strings=all|summary|sum|pools|osds|pgs,"
    "n=N,req=false",
...
COMMAND(
    "pg dump_stuck "
    "name=stuckops,type=CephChoices,strings=inactive|unclean|stale|undersized|"
    "degraded,n=N,req=false "
...
COMMAND(
    "pg debug "
    "name=debugop,type=CephChoices,strings=unfound_objects_exist|degraded_pgs_"
    "exist",
...
COMMAND(
    "pg deep-scrub name=pgid,type=CephPgid",
...
COMMAND(
    "pg force-recovery name=pgid,type=CephPgid,n=N",
    "force recovery of <pgid> first",
    "pg",
    "rw")
COMMAND(
    "pg force-backfill name=pgid,type=CephPgid,n=N",
    "force backfill of <pgid> first",
    "pg",
    "rw")
COMMAND(
    "pg cancel-force-recovery name=pgid,type=CephPgid,n=N",
    "restore normal recovery priority of <pgid>",
    "pg",
    "rw")
COMMAND(
    "pg cancel-force-backfill name=pgid,type=CephPgid,n=N",
...
COMMAND(
    ...
    "reweight OSDs by PG distribution [overload-percentage-for-consideration, "
    "default 120]",
    "osd",
    "rw")
COMMAND(
...
COMMAND(
    "osd safe-to-destroy name=ids,type=CephString,n=N",
    "check whether osd(s) can be safely destroyed without reducing data "
    "durability",
    "osd",
    "r")
COMMAND(
    "osd ok-to-stop name=ids,type=CephString,n=N "
...
COMMAND(
    "device info name=devid,type=CephString",
    "Show information about a device",
    "mgr",
    "r")
COMMAND(
    "device ls-by-daemon name=who,type=CephString",
    "Show devices associated with a daemon",
    "mgr",
    "r")
COMMAND(
    "device ls-by-host name=host,type=CephString",
    "Show devices on a host",
    "mgr",
    "r")
COMMAND(
    "device set-life-expectancy name=devid,type=CephString "
    ...
    "rw")
COMMAND(
    "device rm-life-expectancy name=devid,type=CephString",
