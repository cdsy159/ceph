...
class HealthMonitor : public PaxosService {
  ...
  std::map<std::pair<std::string, std::string>, ceph::coarse_mono_clock::time_point>
      pending_location_netsplits;
