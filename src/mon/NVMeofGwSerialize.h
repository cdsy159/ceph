...
inline std::ostream&
operator<<(std::ostream& os, const gw_exported_states_per_group_t value)
{
  switch (value) {
...
inline std::ostream&
operator<<(std::ostream& os, const gw_states_per_group_t value)
{
  switch (value) {
...
inline std::ostream&
operator<<(std::ostream& os, const gw_availability_t value)
{
  switch (value) {
...
inline std::ostream&
operator<<(std::ostream& os, const gw_admin_state_t value)
{
  switch (value) {
...
inline std::ostream&
operator<<(std::ostream& os, const SmState value)
{
  os << "SM_STATE [ ";
...
inline std::ostream&
operator<<(std::ostream& os, const BeaconNamespace value)
{
...
inline std::ostream&
operator<<(std::ostream& os, const BeaconListener value)
{
  os << "BeaconListener( addrfam:" << value.address_family
     << ", addr:" << value.address << ", svcid:" << value.svcid << " )";
  return os;
}

inline std::ostream&
operator<<(std::ostream& os, const BeaconSubsystem value)
{
  os << "BeaconSubsystem( nqn:" << value.nqn << " descr "
     << (uint32_t)value.change_descriptor << ", listeners [ ";
  for (const auto& list : value.listeners)
    os << list << " ";
  os << "] namespaces [ ";
  for (const auto& ns : value.namespaces)
    os << ns << " ";
  os << "] )";
  return os;
}
...
inline std::ostream&
operator<<(std::ostream& os, const NqnState value)
{
...
inline std::ostream&
operator<<(std::ostream& os, const NvmeGwClientState value)
{
  os << "NvmeGwState { group id: " << value.group_id << " gw_map_epoch "
     << value.gw_map_epoch << " availablilty " << value.availability
     << " sequence " << value.last_beacon_seq_number << " sequence-ooo "
     << value.last_beacon_seq_ooo << " map_features " << value.map_features
     << " GwSubsystems: [ ";
...
inline std::ostream&
operator<<(std::ostream& os, const NvmeGroupKey value)
{
...
inline std::ostream&
operator<<(std::ostream& os, const NvmeGwMonClientStates value)
{
  os << "NvmeGwMap ";
...
inline std::ostream&
operator<<(std::ostream& os, const NvmeNonceVector value)
{
...
inline std::ostream&
operator<<(std::ostream& os, const NvmeAnaNonceMap value)
{
  if (value.size()) {
    os << "\n" << MODULE_PREFFIX;
  }
...
print_gw_created_t(
    std::ostream& os,
    const NvmeGwMonState value,
    size_t num_ana_groups)
{
  os << "==Internal map ==NvmeGwCreated { ana_group_id " << value.ana_grp_id
     << " osd_epochs: ";
  ...
  os << "]\n"
     ...
     << " admin state " << value.gw_admin_state << " full-startup "
     << value.performed_full_startup << " ]";

  return os;
}

inline std::ostream&
operator<<(std::ostream& os, const NvmeGwMonState value)
{
...
inline std::ostream&
operator<<(std::ostream& os, const NvmeGwMonStates value)
{
  if (value.size())
    os << "\n" << MODULE_PREFFIX;
  ;
...
inline std::ostream&
operator<<(std::ostream& os, const LocationStates value)
{
  if (value.size())
    os << "\n" << MODULE_PREFFIX;
  ;
...
inline std::ostream&
operator<<(std::ostream& os, const NVMeofGwMap value)
{
  os << "\n"
     << MODULE_PREFFIX << "== NVMeofGwMap [ Created_gws: epoch " << value.epoch
     << " features " << value.published_features;
...
inline void encode_beacon_change_descriptors(
    const BeaconSubsystems& sub,
    ceph::bufferlist& bl);
inline void decode_beacon_change_descriptors(
    BeaconSubsystems& subs,
    ceph::buffer::list::const_iterator& bl);

inline void
encode(const ana_state_t& st, ceph::bufferlist& bl)
{
  ENCODE_START(1, 1, bl);
...
inline void
decode(ana_state_t& st, ceph::buffer::list::const_iterator& bl)
{
  uint32_t n;
  DECODE_START(1, bl);
  decode(n, bl);
...
inline void
encode(const GwSubsystems& subsystems, ceph::bufferlist& bl, uint64_t features)
{
  uint8_t version = 1;
  ...
  for (const auto& sub : subsystems) {
    ...
    if (version == 1) {
      dout(20) << "encode ana_state vector version1 = " << (int)version
               << dendl;
      ...
      dout(20) << "encode ana_state vector version2 = " << (int)version
               << dendl;
...
inline void
decode(GwSubsystems& subsystems, ceph::bufferlist::const_iterator& bl)
{
...
inline void
encode(const NvmeGwClientState& state, ceph::bufferlist& bl, uint64_t features)
{
...
inline void
decode(NvmeGwClientState& state, ceph::bufferlist::const_iterator& bl)
{
  DECODE_START(2, bl);
...
inline void
encode(const NvmeGwTimerState& state, ceph::bufferlist& bl, uint64_t features)
{
  uint8_t version = 1;
  if (HAVE_FEATURE(features, NVMEOFHA)) {
    version = 2;
...
inline void
decode(NvmeGwTimerState& state, ceph::bufferlist::const_iterator& bl)
{
  DECODE_START(2, bl);
...
inline void
encode(const NvmeAnaNonceMap& nonce_map, ceph::bufferlist& bl, uint64_t features)
{
  ENCODE_START(1, 1, bl);
  ...
  for (auto& ana_group_nonces : nonce_map) {
    ...
    for (auto& nonce : ana_group_nonces.second)
      encode(nonce, bl);
  }
  ENCODE_FINISH(bl);
}
...
inline void
decode(NvmeAnaNonceMap& nonce_map, ceph::buffer::list::const_iterator& bl)
{
...
inline void
encode(const NvmeGwMonStates& gws, ceph::bufferlist& bl, uint64_t features)
{
  uint8_t version = 1;
  if (HAVE_FEATURE(features, NVMEOFHA)) {
    version = 2;
...
inline void
decode(NvmeGwMonStates& gws, ceph::buffer::list::const_iterator& bl)
{
  gws.clear();
  ...
  for (uint32_t i = 0; i < num_created_gws; i++) {
    ...
    if (struct_v >= 2) {
      ...
      for (uint32_t i = 0; i < MAX_SUPPORTED_ANA_GROUPS; i++) {
        decode(sm_state, bl);
        dout(20) << "decode NvmeGwMonStates state: " << i << " " << sm_state
                 << dendl;
...
inline void
encode(const std::map<NvmeGroupKey, epoch_t>& gw_epoch, ceph::bufferlist& bl)
{
  ENCODE_START(1, 1, bl);
...
inline void
encode(const LocationState& locationstate, ceph::bufferlist& bl)
{
  encode(locationstate.failbacks_in_process, bl);
}

inline void
decode(LocationState& locationstate, ceph::buffer::list::const_iterator& bl)
{
...
inline void
encode_gws_beacon_diff_additions(
    const std::map<NvmeGroupKey, NvmeGwMonStates>& created_gws,
    ceph::bufferlist& bl,
    uint64_t features)
{
  ...
  for (auto& group_gws : created_gws) {
    ...
    for (auto& gw : gws) {
      ...
      dout(10) << "encode location " << gw.second.location << " admin state "
               << (int)gw.second.gw_admin_state << dendl;
...
inline void
decode_gws_beacon_diff_additions(
    ...
    ceph::buffer::list::const_iterator& bl)
{
  ...
  for (auto& group_gws : created_gws) {
    ...
    for (auto& gw : gws) {
      ...
      dout(20) << "decoded location " << gw.second.location << " admin state "
               << (int)gw.second.gw_admin_state << dendl;
...
inline void
encode(
    const NvmeGwMonClientStates& subsyst_gwmap,
    ceph::bufferlist& bl,
    uint64_t features)
{
  ENCODE_START(1, 1, bl);
...
inline void
decode(
    NvmeGwMonClientStates& subsyst_gwmap,
    ceph::buffer::list::const_iterator& bl)
{
  subsyst_gwmap.clear();
  uint32_t num_gws;
...
inline void
encode(const NvmeGwTimers& group_md, ceph::bufferlist& bl, uint64_t features)
{
  ENCODE_START(1, 1, bl);
...
inline void
decode(NvmeGwTimers& md, ceph::buffer::list::const_iterator& bl)
{
  uint32_t num_gws;
  DECODE_START(1, bl);
  decode(num_gws, bl);
...
inline void
encode(const BeaconNamespace& ns, ceph::bufferlist& bl)
{
  ENCODE_START(1, 1, bl);
...
inline void
decode(BeaconNamespace& ns, ceph::buffer::list::const_iterator& bl)
{
  DECODE_START(1, bl);
...
inline void
encode(const BeaconListener& ls, ceph::bufferlist& bl)
{
  ENCODE_START(1, 1, bl);
...
inline void
decode(BeaconListener& ls, ceph::buffer::list::const_iterator& bl)
{
  DECODE_START(1, bl);
...
inline void
encode(const BeaconSubsystem& sub, ceph::bufferlist& bl)
{
  uint8_t version = 1;

  ENCODE_START(version, version, bl);
  encode(sub.nqn, bl);
  dout(20) << "encode BeaconSubsystems " << sub.nqn << " version "
           << (int)version << dendl;
...
inline void
encode_beacon_change_descriptors(
    ...
    ceph::bufferlist& bl)
{
  ...
  for (auto& sub_it : subs) {
    ...
    dout(20) << "encode change_descriptor "
             << (uint32_t)sub_it.change_descriptor << dendl;
  }
  ENCODE_FINISH(bl);
}

inline void
decode_beacon_change_descriptors(
    BeaconSubsystems& subs,
    ceph::buffer::list::const_iterator& bl)
{
  DECODE_START(1, bl);
...
inline void
decode(BeaconSubsystem& sub, ceph::buffer::list::const_iterator& bl)
{
  DECODE_START(1, bl);
  decode(sub.nqn, bl);
