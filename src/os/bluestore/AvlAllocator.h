...
private:
  ...
  */
  ...
  void
  _range_size_tree_rm(range_seg_t& r)
  {
  ...
  void
  _range_size_tree_try_insert(range_seg_t& r)
  {
...
protected:
  ...
  _lowest_size_available()
  {
    ...
    return rs != range_size_tree.end() ? rs->length()
