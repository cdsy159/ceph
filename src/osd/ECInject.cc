...
/**
   ...
   */
std::string
clear_read_error(const ghobject_t& o, const int64_t type)
{
  std::lock_guard<ceph::recursive_mutex> l(lock);
  std::map<ghobject_t, std::pair<int64_t, int64_t>>* failures;
  ghobject_t os = o;
...
/**
   ...
   */
std::string
clear_write_error(const ghobject_t& o, const int64_t type)
{
  std::lock_guard<ceph::recursive_mutex> l(lock);
  std::map<ghobject_t, std::pair<int64_t, int64_t>>* failures;
  ghobject_t os = o;
...
/**
   ...
   */
std::string
clear_parity_read(const hobject_t& o)
{
  std::lock_guard<ceph::recursive_mutex> l(lock);
...
bool
test_read_error0(const ghobject_t& o)
{
  return test_error(o, &read_failures0);
}

bool
test_read_error1(const ghobject_t& o)
{
  return test_error(o, &read_failures1);
}

bool
test_write_error0(const hobject_t& o, const osd_reqid_t& reqid)
{
  std::lock_guard<ceph::recursive_mutex> l(lock);
...
bool
test_write_error1(const ghobject_t& o)
{
...
bool
test_write_error2(const hobject_t& o)
{
  return test_error(
      ghobject_t(o, ghobject_t::NO_GEN, shard_id_t::NO_SHARD), &write_failures2);
}

bool
test_write_error3(const hobject_t& o)
{
  return test_error(
      ghobject_t(o, ghobject_t::NO_GEN, shard_id_t::NO_SHARD), &write_failures3);
}
...
/**
   ...
   */
bool
test_parity_read(const hobject_t& o)
{
  std::lock_guard<ceph::recursive_mutex> l(lock);
