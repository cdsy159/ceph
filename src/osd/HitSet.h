...
public:
  ...
  public:
    ...
    public:
      ...
      virtual void
      dump_stream(std::ostream& o) const
      {}
  ...
  bool
  contains(const hobject_t& o) const
  {
  ...
  unsigned
  approx_unique_insert_count() const
  {
...
public:
  ...
  bool
  is_full() const override
  {
    return false;
  }

  void
  insert(const hobject_t& o) override
  {
  ...
  bool
  contains(const hobject_t& o) const override
  {
    return hits.count(o.get_hash());
  }

  unsigned
  insert_count() const override
  {
    return count;
  }

  unsigned
  approx_unique_insert_count() const override
  {
    return hits.size();
  }
  ...
  static std::list<ExplicitHashHitSet>
  generate_test_instances()
  {
...
public:
  ...
  static std::list<ExplicitObjectHitSet>
  generate_test_instances()
  {
...
public:
  ...
  public:
    ...
    Params(const Params& o) :
      fpp_micro(o.fpp_micro), target_size(o.target_size), seed(o.seed)
    {}
    ...
    void
    dump_stream(std::ostream& o) const override
    {
      o << "false_positive_probability: " << get_fpp()
