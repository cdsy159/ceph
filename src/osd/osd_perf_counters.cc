...
PerfCounters*
build_osd_logger(CephContext* cct)
{
  ...
  osd_plb.add_u64_counter(
      l_osd_op, "op", "Client operations", "ops",
  ...
  osd_plb.add_time_avg(
      ...
      "Latency of client operations (excluding queue time and wait for "
      "finished)");
  ...
  osd_plb.add_u64_counter(
      l_osd_op_r_outb, "op_r_out_bytes", "Client data read", NULL,
  ...
  osd_plb.add_time_avg(
      ...
      "Latency of read operations (excluding queue time and wait for "
      "finished)");
  ...
  osd_plb.add_time_avg(
      ...
      "Latency of write operations (excluding queue time and wait for "
      "finished)");
  osd_plb.add_u64_counter(
      l_osd_op_rw, "op_rw", "Client read-modify-write operations");
  osd_plb.add_u64_counter(
  ...
  osd_plb.add_u64_counter(
      l_osd_replica_read_redirect_missing, "replica_read_redirect_missing",
      "Count of replica reads redirected to primary due to missing object");
  osd_plb.add_u64_counter(
      l_osd_replica_read_redirect_conflict, "replica_read_redirect_conflict",
      "Count of replica reads redirected to primary due to unstable write");
  osd_plb.add_u64_counter(
      l_osd_replica_read_served, "replica_read_served",
      "Count of replica reads served");

  osd_plb.add_u64_counter(l_osd_sop, "subop", "Suboperations");
  osd_plb.add_u64_counter(
      l_osd_sop_inb, "subop_in_bytes", "Suboperations total size", NULL, 0,
      unit_t(UNIT_BYTES));
  ...
  osd_plb.add_u64_counter(
      l_osd_push_outb, "push_out_bytes", "Pushed size", NULL, 0,
      unit_t(UNIT_BYTES));

  osd_plb.add_u64_counter(
      l_osd_rop, "recovery_ops", "Started recovery operations", "rop",
      PerfCountersBuilder::PRIO_INTERESTING);

  osd_plb.add_u64_counter(
      l_osd_rbytes, "recovery_bytes", "recovery bytes", "rbt",
      PerfCountersBuilder::PRIO_INTERESTING);

  osd_plb.add_time_avg(
      l_osd_recovery_push_queue_lat, "l_osd_recovery_push_queue_latency",
  ...
  osd_plb.add_time_avg(
      l_osd_recovery_pull_queue_lat, "l_osd_recovery_pull_queue_latency",
      "MOSDPGPull queue latency");
  osd_plb.add_time_avg(
      l_osd_recovery_backfill_queue_lat,
      "l_osd_recovery_backfill_queue_latency", "MOSDPGBackfill queue latency");
  osd_plb.add_time_avg(
      l_osd_recovery_backfill_remove_queue_lat,
      "l_osd_recovery_backfill_remove_queue_latency",
      "MOSDPGBackfillDelete queue latency");
  osd_plb.add_time_avg(
      l_osd_recovery_scan_queue_lat, "l_osd_recovery_scan_queue_latency",
      "MOSDPGScan queue latency");

  osd_plb.add_time_avg(
      l_osd_recovery_queue_lat, "l_osd_recovery_queue_latency",
      "PGRecovery queue latency");
  osd_plb.add_time_avg(
      l_osd_recovery_context_queue_lat, "l_osd_recovery_context_queue_latency",
  ...
  osd_plb.add_u64(
      l_osd_missed_crc, "missed_crc", "Total number of crc cache misses");

  osd_plb.add_u64(
      l_osd_pg, "numpg", "Placement groups", "pgs",
  ...
  osd_plb.add_u64(
      ...
      PerfCountersBuilder::PRIO_USEFUL, unit_t(UNIT_BYTES));
  osd_plb.add_u64(
      l_osd_stat_bytes_avail, "stat_bytes_avail", "Available space", NULL, 0,
      unit_t(UNIT_BYTES));
  ...
  osd_plb.add_u64_counter(
      l_osd_object_ctx_cache_total, "object_ctx_cache_total",
  ...
  osd_plb.add_u64_counter_histogram(
      ...
      rsrv_hist_x_axis_config, rsrv_hist_y_axis_config,
      "Histogram of scrub replicas reservation duration");
  osd_plb.add_u64_counter(
      l_osd_watch_timeouts, "watch_timeouts",
      "Number of watches that timed out or were blocklisted", nullptr,
      PerfCountersBuilder::PRIO_USEFUL);

  // scrub I/O (no EC vs. replicated differentiation)
  osd_plb.add_u64_counter(
      l_osd_scrub_omapgetheader_cnt, "scrub_omapgetheader_cnt",
      "scrub omap get header calls count");
  osd_plb.add_u64_counter(
      l_osd_scrub_omapgetheader_bytes, "scrub_omapgetheader_bytes",
      "scrub omap get header bytes read");
  osd_plb.add_u64_counter(
      l_osd_scrub_omapget_cnt, "scrub_omapget_cnt",
      "scrub omap get calls count");
  osd_plb.add_u64_counter(
      l_osd_scrub_omapget_bytes, "scrub_omapget_bytes",
      "scrub omap get bytes read");
  // scrub I/O performed for replicated pools
  osd_plb.add_u64_counter(
      l_osd_scrub_rppool_getattr_cnt, "scrub_replicated_getattr_cnt",
      "scrub replicated pool getattr calls count");
  osd_plb.add_u64_counter(
      l_osd_scrub_rppool_stats_cnt, "scrub_replicated_stats_cnt",
      "scrub replicated pool stats calls count");
  osd_plb.add_u64_counter(
      l_osd_scrub_rppool_read_cnt, "scrub_replicated_read_cnt",
      "scrub replicated pool read calls count");
  osd_plb.add_u64_counter(
      l_osd_scrub_rppool_read_bytes, "scrub_replicated_read_bytes",
      "scrub replicated pool read bytes read");
  // scrub I/O performed for EC pools
  osd_plb.add_u64_counter(
      l_osd_scrub_ec_getattr_cnt, "scrub_ec_getattr_cnt",
      "scrub EC getattr calls count");
  osd_plb.add_u64_counter(
      l_osd_scrub_ec_stats_cnt, "scrub_ec_stats_cnt",
      "scrub EC stats calls count");
  osd_plb.add_u64_counter(
      l_osd_scrub_ec_read_cnt, "scrub_ec_read_cnt", "scrub EC read calls count");
  osd_plb.add_u64_counter(
      l_osd_scrub_ec_read_bytes, "scrub_ec_read_bytes",
      "scrub EC read bytes read");
  ...
  osd_plb.add_u64_counter(
      ...
      "num_scrubs_past_reservation_replicated", "replicated scrubs count");
  osd_plb.add_u64_counter(
      l_osd_scrub_rppool_successful, "successful_scrubs_replicated",
  ...
  osd_plb.add_time_avg(
      l_osd_scrub_rppool_failed_elapsed, "failed_scrubs_replicated_elapsed",
      "time to scrub failure replicated");
  osd_plb.add_u64_counter(
      l_osd_scrub_rppool_write_intersects, "scrub_replicated_io_intersects",
      "client write op intersects chunk range");
  osd_plb.add_u64_counter(
      l_osd_scrub_rppool_write_blocked, "scrub_replicated_io_blocked",
  ...
  osd_plb.add_u64_counter(
      l_osd_scrub_ec_write_intersects, "scrub_ec_io_intersects",
      "client write op intersects chunk range");
  osd_plb.add_u64_counter(
      l_osd_scrub_ec_write_blocked, "scrub_ec_io_blocked",
      "write op did not preempt the scrub");
...
PerfCounters*
build_recoverystate_perf(CephContext* cct)
{
  PerfCountersBuilder rs_perf(cct, "recoverystate_perf", rs_first, rs_last);

  rs_perf.add_time_avg(
      rs_initial_latency, "initial_latency", "Initial recovery state latency");
  rs_perf.add_time_avg(
      rs_started_latency, "started_latency", "Started recovery state latency");
  rs_perf.add_time_avg(
      rs_reset_latency, "reset_latency", "Reset recovery state latency");
  rs_perf.add_time_avg(
      rs_start_latency, "start_latency", "Start recovery state latency");
  rs_perf.add_time_avg(
      rs_primary_latency, "primary_latency", "Primary recovery state latency");
  rs_perf.add_time_avg(
      rs_peering_latency, "peering_latency", "Peering recovery state latency");
  rs_perf.add_time_avg(
      rs_backfilling_latency, "backfilling_latency",
  ...
  rs_perf.add_time_avg(
      rs_waitlocalbackfillreserved_latency, "waitlocalbackfillreserved_latency",
      "Wait local backfill reserved recovery state latency");
  rs_perf.add_time_avg(
      rs_notbackfilling_latency, "notbackfilling_latency",
      "Notbackfilling recovery state latency");
  rs_perf.add_time_avg(
      rs_repnotrecovering_latency, "repnotrecovering_latency",
      "Repnotrecovering recovery state latency");
  rs_perf.add_time_avg(
      rs_repwaitrecoveryreserved_latency, "repwaitrecoveryreserved_latency",
      "Rep wait recovery reserved recovery state latency");
  rs_perf.add_time_avg(
      rs_repwaitbackfillreserved_latency, "repwaitbackfillreserved_latency",
      "Rep wait backfill reserved recovery state latency");
  rs_perf.add_time_avg(
      rs_reprecovering_latency, "reprecovering_latency",
      "RepRecovering recovery state latency");
  rs_perf.add_time_avg(
      rs_activating_latency, "activating_latency",
      "Activating recovery state latency");
  rs_perf.add_time_avg(
      rs_waitlocalrecoveryreserved_latency, "waitlocalrecoveryreserved_latency",
  ...
  rs_perf.add_time_avg(
      rs_recovering_latency, "recovering_latency",
      "Recovering recovery state latency");
  rs_perf.add_time_avg(
      rs_recovered_latency, "recovered_latency",
      "Recovered recovery state latency");
  rs_perf.add_time_avg(
      rs_clean_latency, "clean_latency", "Clean recovery state latency");
  rs_perf.add_time_avg(
      rs_active_latency, "active_latency", "Active recovery state latency");
  rs_perf.add_time_avg(
      rs_replicaactive_latency, "replicaactive_latency",
      "Replicaactive recovery state latency");
  rs_perf.add_time_avg(
      rs_stray_latency, "stray_latency", "Stray recovery state latency");
  rs_perf.add_time_avg(
      rs_getinfo_latency, "getinfo_latency", "Getinfo recovery state latency");
  rs_perf.add_time_avg(
      rs_getlog_latency, "getlog_latency", "Getlog recovery state latency");
  rs_perf.add_time_avg(
      rs_waitactingchange_latency, "waitactingchange_latency",
      "Waitactingchange recovery state latency");
  rs_perf.add_time_avg(
      rs_incomplete_latency, "incomplete_latency",
      "Incomplete recovery state latency");
  rs_perf.add_time_avg(
      rs_down_latency, "down_latency", "Down recovery state latency");
  rs_perf.add_time_avg(
      rs_getmissing_latency, "getmissing_latency",
      "Getmissing recovery state latency");
  rs_perf.add_time_avg(
      rs_waitupthru_latency, "waitupthru_latency",
      "Waitupthru recovery state latency");
  rs_perf.add_time_avg(
      rs_notrecovering_latency, "notrecovering_latency",
      "Notrecovering recovery state latency");
  rs_perf.add_u64_counter(
      rs_stats_invalidated, "stats_invalidated",
      "Number of times pg stats received invalidations");

  return rs_perf.create_perf_counters();
}

PerfCounters*
build_scrub_labeled_perf(CephContext* cct, std::string label)
{
  ...
  scrub_perf.add_u64_counter(
      scrbcnt_preempted, "preemptions", "preemptions on scrubs");
  scrub_perf.add_u64_counter(
      scrbcnt_chunks_selected, "chunk_selected",
      "chunk selection during scrubs");
  scrub_perf.add_u64_counter(
      scrbcnt_chunks_busy, "chunk_busy", "chunk busy during scrubs");
  scrub_perf.add_u64_counter(
      scrbcnt_blocked, "locked_object", "waiting on locked object events");
