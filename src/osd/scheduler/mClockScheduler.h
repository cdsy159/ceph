...
class mClockScheduler : public OpScheduler {
  ...
  using mclock_queue_t = crimson::dmclock::
      PullPriorityQueue<scheduler_id_t, OpSchedulerItem, true, true, 2>;
  using priority_t = unsigned;
  using SubQueue =
      std::map<priority_t, std::list<OpSchedulerItem>, std::greater<priority_t>>;
  ...
  get_scheduler_id(const OpSchedulerItem& item)
  {
