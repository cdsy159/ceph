...
public:
  SQLInsertUser(void** db, std::string db_name, CephContext* cct) :
    SQLiteDB((sqlite3*)(*db), db_name, cct), sdb((sqlite3**)db)
  {}
...
public:
  ...
  SQLPutObject(sqlite3** sdbi, std::string db_name, CephContext* cct) :
    SQLiteDB(*sdbi, db_name, cct), sdb(sdbi)
  {}
...
class SQLDeleteStaleObjectData : public SQLiteDB,
                                 public DeleteStaleObjectDataOp {
private:
  sqlite3** sdb = NULL;
  sqlite3_stmt* stmt = NULL; // Prepared statement
