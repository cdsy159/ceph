...
public:
  RGWOp_BILog_Info() :
    bucket_ver(), master_ver(), syncstopped(false)
  {}
...
public:
  ...
  get_type() override
  {
    return RGW_OP_SYNC_MDLOG_NOTIFY;
  }
};
...
public:
  RGWOp_DATALog_List() :
    truncated(false), extra_info(false)
  {}
...
public:
  ...
  get_type() override
  {
    return RGW_OP_SYNC_DATALOG_NOTIFY;
  }
};
...
public:
  ...
  get_type() override
  {
    return RGW_OP_SYNC_DATALOG_NOTIFY2;
  }
};
