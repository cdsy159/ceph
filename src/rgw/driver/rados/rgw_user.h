...
void rgw_generate_secret_key(CephContext* cct, std::string& secret_key);

// generate a unique random access key id of PUBLIC_ID_LEN=20
int rgw_generate_access_key(
...
struct RGWUserAdminOpState {
  ...
  void
  set_access_key(const std::string& access_key)
  {
    if (access_key.empty())
      return;
  ...
  void
  set_secret_key(const std::string& secret_key)
  {
    if (secret_key.empty())
      return;
  ...
  void
  set_new_user_id(const rgw_user& id)
  {
    if (id.empty())
      return;
  ...
  void
  set_overwrite_new_user(bool b)
  {
    overwrite_new_user = b;
  }

  void
  set_user_email(const std::string& email)
  {
    user_email = email;
  ...
  void
  set_caps(const std::string& _caps)
  {
    if (_caps.empty())
      return;
  ...
  void
  set_temp_url_key(const std::string& key, int index)
  {
  ...
  void
  set_access_key_active(bool active)
  {
    access_key_active = active;
  }

  void
  set_suspension(__u8 is_suspended)
  {
  ...
  void
  set_account_root(__u8 is_account_root)
  {
  ...
  void
  set_exclusive(__u8 is_exclusive)
  {
    exclusive = is_exclusive;
  }

  void
  set_fetch_stats(__u8 is_fetch_stats)
  {
    fetch_stats = is_fetch_stats;
  }

  void
  set_sync_stats(__u8 is_sync_stats)
  {
  ...
  void
  set_bucket_quota(RGWQuotaInfo& quotas)
  {
  ...
  void
  set_user_quota(RGWQuotaInfo& quotas)
  {
  ...
  void
  set_bucket_ratelimit(RGWRateLimitInfo& ratelimit)
  {
  ...
  void
  set_user_ratelimit(RGWRateLimitInfo& ratelimit)
  {
  ...
  void
  set_mfa_ids(const std::set<std::string>& ids)
  {
    mfa_ids = ids;
  ...
  void
  set_default_placement(const rgw_placement_rule& _placement)
  {
  ...
  void
  set_placement_tags(const std::list<std::string>& _tags)
  {
  ...
  void
  set_existing_user(bool flag)
  {
    existing_user = flag;
  }

  void
  set_existing_key(bool flag)
  {
    existing_key = flag;
  }

  void
  set_existing_subuser(bool flag)
  {
    existing_subuser = flag;
  }

  void
  set_existing_email(bool flag)
  {
    existing_email = flag;
  }

  void
  set_purge_data(bool flag)
  {
    purge_data = flag;
  }

  void
  set_generate_subuser(bool flag)
  {
    gen_subuser = flag;
  }
  ...
  bool
  get_overwrite_new_user() const
  {
    return overwrite_new_user;
  }
...
public:
  ...
  struct PutParams {
    ...
    PutParams&
    set_old_info(RGWUserInfo* _info)
    {
      old_info = _info;
      return *this;
    }
  ...
  int get_info_by_email(
      const DoutPrefixProvider* dpp,
      const std::string& email,
      RGWUserInfo* info,
      optional_yield y,
      const GetParams& params = {});
  int get_info_by_swift(
      const DoutPrefixProvider* dpp,
...
auto create_user_metadata_handler(
