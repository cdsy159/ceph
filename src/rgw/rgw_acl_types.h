...
#define RGW_PERM_FULL_CONTROL \
  (RGW_PERM_READ | RGW_PERM_WRITE | RGW_PERM_READ_ACP | RGW_PERM_WRITE_ACP)
...
public:
  ACLGranteeType(ACLGranteeTypeEnum t = ACL_TYPE_UNKNOWN) :
    type(t)
  {}
