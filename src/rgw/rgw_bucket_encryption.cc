...
void
ApplyServerSideEncryptionByDefault::decode_xml(XMLObj* obj)
{
...
void
ApplyServerSideEncryptionByDefault::dump_xml(Formatter* f) const
{
...
void
ServerSideEncryptionConfiguration::decode_xml(XMLObj* obj)
{
...
void
ServerSideEncryptionConfiguration::dump_xml(Formatter* f) const
{
  encode_xml(
      "ApplyServerSideEncryptionByDefault", applyServerSideEncryptionByDefault,
      f);
...
void
RGWBucketEncryptionConfig::decode_xml(XMLObj* obj)
{
  rule_exist = RGWXMLDecoder::decode_xml("Rule", rule, obj);
}

void
RGWBucketEncryptionConfig::dump_xml(Formatter* f) const
{
  if (rule_exist) {
...
void
RGWBucketEncryptionConfig::dump(Formatter* f) const
{
