...
void encode_json_impl(
    const char* name,
    const BucketIndexType& t,
    ceph::Formatter* f);
void decode_json_obj(BucketIndexType& t, JSONObj* obj);

inline std::ostream&
operator<<(std::ostream& out, const BucketIndexType& t)
{
...
struct bucket_index_normal_layout {
  ...
  friend std::ostream&
  operator<<(std::ostream& out, const bucket_index_normal_layout& l)
  {
    out << "num_shards=" << l.num_shards
        << ", min_num_shards=" << l.min_num_shards
        << ", hash_type=" << to_string(l.hash_type);
    return out;
  }
};
...
struct bucket_index_layout {
  ...
  friend std::ostream&
  operator<<(std::ostream& out, const bucket_index_layout& l)
  {
...
inline bool
operator==(const bucket_index_layout& l, const bucket_index_layout& r)
{
...
struct bucket_index_layout_generation {
  ...
  friend std::ostream&
  operator<<(std::ostream& out, const bucket_index_layout_generation& g)
  {
    out << "gen=" << g.gen;
    return out;
  }
...
void encode_json_impl(
    const char* name,
    const BucketLogType& t,
    ceph::Formatter* f);
void decode_json_obj(BucketLogType& t, JSONObj* obj);

inline std::ostream&
operator<<(std::ostream& out, const BucketLogType& log_type)
{
  switch (log_type) {
...
struct bucket_log_layout {
  ...
  friend std::ostream&
  operator<<(std::ostream& out, const bucket_log_layout& l)
  {
...
struct bucket_log_layout_generation {
  ...
  friend std::ostream&
  operator<<(std::ostream& out, const bucket_log_layout_generation& g)
  {
...
inline bucket_log_layout_generation
log_layout_from_index(uint64_t gen, const bucket_index_layout_generation& index)
{
  return {gen, {BucketLogType::InIndex, {index.gen, index.layout.normal}}};
}

inline auto
matches_gen(uint64_t gen)
{
  return [gen](const bucket_log_layout_generation& l) { return l.gen == gen; };
}

inline bucket_index_layout_generation
log_to_index_layout(const bucket_log_layout_generation& log_layout)
{
...
struct BucketLayout {
  ...
  friend std::ostream&
  operator<<(std::ostream& out, const BucketLayout& l)
  {
    std::stringstream ss;
    if (l.target_index) {
      ss << *l.target_index;
    ...
    out << "resharding=" << to_string(l.resharding) << ", current_index=["
        << l.current_index << "], target_index=[" << ss.str()
        << "], logs.size()=" << l.logs.size()
...
inline uint32_t
num_shards(const bucket_index_normal_layout& index)
{
...
inline uint32_t
num_shards(const bucket_index_layout& index)
{
...
inline uint32_t
num_shards(const bucket_index_layout_generation& index)
{
  return num_shards(index.layout);
}

inline uint32_t
current_num_shards(const BucketLayout& layout)
{
  return num_shards(layout.current_index);
}

inline uint32_t
current_min_layout_shards(const BucketLayout& layout)
{
  return layout.current_index.layout.normal.min_num_shards;
}

inline bool
is_layout_indexless(const bucket_index_layout_generation& layout)
{
  return layout.layout.type == BucketIndexType::Indexless;
}

inline bool
is_layout_reshardable(const bucket_index_layout_generation& layout)
{
  return layout.layout.type == BucketIndexType::Normal;
}

inline bool
is_layout_reshardable(const BucketLayout& layout)
{
  return is_layout_reshardable(layout.current_index);
}

inline std::string_view
current_layout_desc(const BucketLayout& layout)
{
