...
public:
  ...
  SyncScheduler(CephContext* cct, GetClientCounters&& counters, Args&&... args);
  ~SyncScheduler();
...
private:
  ...
  using Queue =
      crimson::dmclock::PushPriorityQueue<client_id, SyncRequest, IsDelayed>;
