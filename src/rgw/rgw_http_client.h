...
protected:
  ...
  virtual int
  receive_header(void* ptr, size_t len)
  {
    return 0;
  }

  virtual int
  receive_data(void* ptr, size_t len, bool* pause)
  {
    return 0;
  }

  virtual int
  send_data(void* ptr, size_t len, bool* pause = nullptr)
  {
    return 0;
  }
  ...
  static size_t
  receive_http_header(void* ptr, size_t size, size_t nmemb, void* _info);

  static size_t
  receive_http_data(void* ptr, size_t size, size_t nmemb, void* _info);
...
public:
  ...
  void
  append_header(const std::string& name, const std::string& val)
  {
    headers.push_back(std::pair<std::string, std::string>(name, val));
  }

  void
  set_send_length(size_t len)
  {
    send_len = len;
    has_send_len = true;
  }
  ...
  void
  set_http_status(long _http_status)
  {
    http_status = _http_status;
  }

  void
  set_verify_ssl(bool flag)
  {
    verify_ssl = flag;
  }
  ...
  void
  set_req_connect_timeout(long connect_timeout)
  {
  ...
  void
  set_method(const std::string& _method)
  {
    method = _method;
  }

  void
  set_io_user_info(void* _user_info) override
  {
  ...
  void
  set_ca_path(const std::string& _ca_path)
  {
    ca_path = _ca_path;
  }

  void
  set_client_cert(const std::string& _client_cert)
  {
    client_cert = _client_cert;
  }

  void
  set_client_key(const std::string& _client_key)
  {
...
public:
  ...
  std::map<header_name_t, header_value_t, ltstr_nocase>
  get_headers() const
  {
  ...
  get_header_value(const header_name_t& name) const
  {
...
public:
  ...
  void
  set_post_data(const std::string& _post_data)
  {
...
protected:
  ...
  int
  receive_data(void* ptr, size_t len, bool* pause) override
  {
