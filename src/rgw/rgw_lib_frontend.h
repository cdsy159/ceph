...
public:
  ...
  void
  enqueue_req(RGWLibRequest* req)
  {

    lsubdout(g_ceph_context, rgw, 10)
        << __func__ << " enqueue request req=" << std::hex << req << std::dec
        << dendl;
