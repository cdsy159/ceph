...
void
DefaultRetention::decode_json(JSONObj* obj)
{
...
void
DefaultRetention::decode_xml(XMLObj* obj)
{
...
void
DefaultRetention::dump(Formatter* f) const
{
...
void
DefaultRetention::dump_xml(Formatter* f) const
{
...
void
RGWObjectLock::decode_json(JSONObj* obj)
{
...
void
RGWObjectLock::decode_xml(XMLObj* obj)
{
  string enabled_str;
...
void
RGWObjectLock::dump_xml(Formatter* f) const
{
  if (enabled) {
...
void
RGWObjectLock::dump(Formatter* f) const
{
  if (enabled) {
...
ceph::real_time
RGWObjectLock::get_lock_until_date(const ceph::real_time& mtime) const
{
  if (!rule_exist) {
...
list<RGWObjectLock>
RGWObjectLock::generate_test_instances()
{
...
void
RGWObjectRetention::decode_xml(XMLObj* obj)
{
  RGWXMLDecoder::decode_xml("Mode", mode, obj, true);
  if (mode.compare("GOVERNANCE") != 0 && mode.compare("COMPLIANCE") != 0) {
...
void
RGWObjectRetention::dump_xml(Formatter* f) const
{
  encode_xml("Mode", mode, f);
...
void
RGWObjectLegalHold::decode_xml(XMLObj* obj)
{
...
void
RGWObjectLegalHold::dump_xml(Formatter* f) const
{
  encode_xml("Status", status, f);
}

bool
RGWObjectLegalHold::is_enabled() const
{
