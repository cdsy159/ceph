...
struct rgw_placement_rule {
  ...
  void
  inherit_from(const rgw_placement_rule& r)
  {
    if (name.empty()) {
      name = r.name;
    }
  ...
  void
  init(const std::string& n, const std::string& c)
  {
    name = n;
    storage_class = c;
  }
  ...
  get_canonical_storage_class(const std::string& storage_class)
  {
    if (storage_class.empty()) {
  ...
  int
  compare(const rgw_placement_rule& r) const
  {
  ...
  bool
  operator==(const rgw_placement_rule& r) const
  {
  ...
  static std::list<rgw_placement_rule>
