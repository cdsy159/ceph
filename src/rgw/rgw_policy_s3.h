...
public:
  ...
  bool match_policy_vars(
      std::map<std::string, bool, ltstr_nocase>& policy_vars,
      std::string& err_msg);
};
...
public:
  ...
  RGWPolicy() :
    expires(0), min_length(0), max_length(LLONG_MAX)
  {}
  ...
  void
  set_var_checked(const std::string& var)
  {
  ...
  void
  add_simple_check(const std::string& var, const std::string& value)
  {
