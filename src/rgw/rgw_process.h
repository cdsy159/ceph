...
protected:
  ...
  struct RGWWQ : public DoutPrefixProvider,
                 public ThreadPool::WorkQueue<RGWRequest> {
    RGWProcess* process;
    ...
    void
    _dequeue(RGWRequest* req) override
    {
      ceph_abort();
    }
    ...
    {
      return out << "rgw request work queue: ";
    }
...
extern int rgw_process_authenticated(
