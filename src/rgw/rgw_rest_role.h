...
protected:
  ...
  RGWRestRole(uint64_t action, uint32_t perm) :
...
public:
  RGWGetRole() :
    RGWRestRole(rgw::IAM::iamGetRole, RGW_CAP_READ)
  {}
...
public:
  ...
  get_type() override
  {
    return RGW_OP_MODIFY_ROLE_TRUST_POLICY;
  }
};
...
public:
  RGWListRoles() :
    RGWRestRole(rgw::IAM::iamListRoles, RGW_CAP_READ)
  {}
...
public:
  RGWGetRolePolicy() :
    RGWRestRole(rgw::IAM::iamGetRolePolicy, RGW_CAP_READ)
  {}
...
public:
  RGWListRolePolicies() :
    RGWRestRole(rgw::IAM::iamListRolePolicies, RGW_CAP_READ)
  {}
...
public:
  explicit RGWTagRole(const bufferlist& bl_post_body) :
    RGWRestRole(rgw::IAM::iamTagRole, RGW_CAP_WRITE), bl_post_body(bl_post_body)
  {}
...
public:
  RGWListRoleTags() :
    RGWRestRole(rgw::IAM::iamListRoleTags, RGW_CAP_READ)
  {}
