...
struct RGWObjState {
  ...
  bool
  get_attr(std::string name, bufferlist& dest)
  {
...
public:
  ...
  get_tenant() override
  {
    return info.user_id.tenant;
  }

  virtual void
  set_tenant(std::string& _t) override
  {
    info.user_id.tenant = _t;
  }

  virtual const std::string&
  get_ns() override
  {
    return info.user_id.ns;
  }
...
public:
  ...
  StoreBucket(const RGWBucketInfo& i) :
    info(i)
  {}
  ...
  {
    return info.bucket.tenant;
  }

  virtual const std::string&
  get_marker() const override
  {
    return info.bucket.marker;
  }
  ...
  versioned() override
  {
    return info.versioned();
  }

  virtual bool
  versioning_enabled() override
  {
    return info.versioning_enabled();
  }
...
public:
  ...
  {
    state.is_atomic = atomic;
  }

  virtual bool
  is_atomic() override
  {
    return state.is_atomic;
  }
  ...
  empty() const override
  {
    return state.obj.empty();
  }

  virtual const std::string&
  get_name() const override
  {
    return state.obj.key.name;
  }

  virtual Attrs&
  get_attrs(void) override
  {
    return state.attrset;
  }
  ...
  {
    return state.accounted_size;
  }

  virtual void
  set_accounted_size(uint64_t size) override
  {
    state.accounted_size = size;
  }
  ...
  {
    return state.zone_short_id;
  }

  virtual void
  set_short_zone_id(uint32_t id) override
  {
    state.zone_short_id = id;
  }
  ...
  {
    return state.obj.index_hash_source;
  }

  virtual void
  set_hash_source(std::string s) override
  {
    state.obj.index_hash_source = s;
  }

  virtual std::string
  get_oid(void) const override
  {
    return state.obj.key.get_oid();
  }

  virtual bool
  get_in_extra_data(void) override
  {
    return state.obj.is_in_extra_data();
  }
  ...
  {
    state.obj.key.set_instance(i);
  }

  virtual const std::string&
  get_instance() const override
  {
    return state.obj.key.instance;
  }

  virtual bool
  have_instance(void) override
  {
    return state.obj.key.have_instance();
  }

  virtual void
  clear_instance() override
  {
    state.obj.key.instance.clear();
  }
  ...
  void
  set_trace(jspan_context&& _trace_ctx) override
  {
    trace_ctx = std::move(_trace_ctx);
  }
...
public:
  ...
  StoreRestoreSerializer(std::string _oid) :
    oid(_oid)
  {}
...
public:
  const std::string&
  luarocks_path() const override
  {
    return _luarocks_path;
  }

  void
  set_luarocks_path(const std::string& path) override
  {
    _luarocks_path = path;
  }

  void
  set_lua_background(rgw::lua::Background* background) override
  {
