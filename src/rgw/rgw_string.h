...
static inline int
stringcasecmp(const std::string& s1, const std::string& s2)
{
  return strcasecmp(s1.c_str(), s2.c_str());
}

static inline int
stringcasecmp(const std::string& s1, const char* s2)
{
  return strcasecmp(s1.c_str(), s2);
}

static inline int
stringcasecmp(const std::string& s1, int ofs, int size, const std::string& s2)
{
  return strncasecmp(s1.c_str() + ofs, s2.c_str(), size);
}

static inline int
stringtoll(const std::string& s, int64_t* val)
{
  char* end;
...
static inline int
stringtoull(const std::string& s, uint64_t* val)
{
  char* end;
...
static inline int
stringtol(const std::string& s, int32_t* val)
{
  char* end;
...
static inline int
stringtoul(const std::string& s, uint32_t* val)
{
  char* end;
...
template <typename... Args>
void
append_to(std::string& s, const std::string_view& v, const Args&... args)
{
...
static inline void
join_next(std::string& s, const std::string_view& d)
{}
...
static inline void
join(std::string& s, const std::string_view& d)
{}
...
template <typename... Args>
std::string
string_cat_reserve(const Args&... args)
{
...
template <typename... Args>
std::string
string_join_reserve(const std::string_view& delim, const Args&... args)
{
...
template <typename... Args>
std::string
string_join_reserve(char delim, const Args&... args)
{
