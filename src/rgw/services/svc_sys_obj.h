...
public:
  ...
  public:
    ...
    struct ROp {
      ...
      ROp&
      set_last_mod(ceph::real_time* _lastmod)
      {
        lastmod = _lastmod;
        return *this;
      }
      ...
      ROp&
      set_refresh_version(boost::optional<obj_version>& rf)
      {
        refresh_version = rf;
        return *this;
      }
      ...
      ROp&
      set_cache_info(rgw_cache_entry_info* ci)
      {
        cache_info = ci;
        return *this;
      }
      ...
      int
      read(const DoutPrefixProvider* dpp, bufferlist* pbl, optional_yield y)
      {
    ...
    struct WOp {
      ...
      WOp&
      set_pmtime(ceph::real_time* _pmtime)
      {
        pmtime = _pmtime;
        return *this;
      }
      ...
      WOp&
      set_exclusive(bool _exclusive = true)
      {
      ...
      int write_data(
          const DoutPrefixProvider* dpp,
          bufferlist& bl,
          optional_yield y); /* write data only */
      int write_attrs(
          const DoutPrefixProvider* dpp,
    ...
    struct OmapOp {
      ...
      OmapOp&
      set_must_exist(bool _must_exist = true)
      {
...
protected:
  ...
  void
  init(librados::Rados* rados_, RGWSI_SysObj_Core* _core_svc)
  {
    rados = rados_;
    core_svc = _core_svc;
  }
