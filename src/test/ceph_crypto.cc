...
TEST(Digest, SHA256)
{
  ...
  }
  {
    ...
    sha256 = digest(bl);
    EXPECT_EQ(
        "e85f57f8bb018bd4f7beed6f27488cef22b13d5e06e8b8a27cac8b087c2a549e",
        sha256.to_str());
  }
  {
    bufferptr p(65536);
...
TEST(Digest, SHA512)
{
  ...
  }
  {
    ...
    sha512_digest_t sha512 = digest(bl);
    EXPECT_EQ(
        "3615f80c9d293ed7402687f94b22d58e529b8cc7916f8fac7fddf7fbd5af4cf777d3d7"
        "95a7a00a16bf7e7f3fb9561ee9baae480da9fe7a18769e71886b03f315",
        sha512.to_str());
  }
  {
    bufferlist bl, bl2;
    ...
    sha512_digest_t sha512 = digest(bl);
    EXPECT_EQ(
        "c1527cd893c124773d811911970c8fe6e857d6df5dc9226bd8a160614c0cd963a4ddea"
        "2b94bb7d36021ef9d865d5cea294a82dd49a0bb269f51f6e7a57f79421",
        sha512.to_str());
    bl2.append("  How are you today?");
    bl.claim_append(bl2);
    sha512 = digest(bl);
    EXPECT_EQ(
        "7d50e299496754f9a0d158e018d4b733f2ef51c487b43b50719ffdabe3c3da5a347029"
        "741056887b4ffa2ddd0aa9e0dd358b8ed9da9a4f3455f44896fc8e5395",
        sha512.to_str());
  }
  {
    bufferptr p(65536);
    ...
    sha512_digest_t sha512 = digest(bl);
    EXPECT_EQ(
        "73e4153936dab198397b74ee9efc26093dda721eaab2f8d92786891153b45b04265a16"
        "1b169c988edb0db2c53124607b6eaaa816559c5ce54f3dbc9fa6a7a4b2",
        sha512.to_str());
  }
}
