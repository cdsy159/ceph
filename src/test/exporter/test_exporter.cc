...
static std::vector<std::pair<std::string, std::string>> promethize_data = {
    ...
    {"bluefs.read_random_disk_bytes_db",
     "ceph_bluefs_read_random_disk_bytes_db"},
    {"bluefs.read_random_disk_bytes_slow",
     "ceph_bluefs_read_random_disk_bytes_slow"},
    {"bluefs.read_random_disk_bytes_wal",
    ...
    {"bluestore.omap_seek_to_first_lat_count",
     "ceph_bluestore_omap_seek_to_first_lat_count"},
    {"bluestore.omap_seek_to_first_lat_sum",
     "ceph_bluestore_omap_seek_to_first_lat_sum"},
    {"bluestore.omap_upper_bound_lat_count",
     "ceph_bluestore_omap_upper_bound_lat_count"},
    {"bluestore.omap_upper_bound_lat_sum",
    ...
    {"bluestore.read_onode_meta_lat_count",
     "ceph_bluestore_read_onode_meta_lat_count"},
    {"bluestore.read_onode_meta_lat_sum",
     "ceph_bluestore_read_onode_meta_lat_sum"},
    {"bluestore.read_wait_aio_lat_count",
    ...
    {"bluestore.state_aio_wait_lat_count",
     "ceph_bluestore_state_aio_wait_lat_count"},
    {"bluestore.state_aio_wait_lat_sum",
     "ceph_bluestore_state_aio_wait_lat_sum"},
    {"bluestore.state_deferred_aio_wait_lat_count",
     "ceph_bluestore_state_deferred_aio_wait_lat_count"},
    {"bluestore.state_deferred_aio_wait_lat_sum",
     "ceph_bluestore_state_deferred_aio_wait_lat_sum"},
    {"bluestore.state_deferred_cleanup_lat_count",
     "ceph_bluestore_state_deferred_cleanup_lat_count"},
    {"bluestore.state_deferred_cleanup_lat_sum",
     "ceph_bluestore_state_deferred_cleanup_lat_sum"},
    {"bluestore.state_deferred_queued_lat_count",
     "ceph_bluestore_state_deferred_queued_lat_count"},
    {"bluestore.state_deferred_queued_lat_sum",
    ...
    {"bluestore.txc_throttle_lat_count",
    ...
    {"cluster_by_class_total_used_raw_bytes",
    ...
    {"mds_server.cap_acquisition_throttle",
    ...
    {"objecter-0x5591781656c0.op_active",
     "ceph_objecter_0x5591781656c0_op_active"},
    ...
    {"objecter-0x559178165930.op_active",
     "ceph_objecter_0x559178165930_op_active"},
    ...
    {"prioritycache:full.committed_bytes",
    ...
    {"prioritycache:full.reserved_bytes",
     "ceph_prioritycache:full_reserved_bytes"},
    {"prioritycache:inc.committed_bytes",
    ...
    {"prioritycache:inc.reserved_bytes",
     "ceph_prioritycache:inc_reserved_bytes"},
    {"prioritycache:kv.committed_bytes",
    ...
    {"rocksdb.submit_sync_latency_count",
     "ceph_rocksdb_submit_sync_latency_count"},
    {"rocksdb.submit_sync_latency_sum",
...
TEST(Exporter, check_labels_and_metric_name)
{
  ...
  counters_data.emplace_back(
      "ceph-client.rgw.foo.ceph-node-00.hrgsea.2.94739968030880",
      "ceph_rgw_get");
  ...
  for (; counter_data_itr != counters_data.end() &&
         labels_vec_itr != labels_vec.end();
    ...
    DaemonMetricCollector& collector)
{
  ...
  collector.dump_asok_metrics(
      true, 5, false, expectedCounterDump, expectedCounterSchema, false);
}
...
TEST(Exporter, UpdateSockets)
{
  ...
  std::ofstream(
      mock_dir +
      "/ceph-client.rgw.rgwfoo.chatest-node-00.yqaoen.2.94354846193952.asok")
      .close();
  std::ofstream(mock_dir + "/ceph-client.ceph-exporter.chatest-node-00.asok")
      .close();
  ...
  ASSERT_TRUE(
      collector.clients.find("ceph-mon.chatest-node-00") !=
      collector.clients.end());
  ASSERT_TRUE(
      collector.clients.find(
          "ceph-client.rgw.rgwfoo.chatest-node-00.yqaoen.2.94354846193952") !=
      collector.clients.end());
...
TEST(Exporter, HealthMetrics)
{
  ...
  auto verifyMetricValue = [&](const std::string& metricValue,
                               bool shouldInitializeSocket) {
    collector.metrics = "";
    ...
    collector.dump_asok_metrics(
        true, 5, true, expectedCounterDump, expectedCounterSchema, false);
    ...
    std::string pattern = metricName + R"(\{[^}]*ceph_daemon=\")" + daemon +
                          R"(\"[^}]*\}\s+)" + metricValue + R"(\b)";
