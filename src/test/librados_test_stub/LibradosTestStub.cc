...
MockTestMemIoCtxImpl&
get_mock_io_ctx(IoCtx& ioctx)
{
...
void
set_cluster(TestClusterRef cluster_ref)
{
  cluster() = cluster_ref;
}
...
extern "C" int
rados_aio_get_return_value(rados_completion_t c)
{
...
extern "C" int
rados_conf_parse_env(rados_t cluster, const char* var)
{
  librados::TestRadosClient* client =
      reinterpret_cast<librados::TestRadosClient*>(cluster);
...
extern "C" int
rados_conf_read_file(rados_t cluster, const char* path)
{
  librados::TestRadosClient* client =
      reinterpret_cast<librados::TestRadosClient*>(cluster);
  auto& conf = client->cct()->_conf;
...
extern "C" int
rados_create(rados_t* cluster, const char* const id)
{
...
extern "C" int
rados_create_with_context(rados_t* cluster, rados_config_t cct_)
{
...
extern "C" int
rados_ioctx_create(rados_t cluster, const char* pool_name, rados_ioctx_t* ioctx)
{
  librados::TestRadosClient* client =
      reinterpret_cast<librados::TestRadosClient*>(cluster);
  ...
  *ioctx =
      reinterpret_cast<rados_ioctx_t>(client->create_ioctx(pool_id, pool_name));
  return 0;
}

extern "C" int
rados_ioctx_create2(rados_t cluster, int64_t pool_id, rados_ioctx_t* ioctx)
{
  librados::TestRadosClient* client =
      reinterpret_cast<librados::TestRadosClient*>(cluster);
...
extern "C" void
rados_ioctx_destroy(rados_ioctx_t io)
{
...
extern "C" int
rados_nobjects_list_open(rados_ioctx_t io, rados_list_ctx_t* ctx)
{
...
extern "C" void
rados_nobjects_list_close(rados_list_ctx_t ctx)
{
  std::list<librados::TestRadosClient::Object>* list =
      reinterpret_cast<std::list<librados::TestRadosClient::Object>*>(ctx);
  delete list;
...
extern "C" int
rados_pool_create(rados_t cluster, const char* pool_name)
{
  librados::TestRadosClient* client =
      reinterpret_cast<librados::TestRadosClient*>(cluster);
...
extern "C" void
rados_shutdown(rados_t cluster)
{
  librados::TestRadosClient* client =
      reinterpret_cast<librados::TestRadosClient*>(cluster);
  client->put();
...
extern "C" int
rados_wait_for_latest_osdmap(rados_t cluster)
{
  librados::TestRadosClient* client =
      reinterpret_cast<librados::TestRadosClient*>(cluster);
...
int
IoCtx::aio_flush_async(AioCompletion* c)
{
  TestIoCtxImpl* ctx = reinterpret_cast<TestIoCtxImpl*>(io_ctx_impl);
    ...
    bufferlist* pbl)
{
  ...
  TestObjectOperationImpl* ops =
      reinterpret_cast<TestObjectOperationImpl*>(op->impl);
  return ctx->aio_operate_read(
      oid, *ops, c->pc, flags, pbl, ctx->get_snap_read(), nullptr);
}
...
int
IoCtx::aio_remove(const std::string& oid, AioCompletion* c)
{
  TestIoCtxImpl* ctx = reinterpret_cast<TestIoCtxImpl*>(io_ctx_impl);
...
int
IoCtx::aio_remove(const std::string& oid, AioCompletion* c, int flags)
{
  TestIoCtxImpl* ctx = reinterpret_cast<TestIoCtxImpl*>(io_ctx_impl);
...
int
IoCtx::aio_unwatch(uint64_t handle, AioCompletion* c)
{
  TestIoCtxImpl* ctx = reinterpret_cast<TestIoCtxImpl*>(io_ctx_impl);
...
int
IoCtx::create(const std::string& oid, bool exclusive)
{
  TestIoCtxImpl* ctx = reinterpret_cast<TestIoCtxImpl*>(io_ctx_impl);
  return ctx->execute_operation(
      oid,
      std::bind(
          &TestIoCtxImpl::create, _1, _2, exclusive, ctx->get_snap_context()));
}

void
IoCtx::dup(const IoCtx& rhs)
{
  close();
    ...
    bufferlist& outbl)
{
  ...
  return ctx->execute_operation(
      oid, std::bind(
               &TestIoCtxImpl::exec, _1, _2,
               librados_test_stub::get_class_handler(), cls, method, inbl,
               &outbl, ctx->get_snap_read(), ctx->get_snap_context()));
}

void
IoCtx::from_rados_ioctx_t(rados_ioctx_t p, IoCtx& io)
{
...
int
IoCtx::list_snaps(const std::string& o, snap_set_t* out_snaps)
{
  TestIoCtxImpl* ctx = reinterpret_cast<TestIoCtxImpl*>(io_ctx_impl);
  return ctx->execute_operation(
...
int
IoCtx::list_watchers(const std::string& o, std::list<obj_watch_t>* out_watchers)
{
  TestIoCtxImpl* ctx = reinterpret_cast<TestIoCtxImpl*>(io_ctx_impl);
  return ctx->execute_operation(
...
int
IoCtx::notify(const std::string& o, uint64_t ver, bufferlist& bl)
{
  TestIoCtxImpl* ctx = reinterpret_cast<TestIoCtxImpl*>(io_ctx_impl);
    ...
    std::map<std::string, bufferlist>* out_vals)
{
  ...
  return ctx->execute_operation(
      oid, std::bind(
               &TestIoCtxImpl::omap_get_vals, _1, _2, start_after, "",
               max_return, out_vals));
}

int
IoCtx::omap_rm_keys(const std::string& oid, const std::set<std::string>& keys)
{
  TestIoCtxImpl* ctx = reinterpret_cast<TestIoCtxImpl*>(io_ctx_impl);
  return ctx->execute_operation(
...
int
IoCtx::operate(const std::string& oid, ObjectWriteOperation* op)
{
  TestIoCtxImpl* ctx = reinterpret_cast<TestIoCtxImpl*>(io_ctx_impl);
  TestObjectOperationImpl* ops =
      reinterpret_cast<TestObjectOperationImpl*>(op->impl);
...
int
IoCtx::operate(const std::string& oid, ObjectReadOperation* op, bufferlist* pbl)
{
  TestIoCtxImpl* ctx = reinterpret_cast<TestIoCtxImpl*>(io_ctx_impl);
  TestObjectOperationImpl* ops =
      reinterpret_cast<TestObjectOperationImpl*>(op->impl);
...
int
IoCtx::read(const std::string& oid, bufferlist& bl, size_t len, uint64_t off)
{
  TestIoCtxImpl* ctx = reinterpret_cast<TestIoCtxImpl*>(io_ctx_impl);
  return ctx->execute_operation(
      oid, std::bind(
               &TestIoCtxImpl::read, _1, _2, len, off, &bl,
               ctx->get_snap_read(), nullptr));
}

int
IoCtx::remove(const std::string& oid)
{
  TestIoCtxImpl* ctx = reinterpret_cast<TestIoCtxImpl*>(io_ctx_impl);
  return ctx->execute_operation(
...
int
IoCtx::selfmanaged_snap_create(uint64_t* snapid)
{
  TestIoCtxImpl* ctx = reinterpret_cast<TestIoCtxImpl*>(io_ctx_impl);
...
void
IoCtx::aio_selfmanaged_snap_create(uint64_t* snapid, AioCompletion* c)
{
  TestIoCtxImpl* ctx = reinterpret_cast<TestIoCtxImpl*>(io_ctx_impl);
...
int
IoCtx::selfmanaged_snap_remove(uint64_t snapid)
{
  TestIoCtxImpl* ctx = reinterpret_cast<TestIoCtxImpl*>(io_ctx_impl);
...
void
IoCtx::aio_selfmanaged_snap_remove(uint64_t snapid, AioCompletion* c)
{
  TestIoCtxImpl* ctx = reinterpret_cast<TestIoCtxImpl*>(io_ctx_impl);
...
int
IoCtx::selfmanaged_snap_rollback(const std::string& oid, uint64_t snapid)
{
  TestIoCtxImpl* ctx = reinterpret_cast<TestIoCtxImpl*>(io_ctx_impl);
...
int
IoCtx::selfmanaged_snap_set_write_ctx(snap_t seq, std::vector<snap_t>& snaps)
{
  TestIoCtxImpl* ctx = reinterpret_cast<TestIoCtxImpl*>(io_ctx_impl);
...
void
IoCtx::snap_set_read(snap_t seq)
{
  TestIoCtxImpl* ctx = reinterpret_cast<TestIoCtxImpl*>(io_ctx_impl);
    ...
    uint64_t off)
{
  ...
  return ctx->execute_operation(
      oid, std::bind(
               &TestIoCtxImpl::sparse_read, _1, _2, off, len, &m, &bl,
               ctx->get_snap_read()));
}

int
IoCtx::stat(const std::string& oid, uint64_t* psize, time_t* pmtime)
{
  TestIoCtxImpl* ctx = reinterpret_cast<TestIoCtxImpl*>(io_ctx_impl);
  return ctx->execute_operation(
...
int
IoCtx::tmap_update(const std::string& oid, bufferlist& cmdbl)
{
  TestIoCtxImpl* ctx = reinterpret_cast<TestIoCtxImpl*>(io_ctx_impl);
  return ctx->execute_operation(
...
int
IoCtx::trunc(const std::string& oid, uint64_t off)
{
  TestIoCtxImpl* ctx = reinterpret_cast<TestIoCtxImpl*>(io_ctx_impl);
  return ctx->execute_operation(
      oid,
      std::bind(&TestIoCtxImpl::truncate, _1, _2, off, ctx->get_snap_context()));
}

int
IoCtx::unwatch2(uint64_t handle)
{
  TestIoCtxImpl* ctx = reinterpret_cast<TestIoCtxImpl*>(io_ctx_impl);
...
int
IoCtx::unwatch(const std::string& o, uint64_t handle)
{
  TestIoCtxImpl* ctx = reinterpret_cast<TestIoCtxImpl*>(io_ctx_impl);
  return ctx->unwatch(handle);
}
...
int
IoCtx::watch2(const std::string& o, uint64_t* handle, librados::WatchCtx2* wctx)
{
  TestIoCtxImpl* ctx = reinterpret_cast<TestIoCtxImpl*>(io_ctx_impl);
...
int
IoCtx::write(const std::string& oid, bufferlist& bl, size_t len, uint64_t off)
{
  TestIoCtxImpl* ctx = reinterpret_cast<TestIoCtxImpl*>(io_ctx_impl);
  return ctx->execute_operation(
      oid, std::bind(
               &TestIoCtxImpl::write, _1, _2, bl, len, off,
               ctx->get_snap_context()));
}

int
IoCtx::write_full(const std::string& oid, bufferlist& bl)
{
  TestIoCtxImpl* ctx = reinterpret_cast<TestIoCtxImpl*>(io_ctx_impl);
  return ctx->execute_operation(
      oid, std::bind(
               &TestIoCtxImpl::write_full, _1, _2, bl, ctx->get_snap_context()));
}

int
IoCtx::writesame(const std::string& oid, bufferlist& bl, size_t len, uint64_t off)
{
  TestIoCtxImpl* ctx = reinterpret_cast<TestIoCtxImpl*>(io_ctx_impl);
  return ctx->execute_operation(
      oid, std::bind(
               &TestIoCtxImpl::writesame, _1, _2, bl, len, off,
               ctx->get_snap_context()));
}

int
IoCtx::cmpext(const std::string& oid, uint64_t off, bufferlist& cmp_bl)
{
  TestIoCtxImpl* ctx = reinterpret_cast<TestIoCtxImpl*>(io_ctx_impl);
  return ctx->execute_operation(
      oid,
      std::bind(
          &TestIoCtxImpl::cmpext, _1, _2, off, cmp_bl, ctx->get_snap_read()));
}

int
IoCtx::application_enable(const std::string& app_name, bool force)
{
  return 0;
}

int
IoCtx::application_enable_async(
...
int
IoCtx::application_list(std::set<std::string>* app_names)
{
  return -EOPNOTSUPP;
}

int
IoCtx::application_metadata_get(
    const std::string& app_name,
...
int
IoCtx::application_metadata_set(
    const std::string& app_name,
    const std::string& key,
...
int
IoCtx::application_metadata_remove(
    const std::string& app_name,
    const std::string& key)
{
  return -EOPNOTSUPP;
...
int
IoCtx::application_metadata_list(
    const std::string& app_name,
...
void
IoCtx::set_namespace(const std::string& nspace)
{
  TestIoCtxImpl* ctx = reinterpret_cast<TestIoCtxImpl*>(io_ctx_impl);
...
bool
IoCtx::get_pool_full_try()
{
  return false;
}

static int
save_operation_result(int result, int* pval)
{
  if (pval != NULL) {
    *pval = result;
  }
...
void
ObjectOperation::assert_version(uint64_t ver)
{
  TestObjectOperationImpl* o = reinterpret_cast<TestObjectOperationImpl*>(impl);
...
void
ObjectOperation::exec(const char* cls, const char* method, bufferlist& inbl)
{
  TestObjectOperationImpl* o = reinterpret_cast<TestObjectOperationImpl*>(impl);
  o->ops.push_back(std::bind(
      &TestIoCtxImpl::exec, _1, _2, librados_test_stub::get_class_handler(),
      cls, method, inbl, _3, _4, _5));
}

void
ObjectOperation::set_op_flags2(int flags)
{}

size_t
ObjectOperation::size()
{
  TestObjectOperationImpl* o = reinterpret_cast<TestObjectOperationImpl*>(impl);
  return o->ops.size();
}
...
void
ObjectOperation::cmpext(uint64_t off, const bufferlist& cmp_bl, int* prval)
{
  TestObjectOperationImpl* o = reinterpret_cast<TestObjectOperationImpl*>(impl);
  ObjectOperationTestImpl op =
      std::bind(&TestIoCtxImpl::cmpext, _1, _2, off, cmp_bl, _4);
  if (prval != NULL) {
    op = std::bind(
        save_operation_result, std::bind(op, _1, _2, _3, _4, _5, _6), prval);
  }
  o->ops.push_back(op);
}

void
ObjectReadOperation::list_snaps(snap_set_t* out_snaps, int* prval)
{
  TestObjectOperationImpl* o = reinterpret_cast<TestObjectOperationImpl*>(impl);

  ObjectOperationTestImpl op =
      std::bind(&TestIoCtxImpl::list_snaps, _1, _2, out_snaps);
  if (prval != NULL) {
    op = std::bind(
        save_operation_result, std::bind(op, _1, _2, _3, _4, _5, _6), prval);
  }
...
void
ObjectReadOperation::list_watchers(
    ...
    int* prval)
{
  ...
  ObjectOperationTestImpl op =
      std::bind(&TestIoCtxImpl::list_watchers, _1, _2, out_watchers);
  if (prval != NULL) {
    op = std::bind(
        save_operation_result, std::bind(op, _1, _2, _3, _4, _5, _6), prval);
  }
...
void
ObjectReadOperation::read(size_t off, uint64_t len, bufferlist* pbl, int* prval)
{
  TestObjectOperationImpl* o = reinterpret_cast<TestObjectOperationImpl*>(impl);
...
void
ObjectReadOperation::sparse_read(
    uint64_t off,
    uint64_t len,
    std::map<uint64_t, uint64_t>* m,
    bufferlist* pbl,
...
void
ObjectReadOperation::stat(uint64_t* psize, time_t* pmtime, int* prval)
{
  TestObjectOperationImpl* o = reinterpret_cast<TestObjectOperationImpl*>(impl);

  ObjectOperationTestImpl op =
      std::bind(&TestIoCtxImpl::stat, _1, _2, psize, pmtime);
...
void
ObjectWriteOperation::append(const bufferlist& bl)
{
  TestObjectOperationImpl* o = reinterpret_cast<TestObjectOperationImpl*>(impl);
...
void
ObjectWriteOperation::create(bool exclusive)
{
  TestObjectOperationImpl* o = reinterpret_cast<TestObjectOperationImpl*>(impl);
...
void
ObjectWriteOperation::omap_set(const std::map<std::string, bufferlist>& map)
{
  TestObjectOperationImpl* o = reinterpret_cast<TestObjectOperationImpl*>(impl);
...
void
ObjectWriteOperation::selfmanaged_snap_rollback(uint64_t snapid)
{
  TestObjectOperationImpl* o = reinterpret_cast<TestObjectOperationImpl*>(impl);
  o->ops.push_back(
      std::bind(&TestIoCtxImpl::selfmanaged_snap_rollback, _1, _2, snapid));
}

void
ObjectWriteOperation::set_alloc_hint(
    uint64_t expected_object_size,
    uint64_t expected_write_size)
{
  TestObjectOperationImpl* o = reinterpret_cast<TestObjectOperationImpl*>(impl);
  o->ops.push_back(std::bind(
      &TestIoCtxImpl::set_alloc_hint, _1, _2, expected_object_size,
      expected_write_size, 0, _5));
}
    ...
    uint32_t flags)
{
  ...
  o->ops.push_back(std::bind(
      &TestIoCtxImpl::set_alloc_hint, _1, _2, expected_object_size,
      expected_write_size, flags, _5));
}

void
ObjectWriteOperation::tmap_update(const bufferlist& cmdbl)
{
  TestObjectOperationImpl* o = reinterpret_cast<TestObjectOperationImpl*>(impl);
...
void
ObjectWriteOperation::truncate(uint64_t off)
{
  TestObjectOperationImpl* o = reinterpret_cast<TestObjectOperationImpl*>(impl);
...
void
ObjectWriteOperation::write(uint64_t off, const bufferlist& bl)
{
  TestObjectOperationImpl* o = reinterpret_cast<TestObjectOperationImpl*>(impl);
  o->ops.push_back(
      std::bind(&TestIoCtxImpl::write, _1, _2, bl, bl.length(), off, _5));
}

void
ObjectWriteOperation::write_full(const bufferlist& bl)
{
  TestObjectOperationImpl* o = reinterpret_cast<TestObjectOperationImpl*>(impl);
...
void
ObjectWriteOperation::writesame(uint64_t off, uint64_t len, const bufferlist& bl)
{
  TestObjectOperationImpl* o = reinterpret_cast<TestObjectOperationImpl*>(impl);
  o->ops.push_back(
      std::bind(&TestIoCtxImpl::writesame, _1, _2, bl, len, off, _5));
}

void
ObjectWriteOperation::zero(uint64_t off, uint64_t len)
{
  TestObjectOperationImpl* o = reinterpret_cast<TestObjectOperationImpl*>(impl);
...
void
Rados::from_rados_t(rados_t p, Rados& rados)
{
...
AioCompletion*
Rados::aio_create_completion(void* cb_arg, callback_t cb_complete)
{
  AioCompletionImpl* c;
  int r = rados_aio_create_completion2(
      cb_arg, cb_complete, reinterpret_cast<void**>(&c));
  ceph_assert(r == 0);
  return new AioCompletion(c);
}

int
Rados::aio_watch_flush(AioCompletion* c)
{
...
int
Rados::blocklist_add(const std::string& client_address, uint32_t expire_seconds)
{
  TestRadosClient* impl = reinterpret_cast<TestRadosClient*>(client);
...
int
Rados::cluster_fsid(std::string* fsid)
{
...
int
Rados::conf_set(const char* option, const char* value)
{
  return rados_conf_set(reinterpret_cast<rados_t>(client), option, value);
}

int
Rados::conf_get(const char* option, std::string& val)
{
  TestRadosClient* impl = reinterpret_cast<TestRadosClient*>(client);
  CephContext* cct = impl->cct();
...
int
Rados::conf_parse_env(const char* env) const
{
  return rados_conf_parse_env(reinterpret_cast<rados_t>(client), env);
}

int
Rados::conf_read_file(const char* const path) const
{
...
int
Rados::get_min_compatible_osd(int8_t* require_osd_release)
{
  TestRadosClient* impl = reinterpret_cast<TestRadosClient*>(client);
...
int
Rados::get_min_compatible_client(
    int8_t* min_compat_client,
    int8_t* require_min_compat_client)
{
  TestRadosClient* impl = reinterpret_cast<TestRadosClient*>(client);
  return impl->get_min_compatible_client(
      min_compat_client, require_min_compat_client);
}

int
Rados::init(const char* const id)
{
  return rados_create(reinterpret_cast<rados_t*>(&client), id);
}

int
Rados::init_with_context(config_t cct_)
{
  return rados_create_with_context(reinterpret_cast<rados_t*>(&client), cct_);
}

int
Rados::ioctx_create(const char* name, IoCtx& io)
{
  rados_ioctx_t p;
...
int
Rados::ioctx_create2(int64_t pool_id, IoCtx& io)
{
  rados_ioctx_t p;
...
int
Rados::service_daemon_update_status(std::map<std::string, std::string>&& status)
{
  TestRadosClient* impl = reinterpret_cast<TestRadosClient*>(client);
...
int
Rados::pool_create(const char* name)
{
  TestRadosClient* impl = reinterpret_cast<TestRadosClient*>(client);
...
int
Rados::pool_delete(const char* name)
{
  TestRadosClient* impl = reinterpret_cast<TestRadosClient*>(client);
...
int
Rados::pool_get_base_tier(int64_t pool, int64_t* base_tier)
{
  TestRadosClient* impl = reinterpret_cast<TestRadosClient*>(client);
...
int
Rados::pool_list(std::list<std::string>& v)
{
  TestRadosClient* impl = reinterpret_cast<TestRadosClient*>(client);
  std::list<std::pair<int64_t, std::string>> pools;
...
int
Rados::pool_list2(std::list<std::pair<int64_t, std::string>>& v)
{
  TestRadosClient* impl = reinterpret_cast<TestRadosClient*>(client);
...
int64_t
Rados::pool_lookup(const char* name)
{
  TestRadosClient* impl = reinterpret_cast<TestRadosClient*>(client);
...
int
Rados::pool_reverse_lookup(int64_t id, std::string* name)
{
  TestRadosClient* impl = reinterpret_cast<TestRadosClient*>(client);
...
void
Rados::test_blocklist_self(bool set)
{}
...
int
cls_cxx_create(cls_method_context_t hctx, bool exclusive)
{
...
int
cls_cxx_remove(cls_method_context_t hctx)
{
  librados::TestClassHandler::MethodContext* ctx =
      reinterpret_cast<librados::TestClassHandler::MethodContext*>(hctx);
  return ctx->io_ctx_impl->remove(
      ctx->oid, ctx->io_ctx_impl->get_snap_context());
}

int
cls_get_request_origin(cls_method_context_t hctx, entity_inst_t* origin)
{
  librados::TestClassHandler::MethodContext* ctx =
      reinterpret_cast<librados::TestClassHandler::MethodContext*>(hctx);
  ...
  entity_addr_t entity_addr(
      entity_addr_t::TYPE_DEFAULT, rados_client->get_nonce());
  entity_addr.in4_addr() = sin;

  *origin = entity_inst_t(
      entity_name_t::CLIENT(rados_client->get_instance_id()), entity_addr);
  return 0;
}

int
cls_cxx_getxattr(cls_method_context_t hctx, const char* name, bufferlist* outbl)
{
    ...
    bool* more)
{
  ...
  int r = ctx->io_ctx_impl->omap_get_vals2(
      ctx->oid, start_obj, "", max_to_get, &vals, more);
  if (r < 0) {
    return r;
  }
    ...
    bool* more)
{
  librados::TestClassHandler::MethodContext* ctx =
      reinterpret_cast<librados::TestClassHandler::MethodContext*>(hctx);
  int r = ctx->io_ctx_impl->omap_get_vals2(
      ctx->oid, start_obj, filter_prefix, max_to_get, vals, more);
  if (r < 0) {
    return r;
  }
  return vals->size();
...
int
cls_cxx_map_remove_key(cls_method_context_t hctx, const string& key)
{
...
int
cls_cxx_read(cls_method_context_t hctx, int ofs, int len, bufferlist* outbl)
{
...
int
cls_cxx_setxattr(cls_method_context_t hctx, const char* name, bufferlist* inbl)
{
  librados::TestClassHandler::MethodContext* ctx =
      reinterpret_cast<librados::TestClassHandler::MethodContext*>(hctx);
...
int
cls_cxx_stat(cls_method_context_t hctx, uint64_t* size, time_t* mtime)
{
  librados::TestClassHandler::MethodContext* ctx =
      reinterpret_cast<librados::TestClassHandler::MethodContext*>(hctx);
...
int
cls_cxx_write(cls_method_context_t hctx, int ofs, int len, bufferlist* inbl)
{
...
int
cls_cxx_write_full(cls_method_context_t hctx, bufferlist* inbl)
{
  librados::TestClassHandler::MethodContext* ctx =
      reinterpret_cast<librados::TestClassHandler::MethodContext*>(hctx);
...
int
cls_cxx_replace(cls_method_context_t hctx, int ofs, int len, bufferlist* inbl)
{
  librados::TestClassHandler::MethodContext* ctx =
      reinterpret_cast<librados::TestClassHandler::MethodContext*>(hctx);
...
int
cls_cxx_truncate(cls_method_context_t hctx, int ofs)
{
  librados::TestClassHandler::MethodContext* ctx =
      reinterpret_cast<librados::TestClassHandler::MethodContext*>(hctx);
...
int
cls_cxx_write_zero(cls_method_context_t hctx, int ofs, int len)
{
  librados::TestClassHandler::MethodContext* ctx =
      reinterpret_cast<librados::TestClassHandler::MethodContext*>(hctx);
...
uint64_t
cls_get_features(cls_method_context_t hctx)
{
  return CEPH_FEATURES_SUPPORTED_DEFAULT;
}

uint64_t
cls_get_client_features(cls_method_context_t hctx)
{
  return CEPH_FEATURES_SUPPORTED_DEFAULT;
}

int
cls_get_snapset_seq(cls_method_context_t hctx, uint64_t* snap_seq)
{
  librados::TestClassHandler::MethodContext* ctx =
      reinterpret_cast<librados::TestClassHandler::MethodContext*>(hctx);
...
int
cls_log(int level, const char* format, ...)
{
  int size = 256;
  va_list ap;
  while (1) {
...
int
cls_register(const char* name, cls_handle_t* handle)
{
...
ceph_release_t
cls_get_required_osd_release(cls_handle_t hclass)
{
  return ceph_release_t::nautilus;
}

ceph_release_t
cls_get_min_compatible_client(cls_handle_t hclass)
{
  return ceph_release_t::nautilus;
}
...
int
cls_gen_rand_base64(char*, int)
{
  return -ENOTSUP;
}

int
cls_cxx_chunk_write_and_set(
    cls_method_handle_t,
    int,
    int,
    bufferlist*,
...
int
cls_cxx_map_read_header(cls_method_handle_t, bufferlist*)
{
  return -ENOTSUP;
}

uint64_t
cls_get_osd_min_alloc_size(cls_method_context_t hctx)
{
  return 0;
}

uint64_t
cls_get_pool_stripe_width(cls_method_context_t hctx)
{
  return 0;
}
