...
TEST_F(StriperTest, SimpleWriteFull)
{
  ...
  memset(buf, 0xcc, sizeof(buf));
  ASSERT_EQ(
      0, rados_striper_write_full(striper, "SimpleWrite", buf, sizeof(buf)));
}
...
TEST_F(StriperTest, RoundTrip)
{
  ...
  ASSERT_EQ(
      (int)sizeof(buf2),
      rados_striper_read(striper, "RoundTrip", buf2, sizeof(buf2), 0));
...
TEST_F(StriperTest, OverlappingWriteRoundTrip)
{
  ...
  memset(buf, 0xcc, sizeof(buf));
  ASSERT_EQ(
      0, rados_striper_write(
             striper, "OverlappingWriteRoundTrip", buf, sizeof(buf), 0));
  memset(buf2, 0xdd, sizeof(buf2));
  ASSERT_EQ(
      0, rados_striper_write(
             striper, "OverlappingWriteRoundTrip", buf2, sizeof(buf2), 0));
  memset(buf3, 0, sizeof(buf3));
  ASSERT_EQ(
      (int)sizeof(buf3),
      rados_striper_read(
          striper, "OverlappingWriteRoundTrip", buf3, sizeof(buf3), 0));
...
TEST_F(StriperTestPP, OverlappingWriteRoundTripPP)
{
  ...
  ASSERT_EQ(
      0, striper.write("OverlappingWriteRoundTripPP", bl1, sizeof(buf), 0));
  char buf2[64];
  memset(buf2, 0xdd, sizeof(buf2));
  bufferlist bl2;
  bl2.append(buf2, sizeof(buf2));
  ASSERT_EQ(
      0, striper.write("OverlappingWriteRoundTripPP", bl2, sizeof(buf2), 0));
  bufferlist bl3;
  ASSERT_EQ(
      (int)sizeof(buf),
      striper.read("OverlappingWriteRoundTripPP", &bl3, sizeof(buf), 0));
  ASSERT_EQ(0, memcmp(bl3.c_str(), buf2, sizeof(buf2)));
  ASSERT_EQ(
      0, memcmp(bl3.c_str() + sizeof(buf2), buf, sizeof(buf) - sizeof(buf2)));
}
...
TEST_F(StriperTest, SparseWriteRoundTrip)
{
  ...
  ASSERT_EQ(
      0,
      rados_striper_write(striper, "SparseWriteRoundTrip", buf, sizeof(buf), 0));
  ASSERT_EQ(
      0, rados_striper_write(
             striper, "SparseWriteRoundTrip", buf, sizeof(buf), 1000000000));
  memset(buf2, 0xaa, sizeof(buf2));
  ASSERT_EQ(
      (int)sizeof(buf2),
      rados_striper_read(
          striper, "SparseWriteRoundTrip", buf2, sizeof(buf2), 0));
  ASSERT_EQ(0, memcmp(buf, buf2, sizeof(buf)));
  ...
  ASSERT_EQ(
      (int)sizeof(buf),
      rados_striper_read(
          striper, "SparseWriteRoundTrip", buf2, sizeof(buf), 500000000));
  ASSERT_EQ(0, memcmp(buf, buf2, sizeof(buf)));
}
...
TEST_F(StriperTestPP, SparseWriteRoundTripPP)
{
  ...
  ASSERT_EQ(
      0, striper.write("SparseWriteRoundTripPP", bl1, sizeof(buf), 1000000000));
  bufferlist bl2;
  ASSERT_EQ(
      (int)(2 * sizeof(buf)),
      striper.read("SparseWriteRoundTripPP", &bl2, 2 * sizeof(buf), 0));
  ASSERT_EQ(0, memcmp(bl2.c_str(), buf, sizeof(buf)));
  memset(buf, 0, sizeof(buf));
  ASSERT_EQ(0, memcmp(bl2.c_str() + sizeof(buf), buf, sizeof(buf)));
  ASSERT_EQ(
      (int)sizeof(buf),
      striper.read("SparseWriteRoundTripPP", &bl2, sizeof(buf), 500000000));
  ASSERT_EQ(0, memcmp(bl2.c_str(), buf, sizeof(buf)));
}
...
TEST_F(StriperTest, WriteFullRoundTrip)
{
  ...
  ASSERT_EQ(
      0,
      rados_striper_write(striper, "WriteFullRoundTrip", buf, sizeof(buf), 0));
  memset(buf2, 0xdd, sizeof(buf2));
  ASSERT_EQ(
      0, rados_striper_write_full(
             striper, "WriteFullRoundTrip", buf2, sizeof(buf2)));
  memset(buf3, 0x00, sizeof(buf3));
  ASSERT_EQ(
      (int)sizeof(buf2),
      rados_striper_read(striper, "WriteFullRoundTrip", buf3, sizeof(buf3), 0));
...
TEST_F(StriperTestPP, WriteFullRoundTripPP)
{
  ...
  ASSERT_EQ(
      (int)sizeof(buf2),
      striper.read("WriteFullRoundTripPP", &bl3, sizeof(buf), 0));
  ASSERT_EQ(0, memcmp(bl3.c_str(), buf2, sizeof(buf2)));
}
...
TEST_F(StriperTest, AppendRoundTrip)
{
  ...
  ASSERT_EQ(
      0, rados_striper_append(striper, "AppendRoundTrip", buf, sizeof(buf)));
  memset(buf2, 0xad, sizeof(buf2));
  ASSERT_EQ(
      0, rados_striper_append(striper, "AppendRoundTrip", buf2, sizeof(buf2)));
  memset(buf3, 0, sizeof(buf3));
  ASSERT_EQ(
      (int)sizeof(buf3),
      rados_striper_read(striper, "AppendRoundTrip", buf3, sizeof(buf3), 0));
...
TEST_F(StriperTest, TruncTest)
{
  ...
  ASSERT_EQ(
      (int)(sizeof(buf) / 2),
      rados_striper_read(striper, "TruncTest", buf2, sizeof(buf2), 0));
...
TEST_F(StriperTestPP, TruncTestPP)
{
  ...
  bufferlist bl2;
  ASSERT_EQ(
      (int)(sizeof(buf) / 2), striper.read("TruncTestPP", &bl2, sizeof(buf), 0));
...
TEST_F(StriperTest, TruncTestGrow)
{
  ...
  ASSERT_EQ(
      (int)sizeof(buf2),
      rados_striper_read(striper, "TruncTestGrow", buf2, sizeof(buf2), 0));
  ASSERT_EQ(0, memcmp(buf, buf2, sizeof(buf)));
...
TEST_F(StriperTestPP, TruncTestGrowPP)
{
  ...
  ASSERT_EQ(
      sizeof(buf) * 2,
      (unsigned)striper.read("TruncTestGrowPP", &bl2, sizeof(buf) * 2, 0));
  ASSERT_EQ(0, memcmp(bl2.c_str(), buf, sizeof(buf)));
  memset(buf, 0x00, sizeof(buf));
  ASSERT_EQ(0, memcmp(bl2.c_str() + sizeof(buf), buf, sizeof(buf)));
}
...
TEST_F(StriperTest, XattrsRoundTrip)
{
  ...
  memset(buf, 0xaa, sizeof(buf));
  ASSERT_EQ(
      0, rados_striper_write(striper, "XattrsRoundTrip", buf, sizeof(buf), 0));
  ASSERT_EQ(
      -ENODATA, rados_striper_getxattr(
                    striper, "XattrsRoundTrip", "attr1", buf, sizeof(buf)));
  ASSERT_EQ(
      0, rados_striper_setxattr(
             striper, "XattrsRoundTrip", "attr1", attr1_buf, sizeof(attr1_buf)));
  ASSERT_EQ(
...
TEST_F(StriperTestPP, XattrsRoundTripPP)
{
  ...
  ASSERT_EQ(
      (int)sizeof(attr1_buf),
      striper.getxattr("XattrsRoundTripPP", "attr1", bl4));
...
TEST_F(StriperTest, RmXattr)
{
  ...
  ASSERT_EQ(
      0, rados_striper_setxattr(
             striper, "RmXattr", "attr1", attr1_buf, sizeof(attr1_buf)));
  ASSERT_EQ(0, rados_striper_rmxattr(striper, "RmXattr", "attr1"));
  ASSERT_EQ(
      -ENODATA,
      rados_striper_getxattr(striper, "RmXattr", "attr1", buf, sizeof(buf)));
}
...
TEST_F(StriperTest, XattrIter)
{
  ...
  ASSERT_EQ(
      0, rados_striper_setxattr(
             striper, "RmXattr", "attr2", attr2_buf, sizeof(attr2_buf)));
