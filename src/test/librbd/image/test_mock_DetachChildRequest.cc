...
public:
  ...
  void
  expect_test_op_features(MockTestImageCtx& mock_image_ctx, bool enabled)
  {
    EXPECT_CALL(
  ...
  void
  expect_remove_child(MockImageCtx& mock_image_ctx, int r)
  {
    EXPECT_CALL(
      ...
      int r)
  {
    ...
    using ceph::encode;
    EXPECT_CALL(
        mock_io_ctx_impl, exec(
                              parent_header_name, _, StrEq("rbd"),
      ...
      int r)
  {
    EXPECT_CALL(
        *mock_image_ctx.operations,
        snap_remove({cls::rbd::TrashSnapshotNamespace{}}, StrEq(snap_name), _))
      ...
      int r)
  {
    ...
    EXPECT_CALL(
        mock_io_ctx_impl,
        exec(RBD_TRASH, _, StrEq("rbd"), StrEq("trash_get"), _, _, _, _))
  ...
  void
  expect_trash_remove(MockTrashRemoveRequest& mock_trash_remove_request, int r)
  {
...
TEST_F(TestMockImageDetachChildRequest, SuccessV2)
{
  ...
  expect_snapshot_get(
      mock_image_ctx, *mock_io_ctx_impl, "rbd_header.parent id",
      {234, {cls::rbd::UserSnapshotNamespace{}}, "snap1", 123, {}, 0}, 0);
...
TEST_F(TestMockImageDetachChildRequest, TrashedSnapshotSuccess)
{
  ...
  expect_snapshot_get(
      mock_image_ctx, *mock_io_ctx_impl, "rbd_header.parent id",
      {234, {cls::rbd::TrashSnapshotNamespace{}}, "snap1", 123, {}, 0}, 0);
...
TEST_F(TestMockImageDetachChildRequest, TrashedSnapshotInUse)
{
  ...
  expect_snapshot_get(
      mock_image_ctx, *mock_io_ctx_impl, "rbd_header.parent id",
      {234, {cls::rbd::TrashSnapshotNamespace{}}, "snap1", 123, {}, 1}, 0);
