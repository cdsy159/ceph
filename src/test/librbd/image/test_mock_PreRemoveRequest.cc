...
SnapshotRemoveRequest<MockTestImageCtx>*
    SnapshotRemoveRequest<MockTestImageCtx>::s_instance;
...
ListWatchersRequest<MockTestImageCtx>*
    ListWatchersRequest<MockTestImageCtx>::s_instance;
...
public:
  ...
  typedef librbd::operation::SnapshotRemoveRequest<MockTestImageCtx>
  ...
  void
  expect_set_exclusive_lock_policy(MockTestImageCtx& mock_image_ctx)
  {
  ...
  void
  expect_set_journal_policy(MockTestImageCtx& mock_image_ctx)
  {
      ...
      int r)
  {
    EXPECT_CALL(mock_list_watchers_request, send())
        .WillOnce(
            FinishRequest(&mock_list_watchers_request, r, &mock_image_ctx));
  }

  void
  expect_get_group(MockTestImageCtx& mock_image_ctx, int r)
  {
...
TEST_F(TestMockImagePreRemoveRequest, AutoDeleteSnapshots)
{
  ...
  m_mock_imctx->snap_info = {
      {123,
       {"snap1", {cls::rbd::TrashSnapshotNamespace{}}, {}, {}, {}, {}, {}}}};
