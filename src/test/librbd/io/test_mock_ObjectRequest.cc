...
inline ImageCtx*
get_image_ctx(MockImageCtx* image_ctx)
{
...
struct CopyupRequest<librbd::MockImageCtx> {
  ...
  MOCK_METHOD2(
      append_request,
      void(
          AbstractObjectWriteRequest<librbd::MockTestImageCtx>*,
          const Extents&));
};

template <>
struct CopyupRequest<librbd::MockTestImageCtx>
  : public CopyupRequest<librbd::MockImageCtx> {
...
CopyupRequest<librbd::MockTestImageCtx>*
    CopyupRequest<librbd::MockTestImageCtx>::s_instance = nullptr;
...
ImageListSnapsRequest<librbd::MockTestImageCtx>*
    ImageListSnapsRequest<librbd::MockTestImageCtx>::s_instance = nullptr;
...
read_parent(
    ...
    Context* on_finish)
{
  Mock::s_instance->read_parent(
      image_ctx, object_no, extents, snap_id, trace, on_finish);
}
...
struct TestMockIoObjectRequest : public TestMockFixture {
  ...
  typedef ObjectWriteSameRequest<librbd::MockTestImageCtx>
      MockObjectWriteSameRequest;
  typedef ObjectCompareAndWriteRequest<librbd::MockTestImageCtx>
      MockObjectCompareAndWriteRequest;
  typedef ObjectListSnapsRequest<librbd::MockTestImageCtx>
      MockObjectListSnapsRequest;
  typedef AbstractObjectWriteRequest<librbd::MockTestImageCtx>
      MockAbstractObjectWriteRequest;
  typedef CopyupRequest<librbd::MockTestImageCtx> MockCopyupRequest;
  typedef ImageListSnapsRequest<librbd::MockTestImageCtx>
  ...
  void
  expect_get_object_size(MockTestImageCtx& mock_image_ctx)
  {
    EXPECT_CALL(mock_image_ctx, get_object_size())
        .WillRepeatedly(Return(mock_image_ctx.layout.object_size));
  }

  void
  expect_get_parent_overlap(
      MockTestImageCtx& mock_image_ctx,
      librados::snap_t snap_id,
      uint64_t overlap,
      int r)
  ...
  void
  expect_is_lock_owner(MockExclusiveLock& mock_exclusive_lock)
  {
    EXPECT_CALL(mock_exclusive_lock, is_lock_owner())
      ...
      int r)
  {
    EXPECT_CALL(mock_utils, read_parent(_, object_no, extents, snap_id, _, _))
        .WillOnce(WithArg<5>(
            CompleteContext(r, static_cast<asio::ContextWQ*>(nullptr))));
  }

  void
  expect_copyup(MockCopyupRequest& mock_copyup_request, int r)
  {
  ...
  expect_copyup(
      ...
      MockAbstractObjectWriteRequest** write_request,
      int r)
  {
      ...
      int ret_val)
  {
    if (mock_image_ctx.object_map != nullptr) {
      EXPECT_CALL(
          *mock_image_ctx.object_map, aio_update(
                                          CEPH_NOSNAP, start_object, end_object,
                                          state, current_state, _, false, _))
          .WillOnce(WithArg<7>(Invoke([&mock_image_ctx, updated,
                                       ret_val](Context* ctx) {
            if (updated) {
  ...
  void
  expect_assert_exists(MockTestImageCtx& mock_image_ctx, int r)
  {
    auto& mock_io_ctx = librados::get_mock_io_ctx(
        mock_image_ctx.rados_api, *mock_image_ctx.get_data_io_context());
  ...
  void
  expect_write_full(MockTestImageCtx& mock_image_ctx, int r)
  {
    auto& mock_io_ctx = librados::get_mock_io_ctx(
        mock_image_ctx.rados_api, *mock_image_ctx.get_data_io_context());
  ...
  void
  expect_remove(MockTestImageCtx& mock_image_ctx, int r)
  {
    auto& mock_io_ctx = librados::get_mock_io_ctx(
        mock_image_ctx.rados_api, *mock_image_ctx.get_data_io_context());
  ...
  void
  expect_create(MockTestImageCtx& mock_image_ctx, bool exclusive)
  {
    auto& mock_io_ctx = librados::get_mock_io_ctx(
        mock_image_ctx.rados_api, *mock_image_ctx.get_data_io_context());
  ...
  void
  expect_truncate(MockTestImageCtx& mock_image_ctx, int offset, int r)
  {
    auto& mock_io_ctx = librados::get_mock_io_ctx(
        mock_image_ctx.rados_api, *mock_image_ctx.get_data_io_context());
  ...
  void
  expect_zero(MockTestImageCtx& mock_image_ctx, int offset, int length, int r)
  {
    auto& mock_io_ctx = librados::get_mock_io_ctx(
        mock_image_ctx.rados_api, *mock_image_ctx.get_data_io_context());
  ...
  void
  expect_cmpext(MockTestImageCtx& mock_image_ctx, int offset, int r)
  {
    auto& mock_io_ctx = librados::get_mock_io_ctx(
        mock_image_ctx.rados_api, *mock_image_ctx.get_data_io_context());
      ...
      int r)
  {
    ...
    auto& mock_io_ctx =
        librados::get_mock_io_ctx(mock_image_ctx.rados_api, io_context);
    EXPECT_CALL(mock_io_ctx, list_snaps(_, _))
        .WillOnce(WithArg<1>(Invoke([snap_set,
                                     r](librados::snap_set_t* out_snap_set) {
  ...
  void
  expect_image_list_snaps(
      MockImageListSnapsRequest& req,
      const Extents& image_extents,
      const SnapshotDelta& image_snapshot_delta,
      int r)
  {
    EXPECT_CALL(req, execute_send())
        .WillOnce(Invoke([&req, image_extents, image_snapshot_delta, r]() {
...
TEST_F(TestMockIoObjectRequest, Read)
{
  ...
  expect_read(
      mock_image_ctx, ictx->get_object_name(0), 0, 4096, std::string(4096, '1'),
      0);
  expect_read(
      mock_image_ctx, ictx->get_object_name(0), 8192, 4096,
      std::string(4096, '2'), 0);
  ...
  auto req = MockObjectReadRequest::create(
      &mock_image_ctx, 0, &extents, mock_image_ctx.get_data_io_context(), 0, 0,
      {}, &version, &ctx);
  req->send();
...
TEST_F(TestMockIoObjectRequest, SparseReadThreshold)
{
  ...
  expect_get_read_flags(mock_image_ctx, CEPH_NOSNAP, 0);
  expect_sparse_read(
      mock_image_ctx, ictx->get_object_name(0), 0,
...
TEST_F(TestMockIoObjectRequest, Write)
{
  ...
  auto req = MockObjectWriteRequest::create_write(
      ...
      mock_image_ctx.get_data_io_context(), 0, 0, std::nullopt, {}, &ctx);
  req->send();
  ASSERT_EQ(0, ctx.wait());
}
...
TEST_F(TestMockIoObjectRequest, WriteWithAssertVersion)
{
  ...
  // assert version should succeed (version = 1)
  {
    ...
    auto req = MockObjectWriteRequest::create_write(
        &mock_image_ctx, 0, 0, std::move(bl),
        mock_image_ctx.get_data_io_context(), 0, 0, std::make_optional(1), {},
        &ctx);
    req->send();
    ASSERT_EQ(0, ctx.wait());
  }
...
TEST_F(TestMockIoObjectRequest, DiscardRemove)
{
  ...
  expect_object_map_update(
      mock_image_ctx, 0, 1, OBJECT_NONEXISTENT, OBJECT_PENDING, false, 0);
...
TEST_F(TestMockIoObjectRequest, ObjectMapError)
{
  ...
  expect_object_may_exist(mock_image_ctx, 0, true);
  expect_object_map_update(
      mock_image_ctx, 0, 1, OBJECT_EXISTS, {}, true, -EBLOCKLISTED);
...
TEST_F(TestMockIoObjectRequest, ListSnaps)
{
  ...
  clone_info.overlap = std::vector<std::pair<uint64_t, uint64_t>>{
      {425984, 4096},  {440320, 1024},  {1925120, 4096},
      {2125824, 4096}, {2215936, 5120}, {3067904, 4096}};
...
TEST_F(TestMockIoObjectRequest, ListSnapsENOENT)
{
  ...
  C_SaferCond ctx;
  auto req = MockObjectListSnapsRequest::create(
      &mock_image_ctx, 0, {{440320, 1024}}, {0, CEPH_NOSNAP}, 0, {},
      &snapshot_delta, &ctx);
  req->send();
  ASSERT_EQ(0, ctx.wait());
...
TEST_F(TestMockIoObjectRequest, ListSnapsDNE)
{
  ...
  C_SaferCond ctx;
  auto req = MockObjectListSnapsRequest::create(
      &mock_image_ctx, 0, {{440320, 1024}}, {2, 3, 4}, 0, {}, &snapshot_delta,
      &ctx);
  req->send();
  ASSERT_EQ(0, ctx.wait());
...
TEST_F(TestMockIoObjectRequest, ListSnapsParent)
{
  ...
  expect_image_list_snaps(
      mock_image_list_snaps_request, {{0, 4096}}, image_snapshot_delta, 0);
