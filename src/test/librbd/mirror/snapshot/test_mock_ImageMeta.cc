...
public:
      ...
      int r)
  {
    ...
    EXPECT_CALL(
        ...
        exec(
            mock_image_ctx.header_oid, _, StrEq("rbd"), StrEq("metadata_get"),
...
TEST_F(TestMockMirrorSnapshotImageMeta, Load)
{
  ...
  InSequence seq;
  expect_metadata_get(
      mock_image_ctx, "mirror uuid", "{\"resync_requested\": true}", 0);
...
TEST_F(TestMockMirrorSnapshotImageMeta, LoadError)
{
  ...
  InSequence seq;
  expect_metadata_get(
      mock_image_ctx, "mirror uuid", "{\"resync_requested\": true}", -EINVAL);
...
TEST_F(TestMockMirrorSnapshotImageMeta, SaveError)
{
  ...
  InSequence seq;
  expect_metadata_set(
      mock_image_ctx, "mirror uuid", "{\"resync_requested\": false}", -EINVAL);
