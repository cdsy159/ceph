...
struct MockImageCtx {
  ...
  MOCK_CONST_METHOD2(
      get_flags,
      int(librados::snap_t in_snap_id, uint64_t* flags));
  MOCK_CONST_METHOD2(
      get_snap_id,
      librados::snap_t(
  ...
  MOCK_CONST_METHOD2(
      get_snap_namespace,
      int(librados::snap_t, cls::rbd::SnapshotNamespace* out_snap_namespace));
  MOCK_CONST_METHOD2(
      get_parent_spec,
      int(librados::snap_t in_snap_id, cls::rbd::ParentImageSpec* pspec));
  MOCK_CONST_METHOD1(get_parent_info, const ParentImageInfo*(librados::snap_t));
  MOCK_CONST_METHOD2(
      get_parent_overlap,
      int(librados::snap_t in_snap_id, uint64_t* raw_overlap));
  MOCK_CONST_METHOD2(
      reduce_parent_overlap,
  ...
  MOCK_CONST_METHOD2(
      is_snap_protected,
      int(librados::snap_t in_snap_id, bool* is_protected));
  MOCK_CONST_METHOD2(
      is_snap_unprotected,
      int(librados::snap_t in_snap_id, bool* is_unprotected));
  ...
  MOCK_CONST_METHOD2(
      test_features,
      bool(uint64_t test_features, const ceph::shared_mutex& in_image_lock));
  ...
  MOCK_METHOD2(
      apply_metadata,
      int(const std::map<std::string, bufferlist>&, bool));
  ...
  static void get_timer_instance(
      CephContext* cct,
      MockSafeTimer** timer,
  ...
  std::map<ImageCtx::SnapKey, librados::snap_t, ImageCtx::SnapKeyComparator>
      snap_ids;
