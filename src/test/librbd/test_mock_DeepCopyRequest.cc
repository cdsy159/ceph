...
ImageCopyRequest<librbd::MockTestImageCtx>*
    ImageCopyRequest<librbd::MockTestImageCtx>::s_instance = nullptr;
MetadataCopyRequest<librbd::MockTestImageCtx>*
    MetadataCopyRequest<librbd::MockTestImageCtx>::s_instance = nullptr;
SnapshotCopyRequest<librbd::MockTestImageCtx>*
    SnapshotCopyRequest<librbd::MockTestImageCtx>::s_instance = nullptr;
...
public:
  ...
  typedef librbd::deep_copy::MetadataCopyRequest<librbd::MockTestImageCtx>
  ...
  void
  expect_rollback_object_map(librbd::MockObjectMap& mock_object_map, int r)
  {
  ...
  void
  expect_copy_metadata(MockMetadataCopyRequest& mock_metadata_copy_request, int r)
  {
...
TEST_F(TestMockDeepCopyRequest, Snap)
{
  ...
  EXPECT_EQ(
      0, librbd::api::Image<>::snap_set(
             m_src_image_ctx, cls::rbd::UserSnapshotNamespace(), "copy"));
  ...
  librbd::deep_copy::NoOpHandler no_op;
  auto request = librbd::DeepCopyRequest<librbd::MockTestImageCtx>::create(
      &mock_src_image_ctx, &mock_dst_image_ctx, 0, m_src_image_ctx->snap_id, 0,
