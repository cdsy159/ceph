...
public:
  ...
  MockPGLogEntryHandler(MockPGBackend* backend, ObjectStore::Transaction* t) :
    backend(backend), t(t)
  {}
  ...
  {
    lgeneric_dout(g_ceph_context, 0)
        << "MockPGLogEntryHandler::remove " << hoid << dendl;
  ...
  {
    lgeneric_dout(g_ceph_context, 0)
        << "MockPGLogEntryHandler::try_stash " << hoid << " " << v << dendl;
  ...
  {
    lgeneric_dout(g_ceph_context, 0)
        << "MockPGLogEntryHandler::rollback " << entry << dendl;
  ...
  {
    lgeneric_dout(g_ceph_context, 0)
        << "MockPGLogEntryHandler::rollforward " << entry << dendl;
  ...
  {
    lgeneric_dout(g_ceph_context, 0)
        << "MockPGLogEntryHandler::trim " << entry << dendl;
  ...
  {
    lgeneric_dout(g_ceph_context, 0)
        << "MockPGLogEntryHandler::partial_write " << entry << dendl;
