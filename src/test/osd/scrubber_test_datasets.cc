...
static RealObj
corrupt_object_size(const RealObj& s, [[maybe_unused]] int osdn)
{
  RealObj ret = s;
...
static RealObj
corrupt_nothing(const RealObj& s, int osdn)
{
  return s;
}
...
CorruptFuncList crpt_funcs_set1 = {
    {0, &corrupt_object_size},
    {1, &corrupt_nothing}};


// object with head & two snaps

static hobject_t hobj_ms1{
    object_t{"hobj_ms1"},
    "keykey", // key
    CEPH_NOSNAP, // snap_id
    0, // hash
...
hobject_t ec_hobj_ms1{
    object_t{"ec_hobj_ms1"},
    "keykey", // key
    CEPH_NOSNAP, // snap_id
    0, // hash
    0, // pool
...
SnapsetMockData::CookedCloneSnaps
ms1_fn()
{
...
static SnapsetMockData hobj_ms1_snapset{
    /* seq */ 0x40,
    /* clones */ {0x20, 0x30}, ms1_fn};

static SnapsetMockData empty_snapset{
    /* seq */ 0x0,
    /* clones */ {}, ms2_fn};

hobject_t hobj_ms1_snp30{
    object_t{"hobj_ms1"},
    "keykey", // key
    0x30, // snap_id
    0, // hash
...
static hobject_t hobj_ms1_snp20{
    object_t{"hobj_ms1"},
    "keykey", // key
    0x20, // snap_id
    0, // hash
...
ScrubGenerator::RealObjsConf minimal_snaps_configuration{/* RealObjsConf::objs */ {
    ...
    {ghobject_t{hobj_ms1, 0, shard_id_t{0}},
     ...
     &crpt_funcs_set0, &hobj_ms1_snapset}}
