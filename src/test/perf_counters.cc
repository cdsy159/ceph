...
static PerfCounters*
setup_test_perfcounters1(CephContext* cct)
{
  PerfCountersBuilder bld(
      cct, "test_perfcounter_1", TEST_PERFCOUNTERS1_ELEMENT_FIRST,
      TEST_PERFCOUNTERS1_ELEMENT_LAST);
...
TEST(PerfCounters, SinglePerfCounters)
{
  ...
  ASSERT_EQ(
      "", client.do_request(
              "{ \"prefix\": \"perf dump\", \"format\": \"json\" }", &msg));
  ASSERT_EQ(
      sd("{\"test_perfcounter_1\":{\"element1\":0,"
         "\"element2\":0.000000000,\"element3\":{\"avgcount\":0,\"sum\":0."
         "000000000,\"avgtime\":0.000000000}}}"),
      msg);
  ...
  ASSERT_EQ(
      sd("{\"test_perfcounter_1\":{\"element1\":1,"
         "\"element2\":0.500000000,\"element3\":{\"avgcount\":1,\"sum\":100."
         "000000000,\"avgtime\":100.000000000}}}"),
      msg);
  ...
  ASSERT_EQ(
      "", client.do_request(
              "{ \"prefix\": \"perf dump\", \"format\": \"json\" }", &msg));
  ASSERT_EQ(
      sd("{\"test_perfcounter_1\":{\"element1\":1,\"element2\":0.500000000,"
         "\"element3\":{\"avgcount\":3,\"sum\":120.000000000,\"avgtime\":40."
         "000000000}}}"),
      msg);
  ...
  ASSERT_EQ(
      sd("{\"test_perfcounter_1\":{\"element1\":1,"
         "\"element2\":0.000000000,\"element3\":{\"avgcount\":2,\"sum\":150."
         "000000000,\"max_inc\":100.000000000,\"avgtime\":75.000000000}}}"),
      msg);
...
static PerfCounters*
setup_test_perfcounter2(CephContext* cct)
{
  PerfCountersBuilder bld(
      cct, "test_perfcounter_2", TEST_PERFCOUNTERS2_ELEMENT_FIRST,
      TEST_PERFCOUNTERS2_ELEMENT_LAST);
...
TEST(PerfCounters, MultiplePerfCounters)
{
  ...
  ASSERT_EQ(
      "", client.do_request(
              "{ \"prefix\": \"perf dump\", \"format\": \"json\" }", &msg));
  ASSERT_EQ(
      sd("{\"test_perfcounter_1\":{\"element1\":0,\"element2\":0.000000000,"
         "\"element3\":"
         "{\"avgcount\":0,\"sum\":0.000000000,\"avgtime\":0.000000000}},\"test_"
         "perfcounter_2\":{\"foo\":0,\"bar\":0.000000000}}"),
      msg);
  ...
  ASSERT_EQ(
      "", client.do_request(
              "{ \"prefix\": \"perf dump\", \"format\": \"json\" }", &msg));
  ASSERT_EQ(
      sd("{\"test_perfcounter_1\":{\"element1\":6,\"element2\":0.000000000,"
         "\"element3\":"
         "{\"avgcount\":0,\"sum\":0.000000000,\"avgtime\":0.000000000}},\"test_"
         "perfcounter_2\":{\"foo\":0,\"bar\":0.000000000}}"),
      msg);
  ...
  ASSERT_EQ(
      "", client.do_request(
              "{ \"prefix\": \"perf dump\", \"format\": \"json\" }", &msg));
  ASSERT_EQ(
      sd("{\"test_perfcounter_1\":{\"element1\":13,\"element2\":0.000000000,"
         "\"element3\":"
         "{\"avgcount\":0,\"sum\":0.000000000,\"avgtime\":0.000000000}},\"test_"
         "perfcounter_2\":{\"foo\":0,\"bar\":0.000000000}}"),
      msg);
  ...
  ASSERT_EQ(
      sd("{\"test_perfcounter_1\":{\"element1\":13,\"element2\":0.000000000,"
         "\"element3\":{\"avgcount\":0,\"sum\":0.000000000,\"avgtime\":0."
         "000000000}}}"),
      msg);
  ASSERT_EQ(
      "", client.do_request(
              "{ \"prefix\": \"perf schema\", \"format\": \"json\" }", &msg));
  ASSERT_EQ(
      sd("{\"test_perfcounter_1\":{\"element1\":{\"type\":2,\"metric_type\":"
         "\"gauge\",\"value_type\":\"integer\",\"description\":\"\",\"nick\":"
         "\"\",\"priority\":0,\"units\":\"none\"},\"element2\":{\"type\":1,"
         "\"metric_type\":\"gauge\",\"value_type\":\"real\",\"description\":"
         "\"\",\"nick\":\"\",\"priority\":0,\"units\":\"none\"},\"element3\":{"
         "\"type\":5,\"metric_type\":\"gauge\",\"value_type\":\"real-integer-"
         "pair\",\"description\":\"\",\"nick\":\"\",\"priority\":0,\"units\":"
         "\"none\"}}}"),
      msg);
  coll->clear();
  ASSERT_EQ(
...
TEST(PerfCounters, ResetPerfCounters)
{
  ...
  ASSERT_EQ(
      "", client.do_request(
              "{ \"prefix\": \"perf reset\", \"var\": \"all\", \"format\": "
              "\"json\" }",
              &msg));
  ...
  ASSERT_EQ(
      "", client.do_request(
              "{ \"prefix\": \"perf reset\", \"var\": \"test_perfcounter_1\", "
              "\"format\": \"json\" }",
              &msg));
...
{
  PerfCountersBuilder bld(
      cct, "test_percounter_3", TEST_PERFCOUNTERS3_ELEMENT_FIRST,
      TEST_PERFCOUNTERS3_ELEMENT_LAST);
...
static void
counters_inc_test(std::shared_ptr<PerfCounters> fake_pf)
{
  int i = 100000;
  utime_t t;
...
static void
counters_readavg_test(std::shared_ptr<PerfCounters> fake_pf)
{
  int i = 100000;

  while (i--) {
    std::pair<uint64_t, uint64_t> dat =
        fake_pf->get_tavg_ns(TEST_PERFCOUNTERS3_ELEMENT_READ);
...
{
  std::shared_ptr<PerfCounters> fake_pf =
...
static PerfCounters*
setup_test_perfcounter4(std::string name, CephContext* cct)
{
  PerfCountersBuilder bld(
      cct, name, TEST_PERFCOUNTERS2_ELEMENT_FIRST,
      TEST_PERFCOUNTERS2_ELEMENT_LAST);
  bld.add_u64(TEST_PERFCOUNTERS2_ELEMENT_FOO, "foo");
  bld.add_time(TEST_PERFCOUNTERS2_ELEMENT_BAR, "bar");
...
TEST(PerfCounters, TestLabeledCountersOnly)
{
  ...
  std::string counter_key1 =
      ceph::perf_counters::key_create("name1", {{"label1", "val1"}});
  std::string counter_key2 =
      ceph::perf_counters::key_create("name2", {{"label2", "val2"}});
  std::string counter_key3 =
      ceph::perf_counters::key_create("name1", {{"label1", "val3"}});
  ...
  ASSERT_EQ(
      "", client.do_request(
              R"({ "prefix": "counter dump", "format": "raw" })", &message));
  ASSERT_EQ(
      R"({
    "name1": [
        {
  ...
  ASSERT_EQ(
      "", client.do_request(
              R"({ "prefix": "perf dump", "format": "raw" })", &message));
  ASSERT_EQ(empty_dump_format_raw, message);

  ASSERT_EQ(
      "", client.do_request(
              R"({ "prefix": "counter schema", "format": "raw" })", &message));
  ASSERT_EQ(
      R"({
    "name1": [
        {
  ...
  ASSERT_EQ(
      "", client.do_request(
              R"({ "prefix": "perf schema", "format": "raw" })", &message));
  ASSERT_EQ(empty_dump_format_raw, message);
...
TEST(PerfCounters, TestLabelStrings)
{
  ...
  std::string counter_key1 = ceph::perf_counters::key_create(
      "good_ctrs", {{"label3", "val4"}, {"label1", ""}});
  PerfCounters* counters1 =
      setup_test_perfcounter4(counter_key1, g_ceph_context);

  std::string counter_key2 = ceph::perf_counters::key_create(
      "bad_ctrs", {{"", "val4"}, {"label1", "val1"}});
  PerfCounters* counters2 =
      setup_test_perfcounter4(counter_key2, g_ceph_context);
  ...
  std::string counter_key3 = ceph::perf_counters::key_create(
      "bad_ctrs2", {{"", "val2"}, {"", "val33"}});
  PerfCounters* counters3 =
      setup_test_perfcounter4(counter_key3, g_ceph_context);
  ...
  counter_key4 += "label2";
  counter_key4 += '\0';
  PerfCounters* counters4 =
      setup_test_perfcounter4(counter_key4, g_ceph_context);
  ...
  PerfCounters* no_label_counters =
      setup_test_perfcounter4(counter_key5, g_ceph_context);
