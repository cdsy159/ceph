...
struct TrashWatcher<MockTestImageCtx> {
  ...
  MOCK_METHOD3(
      notify_image_added,
      void(const std::string&, const cls::rbd::TrashImageSpec&, Context*));

  TrashWatcher() { s_instance = this; }
};

TrashWatcher<MockTestImageCtx>* TrashWatcher<MockTestImageCtx>::s_instance =
    nullptr;
...
ResetRequest<MockTestImageCtx>* ResetRequest<MockTestImageCtx>::s_instance =
    nullptr;
...
GetInfoRequest<librbd::MockTestImageCtx>*
    GetInfoRequest<librbd::MockTestImageCtx>::s_instance = nullptr;
...
ImageRemoveRequest<librbd::MockTestImageCtx>*
    ImageRemoveRequest<librbd::MockTestImageCtx>::s_instance = nullptr;
...
struct MoveRequest<MockTestImageCtx> {
  ...
  MOCK_METHOD2(
      construct,
      void(const std::string&, const cls::rbd::TrashImageSpec&));
  MOCK_METHOD0(send, void());

  MoveRequest() { s_instance = this; }
};

MoveRequest<MockTestImageCtx>* MoveRequest<MockTestImageCtx>::s_instance =
    nullptr;
...
public:
  ...
  typedef librbd::journal::ResetRequest<librbd::MockTestImageCtx>
      MockJournalResetRequest;
  typedef librbd::mirror::GetInfoRequest<librbd::MockTestImageCtx>
      MockGetMirrorInfoRequest;
  typedef librbd::mirror::ImageRemoveRequest<librbd::MockTestImageCtx>
      MockImageRemoveRequest;
  typedef librbd::trash::MoveRequest<librbd::MockTestImageCtx>
      MockLibrbdTrashMoveRequest;
  ...
  void
  expect_mirror_image_get_image_id(const std::string& image_id, int r)
  {
    bufferlist bl;
    encode(image_id, bl);
    ...
    EXPECT_CALL(
        ...
        exec(
            RBD_MIRRORING, _, StrEq("rbd"), StrEq("mirror_image_get_image_id"),
            _, _, _, _))
        .WillOnce(DoAll(
  ...
  void
  expect_set_journal_policy(librbd::MockTestImageCtx& mock_image_ctx)
  {
  ...
  void
  expect_close(librbd::MockTestImageCtx& mock_image_ctx, int r)
  {
  ...
  void
  expect_block_requests(librbd::MockTestImageCtx& mock_image_ctx)
  {
    EXPECT_CALL(*mock_image_ctx.exclusive_lock, block_requests(0)).Times(1);
  }

  void
  expect_acquire_lock(librbd::MockTestImageCtx& mock_image_ctx, int r)
  {
      ...
      int r)
  {
    ...
    EXPECT_CALL(
        get_mock_io_ctx(m_local_io_ctx),
        exec(
            RBD_MIRRORING, _, StrEq("rbd"), StrEq("mirror_image_set"),
            ContentsEqual(bl), _, _, _))
        .WillOnce(Return(r));
  }

  void
  expect_mirror_image_remove_request(
  ...
  void
  expect_journal_reset(MockJournalResetRequest& mock_journal_reset_request, int r)
  {
  ...
  void
  expect_trash_move(
      MockLibrbdTrashMoveRequest& mock_trash_move_request,
      const std::string& image_name,
      const std::string& image_id,
      const boost::optional<uint32_t>& delay,
      int r)
  {
    EXPECT_CALL(mock_trash_move_request, construct(image_id, _))
        .WillOnce(WithArg<1>(
            Invoke([image_name, delay](const cls::rbd::TrashImageSpec& spec) {
...
TEST_F(TestMockImageDeleterTrashMoveRequest, SuccessJournal)
{
  ...
  expect_get_mirror_info(
      ...
      {cls::rbd::MIRROR_IMAGE_MODE_JOURNAL, "global image id",
       cls::rbd::MIRROR_IMAGE_STATE_ENABLED},
      librbd::mirror::PROMOTION_STATE_ORPHAN, "remote mirror uuid", 0);
  ...
  expect_trash_move(
      mock_librbd_trash_move_request, m_image_name, "image id", {}, 0);
  MockImageRemoveRequest mock_image_remove_request;
  ...
  C_SaferCond ctx;
  auto req = MockTrashMoveRequest::create(
      m_local_io_ctx, "global image id", true, m_local_image_ctx->op_work_queue,
      &ctx);
  req->send();
...
TEST_F(TestMockImageDeleterTrashMoveRequest, SuccessSnapshot)
{
  ...
  expect_get_mirror_info(
      mock_get_mirror_info_request,
      {cls::rbd::MIRROR_IMAGE_MODE_SNAPSHOT, "global image id",
       cls::rbd::MIRROR_IMAGE_STATE_ENABLED},
      librbd::mirror::PROMOTION_STATE_NON_PRIMARY, "remote mirror uuid", 0);
  ...
  C_SaferCond ctx;
  auto req = MockTrashMoveRequest::create(
      m_local_io_ctx, "global image id", false,
      m_local_image_ctx->op_work_queue, &ctx);
  req->send();
  ASSERT_EQ(0, ctx.wait());
}
...
TEST_F(TestMockImageDeleterTrashMoveRequest, GetMirrorInfoLocalPrimary)
{
  ...
  expect_get_mirror_info(
      ...
      {cls::rbd::MIRROR_IMAGE_MODE_JOURNAL, "global image id",
       cls::rbd::MIRROR_IMAGE_STATE_ENABLED},
      librbd::mirror::PROMOTION_STATE_PRIMARY, "remote mirror uuid", 0);
...
TEST_F(TestMockImageDeleterTrashMoveRequest, GetMirrorInfoDNE)
{
  ...
  expect_get_mirror_info(
      ...
      {cls::rbd::MIRROR_IMAGE_MODE_JOURNAL, "global image id",
       cls::rbd::MIRROR_IMAGE_STATE_ENABLED},
      librbd::mirror::PROMOTION_STATE_ORPHAN, "remote mirror uuid", -ENOENT);
...
TEST_F(TestMockImageDeleterTrashMoveRequest, GetMirrorInfoError)
{
  ...
  expect_get_mirror_info(
      ...
      {cls::rbd::MIRROR_IMAGE_MODE_JOURNAL, "global image id",
       cls::rbd::MIRROR_IMAGE_STATE_ENABLED},
      librbd::mirror::PROMOTION_STATE_ORPHAN, "remote mirror uuid", -EINVAL);
...
TEST_F(TestMockImageDeleterTrashMoveRequest, TrashMoveError)
{
  ...
  MockLibrbdTrashMoveRequest mock_librbd_trash_move_request;
  expect_trash_move(
      mock_librbd_trash_move_request, m_image_name, "image id", {}, -EINVAL);
...
TEST_F(TestMockImageDeleterTrashMoveRequest, DelayedDelation)
{
  ...
  MockLibrbdTrashMoveRequest mock_librbd_trash_move_request;
  expect_trash_move(
      mock_librbd_trash_move_request, m_image_name, "image id", 600, 0);
