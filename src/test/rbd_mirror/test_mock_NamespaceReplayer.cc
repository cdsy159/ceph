...
ImageDeleter<librbd::MockTestImageCtx>*
    ImageDeleter<librbd::MockTestImageCtx>::s_instance = nullptr;
...
ImageMap<librbd::MockTestImageCtx>*
    ImageMap<librbd::MockTestImageCtx>::s_instance = nullptr;

template <>
struct InstanceReplayer<librbd::MockTestImageCtx> {
  static InstanceReplayer* s_instance;

  static InstanceReplayer*
  create(
...
InstanceReplayer<librbd::MockTestImageCtx>*
    InstanceReplayer<librbd::MockTestImageCtx>::s_instance = nullptr;

template <>
struct InstanceWatcher<librbd::MockTestImageCtx> {
  static InstanceWatcher* s_instance;

  static InstanceWatcher*
  create(
      librados::IoCtx& ioctx,
  ...
  MOCK_METHOD4(
      ...
      void(const std::string&, const std::string&, const std::string&, Context*));
...
InstanceWatcher<librbd::MockTestImageCtx>*
    InstanceWatcher<librbd::MockTestImageCtx>::s_instance = nullptr;
...
std::map<int64_t, PoolWatcher<librbd::MockTestImageCtx>*>
    PoolWatcher<librbd::MockTestImageCtx>::s_instances;
...
public:
  ...
  void
  expect_mirror_status_updater_init(
  ...
  void
  expect_mirror_status_updater_shut_down(
      MockMirrorStatusUpdater& mock_mirror_status_updater)
  {
  ...
  void
  expect_instance_replayer_shut_down(
      MockInstanceReplayer& mock_instance_replayer)
  {
  ...
  void
  expect_instance_replayer_stop(MockInstanceReplayer& mock_instance_replayer)
  {
  ...
  void
  expect_instance_replayer_add_peer(MockInstanceReplayer& mock_instance_replayer)
  {
    EXPECT_CALL(mock_instance_replayer, add_peer(_));
  }

  void
  expect_instance_replayer_release_all(
      MockInstanceReplayer& mock_instance_replayer)
  {
  ...
  void
  expect_instance_watcher_get_instance_id(
  ...
  void
  expect_instance_watcher_init(MockInstanceWatcher& mock_instance_watcher, int r)
  {
  ...
  void
  expect_instance_watcher_shut_down(MockInstanceWatcher& mock_instance_watcher)
  {
  ...
  void
  expect_instance_watcher_handle_acquire_leader(
      MockInstanceWatcher& mock_instance_watcher)
  {
  ...
  void
  expect_instance_watcher_handle_release_leader(
      MockInstanceWatcher& mock_instance_watcher)
  {
  ...
  void
  expect_image_map_init(
      MockInstanceWatcher& mock_instance_watcher,
      MockImageMap& mock_image_map,
      int r)
  {
  ...
  void
  expect_image_map_shut_down(MockImageMap& mock_image_map)
  {
  ...
  void
  expect_pool_watcher_init(MockPoolWatcher& mock_pool_watcher, int r)
  {
  ...
  void
  expect_pool_watcher_shut_down(MockPoolWatcher& mock_pool_watcher)
  {
  ...
  void
  expect_image_deleter_init(MockImageDeleter& mock_image_deleter, int r)
  {
  ...
  void
  expect_image_deleter_shut_down(MockImageDeleter& mock_image_deleter)
  {
...
TEST_F(TestMockNamespaceReplayer, Init_LocalMirrorStatusUpdaterError)
{
  ...
  MockNamespaceReplayer namespace_replayer(
      ...
      "local peer uuid", {"remote mirror uuid", ""}, m_mock_threads, nullptr,
...
TEST_F(TestMockNamespaceReplayer, Init)
{
  ...
  MockNamespaceReplayer namespace_replayer(
      {}, {}, m_local_io_ctx, m_remote_io_ctx, "local mirror uuid",
      "local peer uuid", {"remote mirror uuid", ""}, m_mock_threads, nullptr,
      nullptr, &mock_service_daemon, nullptr, nullptr);
