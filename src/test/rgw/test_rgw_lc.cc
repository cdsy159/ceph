...
struct LCWorkTimeTests : ::testing::Test {
  ...
  utime_t
  get_utime_by_date_time_string(const std::string& date_time_str)
  {
    struct tm tm {};
  ...
  void
  run_should_work_test(const auto& test_values_to_expectations_map)
  {
    for (const auto& [date_time_str, expected_value] :
         test_values_to_expectations_map) {
      ...
      ASSERT_EQ(should_work, expected_value)
          << "input time: " << ut << " expected: " << expected_value
          << " should_work: " << should_work
          << " work-time-window: " << cct->_conf->rgw_lifecycle_work_time
          << std::endl;
    }
  }
  ...
  void
  run_schedule_next_start_time_test(const auto& test_values_to_expectations_map)
  {
    for (const auto& [date_time_str_tuple, expected_value] :
         test_values_to_expectations_map) {
      auto work_started_at =
          get_utime_by_date_time_string(std::get<0>(date_time_str_tuple));
      auto work_completed_at =
          get_utime_by_date_time_string(std::get<1>(date_time_str_tuple));
      auto wait_secs_till_next_start =
          worker->schedule_next_start_time(work_started_at, work_completed_at);
...
protected:
  ...
  SetUp() override
  {
    ...
    cct->_conf->set_value(
        "rgw_lc_max_wp_worker", 0, 0); // no need to create a real workpool
...
TEST_F(LCWorkTimeTests, ShouldWorkDefaultWorkTime)
{
  std::unordered_map<std::string, bool> test_values_to_expectations = {
      ...
      {"01/01/24 00:00:00",
       true}, // date is not relevant, but only the time-window
      {"01/01/23 00:00:01", true},
      {"01/01/23 03:00:00", true},
      {"01/01/23 05:59:59", true},
      {"01/01/23 06:00:00", true},
      {"01/01/23 06:00:59",
       true}, // seconds don't matter, but only hours and minutes
...
TEST_F(LCWorkTimeTests, ShouldWorkCustomWorkTimeEndTimeInTheSameDay)
{
  ...
  std::unordered_map<std::string, bool> test_values_to_expectations = {
      {"01/01/23 00:00:00", false}, {"01/01/23 12:00:00", false},
      {"01/01/24 13:59:59", false}, {"01/01/23 14:00:00", true},
      {"01/01/23 16:00:00", true},  {"01/01/23 16:00:59", true},
      {"01/01/23 16:01:00", false}, {"01/01/23 17:00:00", false},
      {"01/01/23 23:59:59", false},
  };
...
TEST_F(LCWorkTimeTests, ShouldWorkCustomWorkTimeEndTimeInTheSameDay24Hours)
{
  ...
  std::unordered_map<std::string, bool> test_values_to_expectations = {
      {"01/01/23 23:59:00", true}, {"01/01/23 23:59:59", true},
      {"01/01/23 00:00:00", true}, {"01/01/23 00:00:01", true},
      {"01/01/23 00:01:00", true}, {"01/01/23 01:00:00", true},
      {"01/01/23 12:00:00", true}, {"01/01/23 17:00:00", true},
...
TEST_F(LCWorkTimeTests, ShouldWorkCustomWorkTimeEndTimeInTheNextDay)
{
  ...
  std::unordered_map<std::string, bool> test_values_to_expectations = {
      {"01/01/23 13:59:00", false}, {"01/01/23 13:59:59", false},
      ...
      {"01/01/23 01:01:00", false}, {"01/01/23 05:00:00", false},
      {"01/01/23 12:00:00", false}, {"01/01/23 13:00:00", false}};
...
TEST_F(LCWorkTimeTests, ShouldWorkCustomWorkTimeEndTimeInTheNextDay24Hours)
{
  ...
  std::unordered_map<std::string, bool> test_values_to_expectations = {
      {"01/01/23 00:00:00", true}, {"01/01/23 00:00:01", true},
      {"01/01/23 00:01:00", true}, {"01/01/24 01:00:00", true},
      {"01/01/24 12:00:00", true}, {"01/01/24 13:00:00", true},
      {"01/01/24 13:59:00", true}, {"01/01/24 13:59:59", true},
      {"01/01/23 14:00:00", true}, {"01/01/23 14:00:01", true},
      {"01/01/23 14:01:00", true}, {"01/01/23 16:00:00", true},
      {"01/01/23 23:59:00", true}, {"01/01/23 23:59:59", true},
  };
...
TEST_F(LCWorkTimeTests, ShouldWorkCustomWorkTimeEndTimeInTheNextDayIrregularMins)
{
  ...
  std::unordered_map<std::string, bool> test_values_to_expectations = {
      {"01/01/23 22:14:59", false}, {"01/01/23 22:15:00", true}, // used-to-fail
      ...
      {"01/01/23 03:34:00", false}, {"01/01/23 04:00:00", false},
      {"01/01/23 12:00:00", false}, {"01/01/23 22:00:00", false},
  };
...
TEST_F(LCWorkTimeTests, ShouldWorkCustomWorkTimeStartEndSameHour)
{
  ...
  std::unordered_map<std::string, bool> test_values_to_expectations = {
      {"01/01/23 22:14:59", false}, {"01/01/23 22:15:00", true},
      {"01/01/24 22:44:59", true},  {"01/01/24 22:45:59", true},
      {"01/01/24 22:46:00", false}, {"01/01/23 23:00:00", false},
      {"01/01/23 00:00:00", false}, {"01/01/23 12:00:00", false},
