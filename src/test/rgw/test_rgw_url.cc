...
{
  std::string host, user, password;
  EXPECT_FALSE(parse_url_authority("ht!tp://example.com", host, user, password));
}

TEST(TestURL, InvalidCharactersInHost)
{
  std::string host, user, password;
  EXPECT_FALSE(parse_url_authority("http://exa mple.com", host, user, password));
}
...
{
  std::string host, user, password;
  EXPECT_FALSE(parse_url_authority(
