...
void
handle_unrecognised(std::vector<std::string>&& unrecognised)
{
...
main(int argc, char** argv)
{
  ...
  desc.add_options()("help,h", "produce help message")(
      ...
      "mon",
      "Test mon admin socket output")("mgr", "Test mgr admin socket output")(
  ...
  asockout->add_test(
      "osd", R"({"prefix":"dump_pgstate_history"})", test_dump_pgstate_history);
