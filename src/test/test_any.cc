...
struct cmd_tattler {
  ...
  cmd_tattler&
  operator=(const cmd_tattler&) noexcept
  {
    if (copied) {
      std::terminate();
    }
...
struct not_noexcept {
  ...
  not_noexcept&
  operator=(const not_noexcept&) noexcept(false)
  {
    return *this;
  }
  ...
  not_noexcept&
  operator=(not_noexcept&&) noexcept(false)
  {
    return *this;
  }
...
{
  static_assert(
      std::is_nothrow_constructible_v<immobile_any<1024>, const cmd_tattler&>);
  static_assert(
      std::is_nothrow_assignable_v<immobile_any<1024>, const cmd_tattler&>);
  static_assert(
      std::is_nothrow_constructible_v<immobile_any<1024>, cmd_tattler&&>);
  static_assert(std::is_nothrow_assignable_v<immobile_any<1024>, cmd_tattler&&>);

  static_assert(
      !std::is_nothrow_constructible_v<immobile_any<1024>, const not_noexcept&>);
  static_assert(
      !std::is_nothrow_assignable_v<immobile_any<1024>, const not_noexcept&>);
  static_assert(
      !std::is_nothrow_constructible_v<immobile_any<1024>, not_noexcept&&>);
  static_assert(
      !std::is_nothrow_assignable_v<immobile_any<1024>, not_noexcept&&>);
...
{
  static_assert(
      !std::is_nothrow_constructible_v<unique_any, const cmd_tattler&>);
  ...
  static_assert(
      !std::is_nothrow_constructible_v<unique_any, const not_noexcept&>);
...
{
  static_assert(
      !std::is_nothrow_constructible_v<shared_any, const cmd_tattler&>);
  ...
  static_assert(
      !std::is_nothrow_constructible_v<shared_any, const not_noexcept&>);
...
test_unmoving_pack_il()
{
  ...
  {
    const A a(
        std::in_place_type<unmoving>, {true, true, true, true}, nullptr, 5, 3.1);
    EXPECT_TRUE(a.has_value());
    EXPECT_EQ(typeid(unmoving), a.type());
    EXPECT_TRUE(any_cast<const unmoving&>(a).a);
...
TEST(UmovingPackIl, Immobile)
{
  static_assert(std::is_nothrow_constructible_v<
                immobile_any<1024>, std::in_place_type_t<unmoving>>);
  ...
  static_assert(
      noexcept(immobile_any<1024>{}.emplace<unmoving>(nullptr, 5, 3.1)));

  static_assert(std::is_nothrow_constructible_v<
                immobile_any<1024>, std::in_place_type_t<unmoving>,
                std::initializer_list<int>>);
  static_assert(noexcept(
      immobile_any<1024>{}.emplace<unmoving>({true, true, true, true})));
...
{
  static_assert(!std::is_nothrow_constructible_v<
                unique_any, std::in_place_type_t<unmoving>>);
  static_assert(!noexcept(unique_any{}.emplace<unmoving>()));

  static_assert(!std::is_nothrow_constructible_v<
                unique_any, std::in_place_type_t<unmoving>, std::nullptr_t, int,
                double>);
  ...
  static_assert(!std::is_nothrow_constructible_v<
                ...
                std::initializer_list<int>>);
  static_assert(
      !noexcept(unique_any{}.emplace<unmoving>({true, true, true, true})));
...
{
  static_assert(!std::is_nothrow_constructible_v<
                shared_any, std::in_place_type_t<unmoving>>);
  static_assert(!noexcept(shared_any{}.emplace<unmoving>()));

  static_assert(!std::is_nothrow_constructible_v<
                shared_any, std::in_place_type_t<unmoving>, std::nullptr_t, int,
                double>);
  ...
  static_assert(!std::is_nothrow_constructible_v<
                ...
                std::initializer_list<int>>);
  static_assert(
      !noexcept(shared_any{}.emplace<unmoving>({true, true, true, true})));
...
TEST(Cast, Immobile) { test_cast<immobile_any<1024>>(); }

TEST(Cast, Unique) { test_cast<unique_any>(); }

TEST(Cast, Shared) { test_cast<shared_any>(); }
