...
std::string enc_ad{
    ...
    "UiOiAiYWQiLAogICAgICAgICJpZCI6ICJTbW9ubnkiLAogICAgICAgICJrZXkiOiAiVHVyamFu"
    "IG9mIE1paXIiCiAgICB9Cn0K"};

std::string enc_ldap{
    "ewogICAgIlJHV19UT0tFTiI6IHsKICAgICAgICAidmVyc2lvbiI6IDEsCiAgICAgICAgInR5cG"
    "UiOiAibGRhcCIsCiAgICAgICAgImlkIjogIlNtb25ueSIsCiAgICAgICAgImtleSI6ICJUdXJq"
    "YW4gb2YgTWlpciIKICAgIH0KfQo="};
...
TEST(TOKEN, SHUTDOWN) { delete token_formatter; }
