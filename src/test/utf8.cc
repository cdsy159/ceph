...
TEST(IsValidUtf8, SimpleAscii)
{
  ...
  ASSERT_EQ(
      0, check_utf8_cstr("Badgers badgers badgers badgers "
                         "mushroom mushroom"));
...
{
  uint8_t funkystr[] = {0x66, 0xd1, 0x86, 0xd1, 0x9d, 0xd2,
                        0xa0, 0xd3, 0xad, 0xd3, 0xae, 0x0a};
...
TEST(HasControlChars, HasControlChars1)
{
  ...
  ASSERT_NE(
      0, check_for_control_characters_cstr((const char*)has_control_chars));
  uint8_t has_control_chars2[] = {0x7f, 0x41, 0x00};
  ASSERT_NE(
      0, check_for_control_characters_cstr((const char*)has_control_chars2));
  ...
  uint8_t validutf[] = {0x66, 0xd1, 0x86, 0xd1, 0x9d, 0xd2,
                        0xa0, 0xd3, 0xad, 0xd3, 0xae, 0x0};
