...
std::ostream&
operator<<(std::ostream& os, ScheduleStatus& s)
{
  TextTable tbl;
    ...
    const std::vector<std::string>& ceph_global_init_args)
{
  ...
  r = utils::mgr_command(
      rados, "rbd mirror snapshot schedule add", args, &std::cout, &std::cerr);
  if (r < 0) {
    return r;
  }
    ...
    const std::vector<std::string>& ceph_global_init_args)
{
  ...
  normalize_level_spec_args(&args);
  r = utils::mgr_command(
      rados, "rbd mirror snapshot schedule remove", args, &std::cout,
      &std::cerr);
  if (r < 0) {
    return r;
  }
    ...
    const std::vector<std::string>& ceph_global_init_args)
{
  ...
  r = utils::mgr_command(
      rados, "rbd mirror snapshot schedule list", args, &out, &std::cerr);
  if (r < 0) {
    return r;
  }
    ...
    const std::vector<std::string>& ceph_global_init_args)
{
  ...
  std::stringstream out;
  r = utils::mgr_command(
      rados, "rbd mirror snapshot schedule status", args, &out, &std::cerr);
