    ...
    const std::vector<std::string>& ceph_global_init_args)
{
  ...
  r = utils::mgr_command(
      rados, "rbd trash purge schedule add", args, &std::cout, &std::cerr);
  if (r < 0) {
    return r;
  }
    ...
    const std::vector<std::string>& ceph_global_init_args)
{
  ...
  normalize_level_spec_args(&args);
  r = utils::mgr_command(
      rados, "rbd trash purge schedule remove", args, &std::cout, &std::cerr);
  if (r < 0) {
    return r;
  }
    ...
    const std::vector<std::string>& ceph_global_init_args)
{
  ...
  r = utils::mgr_command(
      rados, "rbd trash purge schedule list", args, &out, &std::cerr);
  if (r < 0) {
    return r;
  }
    ...
    const std::vector<std::string>& ceph_global_init_args)
{
  ...
  std::stringstream out;
  r = utils::mgr_command(
      rados, "rbd trash purge schedule status", args, &out, &std::cerr);
