...
public:
      ...
      Context* on_finish)
  {
    return new ImageSync(
        threads, local_image_ctx, remote_image_ctx, local_mirror_uuid,
        sync_point_handler, instance_watcher, progress_ctx, on_finish);
  }
...
private:
  ...
  void handle_copy_image_update_progress(
      uint64_t object_no,
