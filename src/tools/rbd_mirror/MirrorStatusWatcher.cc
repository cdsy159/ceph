...
#undef dout_prefix
#define dout_prefix                                                         \
  *_dout << "rbd::mirror::MirrorStatusWatcher: " << this << " " << __func__ \
         << ": "
...
template <typename I>
void
MirrorStatusWatcher<I>::init(Context* on_finish)
{
  dout(20) << dendl;
...
template <typename I>
void
MirrorStatusWatcher<I>::shut_down(Context* on_finish)
{
  dout(20) << dendl;
...
template <typename I>
void
MirrorStatusWatcher<I>::handle_notify(
    uint64_t notify_id,
    uint64_t handle,
