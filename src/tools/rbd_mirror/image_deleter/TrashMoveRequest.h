...
public:
  ...
  create(
      ...
      Context* on_finish)
  {
    return new TrashMoveRequest(
        io_ctx, global_image_id, resync, op_work_queue, on_finish);
  }
...
extern template class rbd::mirror::image_deleter::TrashMoveRequest<
    librbd::ImageCtx>;
