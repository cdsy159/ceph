...
#undef dout_prefix
#define dout_prefix \
  *_dout << "rbd::mirror::image_map::UpdateRequest: " << this << " " << __func__
...
template <typename I>
void
UpdateRequest<I>::update_image_map()
{
  dout(20) << dendl;
...
template <typename I>
void
UpdateRequest<I>::handle_update_image_map(int r)
{
  dout(20) << ": r=" << r << dendl;
