...
public:
  ...
  create(
      ...
      Context* on_finish)
  {
    return new PrepareRemoteImageRequest(
        threads, local_io_ctx, remote_io_ctx, global_image_id,
...
private:
  ...
  void finalize_journal_state_builder(
...
extern template class rbd::mirror::image_replayer::PrepareRemoteImageRequest<
    librbd::ImageCtx>;
