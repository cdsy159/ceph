...
public:
  ...
  create(Journaler* journaler, const std::string& mirror_uuid)
  {
...
extern template class rbd::mirror::image_replayer::journal::ReplayStatusFormatter<
    librbd::ImageCtx>;
