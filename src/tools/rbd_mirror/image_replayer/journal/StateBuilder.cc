...
#undef dout_prefix
#define dout_prefix                                                      \
  *_dout << "rbd::mirror::image_replayer::journal::" << "StateBuilder: " \
         << this << " " << __func__ << ": "
...
template <typename I>
void
StateBuilder<I>::close(Context* on_finish)
{
  dout(10) << dendl;
...
template <typename I>
bool
StateBuilder<I>::is_disconnected() const
{
...
template <typename I>
bool
StateBuilder<I>::is_linked_impl() const
{
...
StateBuilder<I>::get_mirror_image_mode() const
{
  return cls::rbd::MIRROR_IMAGE_MODE_JOURNAL;
}

template <typename I>
image_sync::SyncPointHandler*
StateBuilder<I>::create_sync_point_handler()
{
  dout(10) << dendl;
...
template <typename I>
BaseRequest*
StateBuilder<I>::create_local_image_request(
    Threads<I>* threads,
...
template <typename I>
BaseRequest*
StateBuilder<I>::create_prepare_replay_request(
...
StateBuilder<I>::create_replayer(
    Threads<I>* threads,
...
template <typename I>
void
StateBuilder<I>::shut_down_remote_journaler(Context* on_finish)
{
...
template <typename I>
void
StateBuilder<I>::handle_shut_down_remote_journaler(int r, Context* on_finish)
{
  dout(10) << "r=" << r << dendl;
...
template class rbd::mirror::image_replayer::journal::StateBuilder<
    librbd::ImageCtx>;
