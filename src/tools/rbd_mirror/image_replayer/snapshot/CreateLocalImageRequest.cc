...
template <typename I>
void
CreateLocalImageRequest<I>::disable_mirror_image()
{
  ...
  librbd::cls_client::mirror_image_set(
      &op, m_state_builder->local_image_id, mirror_image);
...
template <typename I>
void
CreateLocalImageRequest<I>::handle_disable_mirror_image(int r)
{
  dout(10) << "r=" << r << dendl;
...
template <typename I>
void
CreateLocalImageRequest<I>::remove_mirror_image()
{
  dout(10) << dendl;
...
template <typename I>
void
CreateLocalImageRequest<I>::handle_remove_mirror_image(int r)
{
  dout(10) << "r=" << r << dendl;
...
template <typename I>
void
CreateLocalImageRequest<I>::add_mirror_image()
{
...
template <typename I>
void
CreateLocalImageRequest<I>::handle_add_mirror_image(int r)
{
  dout(10) << "r=" << r << dendl;
...
CreateLocalImageRequest<I>::create_local_image()
{
  ...
  auto request = CreateImageRequest<I>::create(
      ...
      cls::rbd::MIRROR_IMAGE_MODE_SNAPSHOT, ctx);
  request->send();
}
...
template class rbd::mirror::image_replayer::snapshot::CreateLocalImageRequest<
    librbd::ImageCtx>;
