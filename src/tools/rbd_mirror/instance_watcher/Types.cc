...
void
PayloadBase::encode(bufferlist& bl) const
{
  using ceph::encode;
...
void
PayloadBase::decode(__u8 version, bufferlist::const_iterator& iter)
{
  using ceph::decode;
...
void
PayloadBase::dump(Formatter* f) const
{
  f->dump_unsigned("request_id", request_id);
}

void
ImagePayloadBase::encode(bufferlist& bl) const
{
  using ceph::encode;
...
void
ImagePayloadBase::decode(__u8 version, bufferlist::const_iterator& iter)
{
  using ceph::decode;
...
void
ImagePayloadBase::dump(Formatter* f) const
{
  PayloadBase::dump(f);
...
void
PeerImageRemovedPayload::encode(bufferlist& bl) const
{
  using ceph::encode;
  PayloadBase::encode(bl);
  encode(global_image_id, bl);
...
void
PeerImageRemovedPayload::decode(__u8 version, bufferlist::const_iterator& iter)
{
  using ceph::decode;
  PayloadBase::decode(version, iter);
  decode(global_image_id, iter);
...
void
PeerImageRemovedPayload::dump(Formatter* f) const
{
  PayloadBase::dump(f);
  f->dump_string("global_image_id", global_image_id);
...
void
SyncPayloadBase::encode(bufferlist& bl) const
{
  using ceph::encode;
  PayloadBase::encode(bl);
  encode(sync_id, bl);
...
void
SyncPayloadBase::decode(__u8 version, bufferlist::const_iterator& iter)
{
  using ceph::decode;
  PayloadBase::decode(version, iter);
  decode(sync_id, iter);
...
void
SyncPayloadBase::dump(Formatter* f) const
{
  PayloadBase::dump(f);
...
void
NotifyAckPayload::encode(bufferlist& bl) const
{
  using ceph::encode;
...
void
NotifyAckPayload::decode(bufferlist::const_iterator& iter)
{
  using ceph::decode;
...
void
NotifyAckPayload::dump(Formatter* f) const
{
